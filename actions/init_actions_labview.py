...
def action_list_init(act_lst):
    ...
    act_lst.add("RF02 ON", lib_action.DigitalAction,
                ...
                parameters=dict(channel=[1], status=[True]),
                categories=["actions", "TTL"])
    act_lst.add("Shutter Probe K Close", lib_action.DigitalAction,
                board="TTL2",
                parameters=dict(channel=[2], status=[False]),
                categories=["actions", "TTL"])
    act_lst.add("Shutter Probe K Open", lib_action.DigitalAction,
                board="TTL2",
                parameters=dict(channel=[2], status=[True]),
                categories=["actions", "TTL"])
    act_lst.add("Shutter CoolerMOT K Close", lib_action.DigitalAction,
                board="TTL2",
                parameters=dict(channel=[3], status=[False]),
                categories=["actions", "TTL"])
    ...
    act_lst.add("Shutter Push K Close", lib_action.DigitalAction,
                ...
                parameters=dict(channel=[4], status=[False]),
                categories=["actions", "TTL"])
    act_lst.add("Shutter Push K Open", lib_action.DigitalAction,
                board="TTL2",
                parameters=dict(channel=[4], status=[True]),
                categories=["actions", "TTL"])
