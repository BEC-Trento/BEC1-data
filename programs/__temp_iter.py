...
def program(prg, cmd):
    ...
    prg.add(202294385, "Gray Molasses 2017", enable=False)
    prg.add(202294385, "empty.sub", enable=False)
    prg.add(202306240, "Picture close.sub", functions=dict(time=lambda x: x + cmd.get_var('dt'), funct_enable=False))
    prg.add(211106560, "TTL2-12 OFF")
    prg.add(211213740, "Set MOT NaK.sub")
    prg.add(211713740, "Dark Spot MOT load.sub")
    prg.add(211813740, "Config MOT.sub")
    return prg
