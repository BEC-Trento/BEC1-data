...
def program(prg, cmd):
    ...
    prg.add(394682100, "Pulse uw OFF")
    prg.add(394686400, "Dipole Trap y DAC V", -0.1000)
    prg.add(394686800, "Dipole Trap x DAC V", 0.0000)
    prg.add(394688800, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(394688800, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(394688800, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(394688800, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(394688800, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(394688800, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(394688800, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(394688800, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(394688800, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(394688800, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(394688800, "Picture NaK.sub", enable=False)
    prg.add(394688800, "Picture NaK no Rep.sub")
    prg.add(406562200, "Bias field initialization")
    prg.add(407312900, "Pulse uw OFF")
    prg.add(415547400, "Set MOT NaK.sub")
    prg.add(416047400, "Dark Spot MOT load.sub")
    prg.add(416147400, "Config MOT.sub")
    return prg
