...
def program(prg, cmd):
    ...
    prg.add(398654600, "Dipole Trap y DAC V", -0.1000)
    prg.add(398655000, "Dipole Trap x DAC V", 0.0000)
    prg.add(398660000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(398660000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(398660000, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(398660000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(398660000, "Picture - DipoleLoad - Levit 50ms.sub", enable=False)
    prg.add(398660000, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(398660000, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(398830000, "Picture NaK.sub")
    prg.add(410703400, "Bias field initialization")
    prg.add(411454100, "Pulse uw OFF", enable=False)
    prg.add(419688600, "Set MOT NaK.sub")
    prg.add(420188600, "Dark Spot MOT load.sub")
    prg.add(420288600, "Config MOT.sub")
    return prg
