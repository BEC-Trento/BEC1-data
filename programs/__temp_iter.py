...
def program(prg, cmd):
    ...
    prg.add(836224470, "Delta 1 Current", 13.200)
    prg.add(836714470, "Config Field OFF.sub")
    prg.add(836724470, "Pulse TTL2-12", polarity=1, pulse_t=0.95600)
    prg.add(836724500, "Picture FastStingray")
    prg.add(852464925, "Set MOT NaK.sub")
    prg.add(852964925, "Dark Spot MOT load.sub")
    prg.add(853064925, "Config MOT.sub")
    return prg
