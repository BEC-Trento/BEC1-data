...
def program(prg, cmd):
    ...
    prg.add(202191645, "B comp x", 720.0)
    ...
    prg.add(787220000, "Picture Levit 2017 - 15ms", enable=False)
    prg.add(787220000, "Picture Levit 2017 - 20ms", enable=False)
    prg.add(787220000, "Picture Levit 2017 - 50ms", enable=False)
    prg.add(787220000, "Picture Levit 2017 - 150ms", enable=False)
    prg.add(787220000, "Picture Levit 2017 - 180ms", enable=False)
    prg.add(787220000, "Picture Levit 2017 - 200ms", enable=False)
    prg.add(787220000, "Config Field OFF.sub", functions=dict(time=lambda x: x + cmd.get_var('t'), funct_enable=False))
    prg.add(787230000, "Picture NaK.sub")
    prg.add(787230000, "empty.sub", enable=False)
    prg.add(795230000, "Set MOT NaK.sub")
    prg.add(795730000, "Dark Spot MOT load.sub")
    prg.add(795830000, "Config MOT.sub")
    return prg
