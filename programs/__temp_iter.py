...
def program(prg, cmd):
    ...
    prg.add(674500000, "Bragg Pulse Single New_20160509.sub", enable=False)
    prg.add(674530000, "Config Field OFF.sub", enable=False)
    prg.add(674530000, "Picture - Field off at 0ms - Levit 180ms.sub")
    prg.add(674530000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(674530000, "Picture - Field off at 0ms - Levit 80ms.sub", enable=False)
    prg.add(674530000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(674531000, "Picture NaK Bragg New_20160509.sub", enable=False)
    prg.add(674531000, "Picture NaK.sub", enable=False)
    prg.add(676531000, "Na Repumper1 (+) Amp", 600, enable=False)
    prg.add(682161000, "Set MOT NaK.sub")
    prg.add(682661000, "Dark Spot MOT load.sub")
    prg.add(682761000, "Config MOT.sub")
    return prg
