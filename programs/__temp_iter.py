...
def program(prg, cmd):
    ...
    prg.add(392654600, "Dipole Trap y DAC V", -0.1000)
    prg.add(392655000, "Dipole Trap x DAC V", 0.0000)
    prg.add(392660000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(392660000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(392660000, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(392660000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(392660000, "Picture - DipoleLoad - Levit 50ms.sub", enable=False)
    prg.add(392660000, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(392660000, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(392820000, "Picture NaK.sub", enable=False)
    prg.add(403120000, "excite pinch", enable=False)
    prg.add(414993400, "Bias field initialization")
    prg.add(415744100, "Pulse uw OFF", enable=False)
    prg.add(423978600, "Set MOT NaK.sub")
    prg.add(424478600, "Dark Spot MOT load.sub")
    prg.add(424578600, "Config MOT.sub")
    return prg
