...
def program(prg, cmd):
    ...
    prg.add(836019990, "Picture FastStingray uw rep", enable=False)
    prg.add(836019990, "Picture FastStingray uw rep extra probe pic", enable=False)
    prg.add(836219990, "Config Field OFF.sub", enable=False)
    prg.add(836222370, "Picture Levit 2017 - setup")
