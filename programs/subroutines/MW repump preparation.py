...
def program(prg, cmd):
    ...
    prg.add(1500, "B comp x ramp", start_t=0, stop_x=2200, n_points=300, start_x=1369, stop_t=150)
    prg.add(1510000, "B comp y ramp", start_t=0, stop_x=0, n_points=300, start_x=1000, stop_t=150)
    return prg
