...
def program(prg, cmd):
    ...
    prg.add(45510, "IGBT 1 pinch", -10.0000)
    prg.add(45520, "IGBT 2 pinch+comp", -10.0000)
    prg.add(45530, "IGBT 3 Open")
    prg.add(45540, "IGBT 4 Open")
    prg.add(45550, "IGBT 5 Open")
    prg.add(49010, "Na Repumper MOT Amp", 1000)
    prg.add(49510, "Na Repumper1 (+) Amp", 1000)
    prg.add(49910, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(50310, "Na Probe/Push (+) freq", 110.00)
    prg.add(50710, "Na Probe/Push (-) freq", 110.00)
    prg.add(51010, "Trig ON Stingray 1")
    prg.add(51110, "Na Probe/Push (+) Amp", 1000)
    prg.add(51510, "Na Probe/Push (-) Amp", 1000)
    prg.add(52510, "Na Probe/Push (-) Amp", 1)
    prg.add(53010, "Trig OFF Stingray 1")
    prg.add(301510, "Shutter Probe Na Close")
    prg.add(1051010, "Trig ON Stingray 1")
    prg.add(1051510, "Na Probe/Push (-) Amp", 1000)
    prg.add(1052510, "Na Probe/Push (-) Amp", 1)
    prg.add(1053010, "Trig OFF Stingray 1")
    prg.add(1061510, "Na Repumper MOT Amp", 1)
    prg.add(1071510, "Na Repumper1 (+) Amp", 1)
    prg.add(2051010, "Trig ON Stingray 1")
    prg.add(2053010, "Trig OFF Stingray 1")
    prg.add(3051010, "Trig ON Stingray 1")
    prg.add(3053010, "Trig OFF Stingray 1")
    prg.add(4051510, "B comp y", 0.0000, enable=False)
    prg.add(4150510, "IGBT B comp y OFF")
    return prg
