...
def program(prg, cmd):
    ...
    prg.add(32000, "Trig OFF Stingray 1")
    prg.add(999950, "Pulse uw ON")
    prg.add(1000000, "Pulse uw OFF")
    prg.add(1024500, "Trig ON Stingray 1")
    prg.add(1025000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(1026000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(1026500, "Trig OFF Stingray 1")
    prg.add(1999950, "Pulse uw ON")
    prg.add(2000000, "Pulse uw OFF")
    prg.add(2024500, "Trig ON Stingray 1")
    prg.add(2025000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(2026000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(2026500, "Trig OFF Stingray 1")
    ...
    prg.add(3024500, "Trig ON Stingray 1")
    prg.add(3025000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(3026000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(3026500, "Trig OFF Stingray 1")
    ...
    prg.add(4024500, "Trig ON Stingray 1")
    prg.add(4025000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(4026000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(4026500, "Trig OFF Stingray 1")
