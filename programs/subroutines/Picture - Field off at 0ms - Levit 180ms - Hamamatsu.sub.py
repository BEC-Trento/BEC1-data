...
def program(prg, cmd):
    ...
    prg.add(1785000, "IGBT 1 pinch", -10.0000)
    prg.add(1785010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(1785020, "IGBT 3 Open")
    prg.add(1785029, "IGBT 4 Open")
    prg.add(1785040, "IGBT 5 Open")
    prg.add(1785050, "IGBT 6 Open")
    prg.add(1800000, "Picture NaK.sub", enable=False)
    prg.add(1800000, "Picture NaK Repump Off.sub", enable=False)
    prg.add(1800000, "Picture NaK Hamamatsu.sub")
    prg.add(5299000, "Shutter Optical Levit Close")
    prg.add(5800000, "B comp y", 0.0000)
    prg.add(15299000, "Optical Levit ON")
    return prg
