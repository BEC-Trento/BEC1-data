...
def program(prg, cmd):
    ...
    prg.add(10410, "Delta 1 Current", 15.300000)
    prg.add(1475020, "IGBT 3 Open")
    prg.add(1482000, "B comp x", 2000.000000)
    prg.add(1483500, "Na Repumper MOT Amp", 1000.000000)
    prg.add(1484000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(1484400, "Na Repumper Tune (+) freq", 1713.000000)
    ...
    prg.add(1499000, "Na Repumper MOT Amp", 1.000000)
    ...
    prg.add(1949400, "Na Repumper1 (+) Amp", 1.000000)
    ...
    prg.add(5501000, "B comp x", 0.000000)
