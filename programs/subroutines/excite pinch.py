...
def program(prg, cmd):
    ...
    prg.add(3000, "Decompress Current 200-50", start_t=0.0000, stop_x=1.000, n_points=200, start_x=0.000, stop_t=50.0000, enable=False)
    prg.add(493000, "Delta 1 Current", 5.000)
