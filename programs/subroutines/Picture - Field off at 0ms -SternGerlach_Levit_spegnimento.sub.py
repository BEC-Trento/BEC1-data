...
def program(prg, cmd):
    ...
    prg.add(10410, "Delta 1 Current", 13.000)
    ...
    prg.add(130000, "IGBT B comp z OFF")
    prg.add(132000, "B comp y", 3.0000)
    prg.add(135000, "IGBT 1 pinch", -10.0000)
    prg.add(135010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(135020, "IGBT 3 Open")
    prg.add(135030, "IGBT 4 Open")
    prg.add(135040, "IGBT 5 Open")
    prg.add(138500, "Na Repumper MOT Amp", 1000)
    prg.add(139000, "Na Repumper1 (+) Amp", 1000)
    prg.add(139400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(139800, "Na Probe/Push (+) freq", 110.00)
    prg.add(140200, "Na Probe/Push (-) freq", 110.00)
    prg.add(140500, "Trig ON Stingray 1")
    prg.add(140600, "Na Probe/Push (+) Amp", 1000)
    prg.add(141000, "Na Probe/Push (-) Amp", 1000)
    prg.add(142000, "Na Probe/Push (-) Amp", 1)
    prg.add(142500, "Trig OFF Stingray 1")
    prg.add(391000, "Shutter Probe Na Close")
    prg.add(1140500, "Trig ON Stingray 1")
    prg.add(1141000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1142000, "Na Probe/Push (-) Amp", 1)
    prg.add(1142500, "Trig OFF Stingray 1")
    prg.add(1151000, "Na Repumper MOT Amp", 1)
    prg.add(1161000, "Na Repumper1 (+) Amp", 1)
    prg.add(2140500, "Trig ON Stingray 1")
    prg.add(2142500, "Trig OFF Stingray 1")
    prg.add(3140500, "Trig ON Stingray 1")
    prg.add(3142500, "Trig OFF Stingray 1")
    prg.add(4141000, "B comp y", 0.0000, enable=False)
    prg.add(4240000, "IGBT B comp y OFF")
    return prg
