...
def program(prg, cmd):
    ...
    prg.add(10380, "IGBT 4 Close", enable=False)
    ...
    prg.add(98500, "Na Repumper MOT Amp", 1000)
    prg.add(99000, "Na Repumper1 (+) Amp", 1000)
    prg.add(99400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(99800, "Na Probe/Push (+) freq", 110.00)
    prg.add(100200, "Na Probe/Push (-) freq", 110.00)
    prg.add(100500, "Trig ON Stingray 1")
    prg.add(100600, "Na Probe/Push (+) Amp", 1000)
    prg.add(101000, "Na Probe/Push (-) Amp", 1000)
    prg.add(102000, "Na Probe/Push (-) Amp", 1)
    prg.add(102500, "Trig OFF Stingray 1")
    prg.add(351000, "Shutter Probe Na Close")
    prg.add(1100500, "Trig ON Stingray 1")
    prg.add(1101000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1102000, "Na Probe/Push (-) Amp", 1)
    prg.add(1102500, "Trig OFF Stingray 1")
    prg.add(1111000, "Na Repumper MOT Amp", 1)
    prg.add(1121000, "Na Repumper1 (+) Amp", 1)
    ...
    prg.add(4101000, "B comp y", 0.0000)
    prg.add(4200000, "IGBT B comp y OFF")
    return prg
