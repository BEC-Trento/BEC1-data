...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-4349000, "Na Repumper1 (+) Amp", 1)
    prg.add(-4309000, "Na Dark Spot Amp", 1)
    prg.add(-4299000, "Na Repumper MOT Amp", 1)
    prg.add(-2959000, "Shutter repump Na Open")
    prg.add(-2949000, "Shutter Probe Na Open")
    prg.add(-2520000, "Shutter 3DMOT cool Na Open")
    prg.add(-2459000, "Na Probe/Push (-) Amp", 1)
    prg.add(-2449000, "Na Probe/Push (+) Amp", 1)
    ...
    prg.add(10410, "Delta 1 Current", 24.000)
    ...
    prg.add(32000, "B comp y", 1.0000)
    prg.add(45000, "IGBT 1 pinch", -10.0000)
    prg.add(45010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(45020, "IGBT 3 Open")
    prg.add(45030, "IGBT 4 Open")
    prg.add(45039, "IGBT 5 Open")
    prg.add(49000, "Na Repumper1 (+) Amp", 1000)
    prg.add(49400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(49800, "Na Probe/Push (+) freq", 110.00)
    prg.add(50000, "Na Repumper MOT Amp", 1000)
    prg.add(50199, "Na Probe/Push (-) freq", 110.00)
    prg.add(50500, "Trig ON Stingray 1")
    prg.add(50599, "Na Probe/Push (+) Amp", 1000)
    prg.add(51000, "Na Probe/Push (-) Amp", 1000)
    prg.add(52000, "Na Probe/Push (-) Amp", 1)
    prg.add(52500, "Trig OFF Stingray 1")
    prg.add(301000, "Shutter Probe Na Close")
    prg.add(1050500, "Trig ON Stingray 1")
    prg.add(1051000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1052000, "Na Probe/Push (-) Amp", 1)
    prg.add(1052500, "Trig OFF Stingray 1")
    prg.add(1061000, "Na Repumper MOT Amp", 1)
    prg.add(1071000, "Na Repumper1 (+) Amp", 1)
    ...
    prg.add(4051000, "B comp y", 0.0000)
