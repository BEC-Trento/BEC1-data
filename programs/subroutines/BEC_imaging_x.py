...
def program(prg, cmd):
    ...
    prg.add(999916, "Pulse Trig Stingray x", comment="probe", polarity=1, pulse_t=0.14400)
    prg.add(1001416, "Probe y AOM TTL")
    prg.add(1804381, "Shutter Probe/Push Close")
    prg.add(2016036, "Pulse Trig Stingray x", comment="dark", polarity=1, pulse_t=0.10000)
    return prg
