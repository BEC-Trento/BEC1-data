...
def program(prg, cmd):
    ...
    prg.add(10380, "IGBT 5 Open")
    prg.add(10400, "IGBT 4 Close")
    prg.add(10410, "Delta 1 Current", 80.000)
    prg.add(10420, "Delta 2 Voltage", 0.0000)
    prg.add(10440, "B comp x", 1369.0, enable=False)
    prg.add(10490, "B comp y", 5.0000, enable=False)
    prg.add(11020, "B comp y", 4.7400, enable=False)
    prg.add(11540, "B comp y", 4.4700, enable=False)
    prg.add(12070, "B comp y", 4.2100, enable=False)
    prg.add(12599, "B comp y", 3.9500, enable=False)
    prg.add(13120, "B comp y", 3.6800, enable=False)
    prg.add(13650, "B comp y", 3.4200, enable=False)
    prg.add(14170, "B comp y", 3.1600, enable=False)
    prg.add(14700, "B comp y", 2.8900, enable=False)
    prg.add(15230, "B comp y", 2.6300, enable=False)
    prg.add(15750, "B comp y", 2.3700, enable=False)
    prg.add(16280, "B comp y", 2.1100, enable=False)
    prg.add(16810, "B comp y", 1.8400, enable=False)
    prg.add(17330, "B comp y", 1.5800, enable=False)
    prg.add(17860, "B comp y", 1.3200, enable=False)
    prg.add(18380, "B comp y", 1.0500, enable=False)
    prg.add(18910, "B comp y", 0.7900, enable=False)
    prg.add(19440, "B comp y", 0.5300, enable=False)
    prg.add(19960, "B comp y", 0.2600, enable=False)
    prg.add(20490, "B comp y", 0.0000, enable=False)
    prg.add(25499, "IGBT B comp z OFF")
    prg.add(27499, "B comp y", 3.0000)
    prg.add(47499, "IGBT 1 pinch", -10.0000)
    prg.add(47509, "IGBT 2 pinch+comp", -10.0000)
    prg.add(47519, "IGBT 3 Open")
    prg.add(47529, "IGBT 4 Open")
    prg.add(47539, "IGBT 5 Open")
    prg.add(50999, "Na Repumper MOT Amp", 1000)
    prg.add(51499, "Na Repumper1 (+) Amp", 1000)
    prg.add(51899, "Na Repumper Tune (+) freq", 1707.0)
    prg.add(52299, "Na Probe/Push (+) freq", 110.00)
    prg.add(52699, "Na Probe/Push (-) freq", 110.00)
    prg.add(52999, "Trig ON Stingray 1")
    prg.add(53099, "Na Probe/Push (+) Amp", 1000)
    prg.add(53499, "Na Probe/Push (-) Amp", 1000)
    prg.add(54499, "Na Probe/Push (-) Amp", 1)
    prg.add(54999, "Trig OFF Stingray 1")
    prg.add(303499, "Shutter Probe Na Close")
    prg.add(1052999, "Trig ON Stingray 1")
    prg.add(1053499, "Na Probe/Push (-) Amp", 1000)
    prg.add(1054499, "Na Probe/Push (-) Amp", 1)
    prg.add(1054999, "Trig OFF Stingray 1")
    prg.add(1063499, "Na Repumper MOT Amp", 1)
    prg.add(1073499, "Na Repumper1 (+) Amp", 1)
    prg.add(2052999, "Trig ON Stingray 1")
    prg.add(2054999, "Trig OFF Stingray 1")
    prg.add(3052999, "Trig ON Stingray 1")
    prg.add(3054999, "Trig OFF Stingray 1")
    prg.add(4053499, "B comp y", 0.0000, enable=False)
    prg.add(4152499, "IGBT B comp y OFF")
    return prg
