...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-4369000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(-4329000, "Na Dark Spot Amp", 1.000000)
    prg.add(-4319000, "Na Repumper MOT Amp", 1.000000)
    prg.add(-2979000, "Shutter repump Na Open")
    prg.add(-2969000, "Shutter Probe Na Open")
    prg.add(-2479000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(-2469000, "Na Probe/Push (+) Amp", 1.000000)
    ...
    prg.add(10000, "IGBT B comp z OFF")
    ...
    prg.add(12000, "B comp y", 1.000000)
    ...
    prg.add(25000, "IGBT 1 pinch", -10.000000)
    prg.add(25010, "IGBT 2 pinch+comp", -10.000000)
    prg.add(25019, "IGBT 3 Open")
    prg.add(25030, "IGBT 4 Open")
    prg.add(25040, "IGBT 5 Open")
    prg.add(29000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(29400, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(29800, "Na Probe/Push (+) freq", 110.000000)
    prg.add(30000, "Na Repumper MOT Amp", 1000.000000)
    prg.add(30200, "Na Probe/Push (-) freq", 110.000000)
    prg.add(30500, "Trig ON Stingray 1")
    prg.add(30600, "Na Probe/Push (+) Amp", 1000.000000)
    prg.add(31000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(32000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(32500, "Trig OFF Stingray 1")
    prg.add(281000, "Shutter Probe Na Close")
    prg.add(1030500, "Trig ON Stingray 1")
    prg.add(1031000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(1032000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(1032500, "Trig OFF Stingray 1")
    prg.add(1041000, "Na Repumper MOT Amp", 1.000000)
    prg.add(1051000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(2030500, "Trig ON Stingray 1")
    prg.add(2032500, "Trig OFF Stingray 1")
    prg.add(3030500, "Trig ON Stingray 1")
    prg.add(3032500, "Trig OFF Stingray 1")
    prg.add(4031000, "B comp y", 0.000000)
