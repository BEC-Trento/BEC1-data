...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-2399000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(-2359000, "Na Dark Spot Amp", 1.000000)
    prg.add(-2349000, "Na Repumper MOT Amp", 1.000000)
    prg.add(-1830000, "Na 3D MOT cool (-) Amp", 1.000000)
    prg.add(-1820000, "Na 3D MOT cool (+) Amp", 1.000000)
    prg.add(-1810000, "Na Probe/Push (+) ON")
    prg.add(-1800000, "Shutter 3DMOT cool Na Open")
    prg.add(-1009000, "Shutter repump Na Open")
    prg.add(-999000, "Shutter Probe Na Open")
    prg.add(-509000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(-500000, "IGBT B comp y ON")
    prg.add(-499000, "Na Probe/Push (+) Amp", 1.000000)
    ...
    prg.add(10410, "Delta 1 Current", 15.240000)
    ...
    prg.add(1950000, "IGBT B comp z OFF")
    prg.add(1982000, "B comp y", 1.000000)
    prg.add(1995000, "IGBT 1 pinch", -10.000000)
    prg.add(1995010, "IGBT 2 pinch+comp", -10.000000)
    prg.add(1995020, "IGBT 3 Open")
    prg.add(1995029, "IGBT 4 Open")
    prg.add(1995040, "IGBT 5 Open")
    prg.add(1999000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(1999400, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(1999800, "Na Probe/Push (+) freq", 110.000000)
    prg.add(2000000, "Na Repumper MOT Amp", 1000.000000)
    prg.add(2000200, "Na Probe/Push (-) freq", 110.000000)
    prg.add(2000500, "Trig ON Stingray 1")
    prg.add(2000600, "Na Probe/Push (+) Amp", 1000.000000)
    prg.add(2001000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(2002000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(2002500, "Trig OFF Stingray 1")
    prg.add(2251000, "Shutter Probe Na Close")
    prg.add(3000500, "Trig ON Stingray 1")
    prg.add(3001000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(3002000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(3002500, "Trig OFF Stingray 1")
    prg.add(3011000, "Na Repumper MOT Amp", 1.000000)
    prg.add(3021000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(4000500, "Trig ON Stingray 1")
    prg.add(4002500, "Trig OFF Stingray 1")
    prg.add(5000500, "Trig ON Stingray 1")
    prg.add(5002500, "Trig OFF Stingray 1")
    prg.add(5200000, "Shutter Optical Levit Close")
    prg.add(6001000, "B comp y", 0.000000)
    prg.add(6100000, "IGBT B comp y OFF")
    return prg
