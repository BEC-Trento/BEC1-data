...
def program(prg, cmd):
    ...
    prg.add(35500, "IGBT B comp z OFF")
    prg.add(72500, "B comp y", 3.0000)
    prg.add(72600, "IGBT 1 pinch", -10.0000)
    prg.add(72610, "IGBT 2 pinch+comp", -10.0000)
    prg.add(72620, "IGBT 3 Open")
    prg.add(72630, "IGBT 4 Open")
    prg.add(72640, "IGBT 5 Open")
    prg.add(76100, "Na Repumper MOT Amp", 1000)
    prg.add(76600, "Na Repumper1 (+) Amp", 1000)
    prg.add(77000, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(77400, "Na Probe/Push (+) freq", 110.00)
    prg.add(77800, "Na Probe/Push (-) freq", 110.00)
    prg.add(78100, "Trig ON Stingray 1")
    prg.add(78200, "Na Probe/Push (+) Amp", 1000)
    prg.add(78600, "Na Probe/Push (-) Amp", 1000)
    prg.add(79600, "Na Probe/Push (-) Amp", 1)
    prg.add(80100, "Trig OFF Stingray 1")
    prg.add(328600, "Shutter Probe Na Close")
    prg.add(1078100, "Trig ON Stingray 1")
    prg.add(1078600, "Na Probe/Push (-) Amp", 1000)
    prg.add(1079600, "Na Probe/Push (-) Amp", 1)
    prg.add(1080100, "Trig OFF Stingray 1")
    prg.add(1088600, "Na Repumper MOT Amp", 1)
    prg.add(1098600, "Na Repumper1 (+) Amp", 1)
    prg.add(2078100, "Trig ON Stingray 1")
    prg.add(2080100, "Trig OFF Stingray 1")
    prg.add(3078100, "Trig ON Stingray 1")
    prg.add(3080100, "Trig OFF Stingray 1")
    prg.add(4078600, "B comp y", 0.0000, enable=False)
    prg.add(4177600, "IGBT B comp y OFF")
    return prg
