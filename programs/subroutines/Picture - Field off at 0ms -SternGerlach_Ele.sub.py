...
def program(prg, cmd):
    ...
    prg.add(21000, "IGBT B comp z OFF")
    prg.add(68000, "B comp y", 3.0000)
    prg.add(81000, "IGBT 1 pinch", -10.0000)
    prg.add(81010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(81020, "IGBT 3 Open")
    prg.add(81030, "IGBT 4 Open")
    prg.add(81040, "IGBT 5 Open")
    prg.add(84500, "Na Repumper MOT Amp", 1000)
    prg.add(85000, "Na Repumper1 (+) Amp", 1000)
    prg.add(85400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(85800, "Na Probe/Push (+) freq", 110.00)
    prg.add(86200, "Na Probe/Push (-) freq", 110.00)
    prg.add(86500, "Trig ON Stingray 1")
    prg.add(86600, "Na Probe/Push (+) Amp", 1000)
    prg.add(87000, "Na Probe/Push (-) Amp", 1000)
    prg.add(88000, "Na Probe/Push (-) Amp", 1)
    prg.add(88500, "Trig OFF Stingray 1")
    prg.add(337000, "Shutter Probe Na Close")
    prg.add(1086500, "Trig ON Stingray 1")
    prg.add(1087000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1088000, "Na Probe/Push (-) Amp", 1)
    prg.add(1088500, "Trig OFF Stingray 1")
    prg.add(1097000, "Na Repumper MOT Amp", 1)
    prg.add(1107000, "Na Repumper1 (+) Amp", 1)
    prg.add(2086500, "Trig ON Stingray 1")
    prg.add(2088500, "Trig OFF Stingray 1")
    prg.add(3086500, "Trig ON Stingray 1")
    prg.add(3088500, "Trig OFF Stingray 1")
    prg.add(4087000, "B comp y", 0.0000, enable=False)
    prg.add(4186000, "IGBT B comp y OFF")
    return prg
