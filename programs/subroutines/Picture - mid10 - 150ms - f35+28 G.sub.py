...
def program(prg, cmd):
    ...
    prg.add(268000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(278000, "K probe Repumper (+) Amp", 1.000000)
    prg.add(288000, "K Repumper 1p (+) Amp", 1.000000)
    prg.add(299964, "Pulse uw ON")
    prg.add(300000, "Pulse uw OFF")
    prg.add(308000, "Na Dark Spot Amp", 1.000000)
    prg.add(318000, "Na Repumper MOT Amp", 1.000000)
    ...
    prg.add(668000, "Shutter Probe Na Open")
    ...
    prg.add(1638000, "Shutter Probe K Open")
    prg.add(1648000, "Shutter RepumperMOT K Open")
    prg.add(1658000, "Shutter repump Na Open")
    ...
    prg.add(2178000, "K probe Cooler (-) Amp", 1.000000)
    ...
    prg.add(2641000, "Na 3D MOT cool (-) Amp", 1.000000)
    prg.add(2651000, "Na 3D MOT cool (+) Amp", 1.000000)
    prg.add(2670000, "Optical Levit OFF")
    prg.add(2671000, "Shutter 3DMOT cool Na Open")
    prg.add(2682000, "Shutter Optical Levit Close")
    ...
    prg.add(3180410, "Delta 1 Current", 15.350000)
    ...
    prg.add(4652000, "B comp y", 1.000000)
    prg.add(4665000, "IGBT 1 pinch", -10.000000)
    prg.add(4665010, "IGBT 2 pinch+comp", -10.000000)
    prg.add(4665020, "IGBT 3 Open")
    prg.add(4665030, "IGBT 4 Open")
    prg.add(4665040, "IGBT 5 Open")
    prg.add(4665050, "IGBT 6 Open")
    prg.add(4665070, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(4665400, "Na Probe/Push (+) Amp", 1.000000)
    prg.add(4668500, "Na Repumper MOT Amp", 1000.000000)
    prg.add(4669000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(4669400, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(4669800, "Na Probe/Push (+) freq", 110.000000)
    prg.add(4670200, "Na Probe/Push (-) freq", 110.000000)
    prg.add(4670500, "Trig Slow Stingray ON")
    prg.add(4670600, "Na Probe/Push (+) Amp", 1000.000000)
    prg.add(4671000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(4671400, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(4672050, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(4672400, "K probe Cooler (-) Amp", 1.000000)
    prg.add(4673000, "Trig Slow Stingray OFF")
    prg.add(4921000, "Shutter Probe Na Close")
    prg.add(4931000, "Shutter Probe K Close")
    prg.add(5170000, "Optical Levit ON")
    prg.add(5670500, "Trig Slow Stingray ON")
    prg.add(5671000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(5671400, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(5672000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(5672400, "K probe Cooler (-) Amp", 1.000000)
    prg.add(5673000, "Trig Slow Stingray OFF")
    prg.add(5681000, "Na Repumper MOT Amp", 1.000000)
    prg.add(5691000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(5701000, "K Repumper 1p (+) Amp", 1.000000)
    prg.add(6670500, "Trig Slow Stingray ON")
    prg.add(6672500, "Trig Slow Stingray OFF")
    prg.add(7670500, "Trig Slow Stingray ON")
    prg.add(7672500, "Trig Slow Stingray OFF")
    prg.add(8181000, "Optical Levit OFF")
    prg.add(8420000, "Shutter Optical Levit Close")
    prg.add(8671000, "B comp y", 0.000000)
    prg.add(13170000, "Optical Levit ON")
    return prg
