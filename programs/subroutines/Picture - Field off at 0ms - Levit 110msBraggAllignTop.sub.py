...
def program(prg, cmd):
    ...
    prg.add(20500, "Shutter 3DMOT cool Na Close")
    prg.add(520799, "Shutter Bragg Open")
    prg.add(1102100, "B comp y", 1.0000)
    prg.add(1115100, "IGBT 1 pinch", -10.0000)
    prg.add(1115110, "IGBT 2 pinch+comp", -10.0000)
    prg.add(1115120, "IGBT 3 Open")
    prg.add(1115129, "IGBT 4 Open")
    prg.add(1115140, "IGBT 5 Open")
    prg.add(1115150, "IGBT 6 Open")
    prg.add(1115700, "K probe Cooler (-) freq", 99.50)
    prg.add(1116100, "K Cooler 2p (+) freq", 97.50)
    prg.add(1116499, "K Repumper 1p (+) Amp", 1000)
    prg.add(1116900, "K Repumper 1p (+) freq", 115.00)
    prg.add(1117300, "K Repumper 2p (+) freq", 96.00)
    prg.add(1118600, "Na Repumper MOT Amp", 1000)
    prg.add(1119100, "Na Repumper1 (+) Amp", 1000)
    prg.add(1119500, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(1119900, "Na Probe/Push (+) freq", 110.00, enable=False)
    prg.add(1119900, "Na 3D MOT cool (+) freq", 110.00)
    prg.add(1120249, "Na Repumper1 (+) Amp", 1)
    prg.add(1120300, "Na Probe/Push (-) freq", 110.00, enable=False)
    prg.add(1120300, "Na 3D MOT cool (-) freq", 110.00)
    prg.add(1120350, "Na Repumper MOT Amp", 1)
    prg.add(1120600, "Trig ON Stingray 1")
    prg.add(1120700, "Na Probe/Push (+) Amp", 1000, enable=False)
    prg.add(1120700, "Na 3D MOT cool (+) Amp", 1000)
    prg.add(1121100, "Na Probe/Push (-) Amp", 1000, enable=False)
    prg.add(1121100, "Na 3D MOT cool (-) Amp", 1000)
    prg.add(1121499, "K probe Cooler (-) Amp", 1000)
    prg.add(1122150, "Na Probe/Push (-) Amp", 1, enable=False)
    prg.add(1122150, "Na 3D MOT cool (-) Amp", 1)
    prg.add(1122500, "K probe Cooler (-) Amp", 1)
    prg.add(1123100, "Trig OFF Stingray 1")
    prg.add(1371100, "Shutter Probe Na Close")
    prg.add(2120600, "Trig ON Stingray 1")
    prg.add(2121100, "Na Probe/Push (-) Amp", 1000, enable=False)
    prg.add(2121500, "K probe Cooler (-) Amp", 1000)
    prg.add(2122100, "Na Probe/Push (-) Amp", 1, enable=False)
    prg.add(2122500, "K probe Cooler (-) Amp", 1)
    prg.add(2123100, "Trig OFF Stingray 1")
    prg.add(2131100, "Na Repumper MOT Amp", 1, enable=False)
    prg.add(2141100, "Na Repumper1 (+) Amp", 1, enable=False)
    prg.add(2151100, "K Repumper 1p (+) Amp", 1)
    prg.add(3120600, "Trig ON Stingray 1")
    prg.add(3122600, "Trig OFF Stingray 1")
    prg.add(4120600, "Trig ON Stingray 1")
    prg.add(4122600, "Trig OFF Stingray 1")
    prg.add(4620100, "Shutter Optical Levit Close")
    prg.add(5121100, "B comp y", 0.0000)
    prg.add(14620100, "Optical Levit ON")
    return prg
