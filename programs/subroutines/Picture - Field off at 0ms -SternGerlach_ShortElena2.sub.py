...
def program(prg, cmd):
    ...
    prg.add(-400000, "Bcomp y Sign Minus", enable=False)
    ...
    prg.add(10400, "Delta 2 Voltage", 30.0000)
    prg.add(10410, "Delta 1 Current", 90.000)
    ...
    prg.add(20510, "IGBT B comp z OFF")
    prg.add(22510, "B comp y", 3.0000)
    prg.add(32510, "IGBT 1 pinch", -10.0000)
    prg.add(32520, "IGBT 2 pinch+comp", -10.0000)
    prg.add(32530, "IGBT 3 Open")
    prg.add(32540, "IGBT 4 Open")
    prg.add(32550, "IGBT 5 Open")
    prg.add(36010, "Na Repumper MOT Amp", 1000)
    prg.add(36510, "Na Repumper1 (+) Amp", 1000)
    prg.add(36910, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(37310, "Na Probe/Push (+) freq", 112.00)
    prg.add(37710, "Na Probe/Push (-) freq", 108.00)
    prg.add(38010, "Trig ON Stingray 1")
    prg.add(38110, "Na Probe/Push (+) Amp", 1000)
    prg.add(38510, "Na Probe/Push (-) Amp", 1000)
    prg.add(39510, "Na Probe/Push (-) Amp", 1)
    prg.add(40010, "Trig OFF Stingray 1")
    prg.add(288510, "Shutter Probe Na Close")
    prg.add(1038010, "Trig ON Stingray 1")
    prg.add(1038510, "Na Probe/Push (-) Amp", 1000)
    prg.add(1039510, "Na Probe/Push (-) Amp", 1)
    prg.add(1040010, "Trig OFF Stingray 1")
    prg.add(1048510, "Na Repumper MOT Amp", 1)
    prg.add(1058510, "Na Repumper1 (+) Amp", 1)
    prg.add(2038010, "Trig ON Stingray 1")
    prg.add(2040010, "Trig OFF Stingray 1")
    prg.add(3038010, "Trig ON Stingray 1")
    prg.add(3040010, "Trig OFF Stingray 1")
    prg.add(4038510, "B comp y", 0.0000, enable=False)
    prg.add(4137510, "IGBT B comp y OFF")
    prg.add(4490000, "Bcomp y Sign Plus")
    return prg
