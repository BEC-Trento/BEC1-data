...
def program(prg, cmd):
    ...
    prg.add(150000, "IGBT B comp z OFF", enable=False)
    ...
    prg.add(198500, "Na Repumper MOT Amp", 1000)
    prg.add(199000, "Na Repumper1 (+) Amp", 1000)
    prg.add(199400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(199800, "Na Probe/Push (+) freq", 110.00)
    prg.add(200200, "Na Probe/Push (-) freq", 110.00)
    prg.add(200500, "Trig ON Stingray 1")
    prg.add(200600, "Na Probe/Push (+) Amp", 1000)
    prg.add(201000, "Na Probe/Push (-) Amp", 1000)
    prg.add(202000, "Na Probe/Push (-) Amp", 1)
    prg.add(202500, "Trig OFF Stingray 1")
    prg.add(451000, "Shutter Probe Na Close")
    prg.add(1200500, "Trig ON Stingray 1")
    prg.add(1201000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1202000, "Na Probe/Push (-) Amp", 1)
    prg.add(1202500, "Trig OFF Stingray 1")
    prg.add(1211000, "Na Repumper MOT Amp", 1)
    prg.add(1221000, "Na Repumper1 (+) Amp", 1)
    ...
    prg.add(4201000, "B comp y", 0.0000)
    prg.add(4300000, "IGBT B comp y OFF")
    return prg
