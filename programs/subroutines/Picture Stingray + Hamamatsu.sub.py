...
def program(prg, cmd):
    ...
    prg.add(-490, "Trig Slow Stingray ON")
    ...
    prg.add(1010510, "Trig Slow Stingray OFF")
    prg.add(1020000, "Na Repumper1 (+) Amp", 1)
    prg.add(1999500, "Trig ON Stingray 1")
    prg.add(1999510, "Trig Slow Stingray ON")
    prg.add(2001500, "Trig OFF Stingray 1")
    prg.add(2010509, "Trig Slow Stingray OFF")
    prg.add(2999500, "Trig ON Stingray 1")
    prg.add(2999510, "Trig Slow Stingray ON")
    prg.add(3001500, "Trig OFF Stingray 1")
    prg.add(3010510, "Trig Slow Stingray OFF")
