...
def program(prg, cmd):
    ...
    prg.add(360000, "Na Probe/Push (+) freq", 116.00, enable=False)
    prg.add(360000, "Na Probe/Push (+) freq", 110.00)
    prg.add(370000, "Na Probe/Push (-) Amp", 500)
    prg.add(380000, "Na Probe/Push (+) Amp", 500)
