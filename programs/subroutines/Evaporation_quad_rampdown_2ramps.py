...
prg_version = "0.7"
def program(prg, cmd):
    prg.add(0, "Evaporation_setfull", ch0_amp=1000, ch0_freq=24000000.000, ch1_freq=24000000.000, ch0_phase=0.000, ch1_phase=0.000, ch1_amp=1, enable=False)
    ...
    prg.add(24000, "Evaporation amp", 1, functions=dict(time=lambda x: x +cmd.get_var('evap1_time') + cmd.get_var('evap2_time')+0.098), enable=False)
    return prg
