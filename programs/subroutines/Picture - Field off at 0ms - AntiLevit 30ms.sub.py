...
def program(prg, cmd):
    ...
    prg.add(-4060000, "Na Dark Spot Amp", 1)
    prg.add(-4050000, "Na Repumper MOT Amp", 1)
    prg.add(-2710000, "Shutter repump Na Open")
    prg.add(-2700000, "Shutter Probe Na Open")
    prg.add(-2210000, "Na Probe/Push (-) Amp", 1)
    prg.add(-2200000, "Na Probe/Push (+) Amp", 1)
    ...
    prg.add(10380, "IGBT 4 Open")
    prg.add(10390, "IGBT 5 Close")
    ...
    prg.add(250000, "IGBT B comp z OFF", enable=False)
    prg.add(261000, "B comp y", 1.0000)
    prg.add(295000, "IGBT 1 pinch", -10.0000)
    prg.add(295010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(295020, "IGBT 3 Open")
    prg.add(295030, "IGBT 4 Open")
    prg.add(295040, "IGBT 5 Open")
    prg.add(297500, "Na Repumper MOT Amp", 1000)
    prg.add(298000, "Na Repumper1 (+) Amp", 1000)
    prg.add(298400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(298800, "Na Probe/Push (+) freq", 110.00)
    prg.add(299200, "Na Probe/Push (-) freq", 110.00)
    prg.add(299500, "Trig ON Stingray 1")
    prg.add(299600, "Na Probe/Push (+) Amp", 1000)
    prg.add(300000, "Na Probe/Push (-) Amp", 1000)
    prg.add(301000, "Na Probe/Push (-) Amp", 1)
    prg.add(301500, "Trig OFF Stingray 1")
    prg.add(550000, "Shutter Probe Na Close")
    prg.add(1299500, "Trig ON Stingray 1")
    prg.add(1300000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1301000, "Na Probe/Push (-) Amp", 1)
    prg.add(1301500, "Trig OFF Stingray 1")
    prg.add(1310000, "Na Repumper MOT Amp", 1)
    prg.add(1320000, "Na Repumper1 (+) Amp", 1)
    ...
    prg.add(4300000, "B comp y", 0.0000)
    prg.add(4400000, "IGBT B comp y OFF")
    return prg
