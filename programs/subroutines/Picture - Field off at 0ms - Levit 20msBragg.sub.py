...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-4199000, "Na Repumper1 (+) Amp", 1)
    prg.add(-4159000, "Na Dark Spot Amp", 1)
    prg.add(-4149000, "Na Repumper MOT Amp", 1)
    prg.add(-2809000, "Shutter repump Na Open")
    prg.add(-2799000, "Shutter Probe Na Open")
    prg.add(-2309000, "Na Probe/Push (-) Amp", 1)
    prg.add(-2299000, "Na Probe/Push (+) Amp", 1)
    ...
    prg.add(150000, "IGBT B comp z OFF")
    prg.add(182000, "B comp y", 1.0000)
    prg.add(195000, "IGBT 1 pinch", -10.0000)
    prg.add(195010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(195020, "IGBT 3 Open")
    prg.add(195030, "IGBT 4 Open")
    prg.add(195040, "IGBT 5 Open")
    prg.add(200000, "Bragg Pulse Single.sub")
    prg.add(278500, "Na Repumper MOT Amp", 1000)
    prg.add(279000, "Na Repumper1 (+) Amp", 1000)
    prg.add(279400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(279800, "Na Probe/Push (+) freq", 115.00)
    prg.add(280200, "Na Probe/Push (-) freq", 105.00)
    prg.add(280500, "Trig ON Stingray 1")
    prg.add(280600, "Na Probe/Push (+) Amp", 1000)
    prg.add(281000, "Na Probe/Push (-) Amp", 1000)
    prg.add(282000, "Na Probe/Push (-) Amp", 1)
    prg.add(282500, "Trig OFF Stingray 1")
    prg.add(531000, "Shutter Probe Na Close")
    prg.add(1280500, "Trig ON Stingray 1")
    prg.add(1281000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1282000, "Na Probe/Push (-) Amp", 1)
    prg.add(1282500, "Trig OFF Stingray 1")
    prg.add(1291000, "Na Repumper MOT Amp", 1)
    prg.add(1301000, "Na Repumper1 (+) Amp", 1)
    prg.add(2280500, "Trig ON Stingray 1")
    prg.add(2282500, "Trig OFF Stingray 1")
    prg.add(3280500, "Trig ON Stingray 1")
    prg.add(3282500, "Trig OFF Stingray 1")
    prg.add(4281000, "B comp y", 0.0000)
    prg.add(4380000, "IGBT B comp y OFF")
    return prg
