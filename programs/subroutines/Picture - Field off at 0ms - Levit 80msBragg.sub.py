...
def program(prg, cmd):
    ...
    prg.add(-3003000, "Shutter Bragg Open")
    ...
    prg.add(-1019000, "Na 3D MOT cool (+) Amp", 1)
    prg.add(-500000, "Shutter Bragg Close")
    prg.add(-200000, "Shutter 3DMOT cool Na Open")
    prg.add(-10000, "Na 3D MOT cool (+) freq", 110.00)
    prg.add(-9500, "B comp y", 0.0000)
    prg.add(-9000, "Na 3D MOT cool (-) freq", 110.00)
