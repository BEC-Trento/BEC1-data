...
def program(prg, cmd):
    ...
    prg.add(-2892000, "K probe Repumper (+) Amp", 1)
    prg.add(-2882000, "K Repumper 1p (+) Amp", 1)
    prg.add(-2862000, "Na Dark Spot Amp", 1)
    prg.add(-2852000, "Na Repumper MOT Amp", 1)
    prg.add(-2500000, "Shutter Bragg Open", enable=False)
    ...
    prg.add(-992000, "K probe Cooler (-) Amp", 1)
    ...
    prg.add(10410, "Delta 1 Current", 15.200)
    ...
    prg.add(400400, "Shutter 3DMOT cool Na Close")
    prg.add(900699, "Shutter Bragg Open")
    prg.add(1482000, "B comp y", 1.0000)
    prg.add(1495000, "IGBT 1 pinch", -10.0000)
    prg.add(1495010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(1495020, "IGBT 3 Open")
    prg.add(1495029, "IGBT 4 Open")
    prg.add(1495040, "IGBT 5 Open")
    prg.add(1495050, "IGBT 6 Open")
    prg.add(1495600, "K probe Cooler (-) freq", 99.50)
    prg.add(1496000, "K Cooler 2p (+) freq", 97.50)
    prg.add(1496399, "K Repumper 1p (+) Amp", 1000)
    prg.add(1496800, "K Repumper 1p (+) freq", 115.00)
    prg.add(1497200, "K Repumper 2p (+) freq", 96.00)
    prg.add(1498500, "Na Repumper MOT Amp", 1000)
    prg.add(1499000, "Na Repumper1 (+) Amp", 1000)
    prg.add(1499400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(1499800, "Na Probe/Push (+) freq", 110.00, enable=False)
    prg.add(1499800, "Na 3D MOT cool (+) freq", 110.00)
    prg.add(1500149, "Na Repumper1 (+) Amp", 1)
    prg.add(1500200, "Na Probe/Push (-) freq", 110.00, enable=False)
    prg.add(1500200, "Na 3D MOT cool (-) freq", 110.00)
    prg.add(1500250, "Na Repumper MOT Amp", 1)
    prg.add(1500500, "Trig ON Stingray 1")
    prg.add(1500600, "Na Probe/Push (+) Amp", 1000, enable=False)
    prg.add(1500600, "Na 3D MOT cool (+) Amp", 1000)
    prg.add(1501000, "Na Probe/Push (-) Amp", 1000, enable=False)
    prg.add(1501000, "Na 3D MOT cool (-) Amp", 1000)
    prg.add(1501399, "K probe Cooler (-) Amp", 1000)
    prg.add(1502050, "Na Probe/Push (-) Amp", 1, enable=False)
    prg.add(1502050, "Na 3D MOT cool (-) Amp", 1)
    prg.add(1502400, "K probe Cooler (-) Amp", 1)
    ...
    prg.add(2501000, "Na Probe/Push (-) Amp", 1000, enable=False)
    prg.add(2501400, "K probe Cooler (-) Amp", 1000)
    prg.add(2502000, "Na Probe/Push (-) Amp", 1, enable=False)
    prg.add(2502400, "K probe Cooler (-) Amp", 1)
    prg.add(2503000, "Trig OFF Stingray 1")
    prg.add(2511000, "Na Repumper MOT Amp", 1, enable=False)
    prg.add(2521000, "Na Repumper1 (+) Amp", 1, enable=False)
    prg.add(2531000, "K Repumper 1p (+) Amp", 1)
    ...
    prg.add(5501000, "B comp y", 0.0000)
