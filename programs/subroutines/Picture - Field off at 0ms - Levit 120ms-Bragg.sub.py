...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-3200000, "Na Repumper Tune (+) freq", 1713.000000)
    ...
    prg.add(-2920000, "Shutter 3DMOT cool Na Open")
    prg.add(-2430000, "Na 3D MOT cool (-) Amp", 1.000000)
    prg.add(-2420000, "Na 3D MOT cool (+) Amp", 1.000000)
    prg.add(-1410000, "Shutter Probe Na Open")
    ...
    prg.add(10410, "Delta 1 Current", 15.500000)
    ...
    prg.add(400000, "Shutter repump Na Open")
    prg.add(1150000, "IGBT B comp z OFF")
    ...
    prg.add(1198000, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(1199000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(1199800, "Na Probe/Push (+) freq", 110.000000)
    prg.add(1200000, "Na Repumper MOT Amp", 1000.000000)
    ...
    prg.add(1202500, "Trig OFF Stingray 1")
    ...
    prg.add(5300000, "IGBT B comp y OFF")
    return prg
