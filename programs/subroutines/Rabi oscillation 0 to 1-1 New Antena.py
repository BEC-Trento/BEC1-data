...
def program(prg, cmd):
    ...
    prg.add(800, "Analog71 Ramp", start_t=0.0000, stop_x=0.000, n_points=300, start_x=0.325, stop_t=50.0000)
    prg.add(900, "B comp y ramp", start_t=0, stop_x=0.15, n_points=300, start_x=1500, stop_t=50)
    prg.add(1100, "B comp x ramp", start_t=0, stop_x=2050, n_points=300, start_x=0, stop_t=50)
