...
def program(prg, cmd):
    ...
    prg.add(1100, "B comp x ramp", start_t=0, stop_x=1129, n_points=300, start_x=0, stop_t=50)
    prg.add(521100, "RFO2 Amp", 1)
    prg.add(523100, "RFO", 701)
    prg.add(524100, "RFO2 Amp", 400)
    prg.add(525100, "RF02 ON")
    prg.add(525230, "RF02 OFF")
    prg.add(525330, "RFO", 0)
    prg.add(525430, "RFO2 Amp", 1)
    return prg
