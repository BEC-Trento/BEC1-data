...
def program(prg, cmd):
    ...
    prg.add(-299000, "TTL Repumper MOT OFF")
    ...
    prg.add(-195000, "TTL Probe y ON", enable=False)
    prg.add(-194000, "TTL Repumper MOT ON", enable=False)
    prg.add(-190000, "Shutter repump Na Open")
    prg.add(-180000, "Shutter Probe/Push Open")
    return prg
