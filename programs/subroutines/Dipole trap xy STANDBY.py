...
def program(prg, cmd):
    ...
    prg.add(500, "Dipole Trap x AOM (+) Amp", 1000)
    prg.add(1000, "Dipole Trap y DAC V", 0.000)
    prg.add(1500, "Dipole Trap y AOM (-) Amp", 1000)
    prg.add(2000, "Dipole Trap x AOM (+) freq", 60.00)
    prg.add(3000, "Dipole Trap y AOM (-) freq", 60.00)
