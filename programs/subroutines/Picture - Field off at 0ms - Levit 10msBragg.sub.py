...
def program(prg, cmd):
    ...
    prg.add(60000, "Bragg Pulse Single.sub", enable=False)
    prg.add(82000, "B comp y", 1.0000)
    prg.add(95000, "IGBT 1 pinch", -10.0000)
    prg.add(95010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(95020, "IGBT 3 Open")
    prg.add(95030, "IGBT 4 Open")
    prg.add(95040, "IGBT 5 Open")
    prg.add(148500, "Na Repumper MOT Amp", 1000)
    prg.add(149000, "Na Repumper1 (+) Amp", 1000)
    prg.add(149400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(149800, "Na Probe/Push (+) freq", 110.00)
    prg.add(150200, "Na Probe/Push (-) freq", 110.00)
    prg.add(150500, "Trig ON Stingray 1")
    prg.add(150600, "Na Probe/Push (+) Amp", 1000)
    prg.add(151000, "Na Probe/Push (-) Amp", 1000)
    prg.add(152000, "Na Probe/Push (-) Amp", 1)
    prg.add(152500, "Trig OFF Stingray 1")
    prg.add(401000, "Shutter Probe Na Close")
    prg.add(1150500, "Trig ON Stingray 1")
    prg.add(1151000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1152000, "Na Probe/Push (-) Amp", 1)
    prg.add(1152500, "Trig OFF Stingray 1")
    prg.add(1161000, "Na Repumper MOT Amp", 1)
    prg.add(1171000, "Na Repumper1 (+) Amp", 1)
    prg.add(2150500, "Trig ON Stingray 1")
    prg.add(2152500, "Trig OFF Stingray 1")
    prg.add(3150500, "Trig ON Stingray 1")
    prg.add(3152500, "Trig OFF Stingray 1")
    prg.add(4151000, "B comp y", 0.0000)
    prg.add(4250000, "IGBT B comp y OFF")
    return prg
