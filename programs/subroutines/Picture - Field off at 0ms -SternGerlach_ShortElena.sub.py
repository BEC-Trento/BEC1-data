...
def program(prg, cmd):
    ...
    prg.add(42510, "IGBT 1 pinch", -10.0000)
    prg.add(42520, "IGBT 2 pinch+comp", -10.0000)
    prg.add(42530, "IGBT 3 Open")
    prg.add(42540, "IGBT 4 Open")
    prg.add(42550, "IGBT 5 Open")
    prg.add(46010, "Na Repumper MOT Amp", 1000)
    prg.add(46510, "Na Repumper1 (+) Amp", 1000)
    prg.add(46910, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(47310, "Na Probe/Push (+) freq", 110.00)
    prg.add(47710, "Na Probe/Push (-) freq", 110.00)
    prg.add(48010, "Trig ON Stingray 1")
    prg.add(48110, "Na Probe/Push (+) Amp", 1000)
    prg.add(48510, "Na Probe/Push (-) Amp", 1000)
    prg.add(49510, "Na Probe/Push (-) Amp", 1)
    prg.add(50010, "Trig OFF Stingray 1")
    prg.add(298510, "Shutter Probe Na Close")
    prg.add(1048010, "Trig ON Stingray 1")
    prg.add(1048510, "Na Probe/Push (-) Amp", 1000)
    prg.add(1049510, "Na Probe/Push (-) Amp", 1)
    prg.add(1050010, "Trig OFF Stingray 1")
    prg.add(1058510, "Na Repumper MOT Amp", 1)
    prg.add(1068510, "Na Repumper1 (+) Amp", 1)
    prg.add(2048010, "Trig ON Stingray 1")
    prg.add(2050010, "Trig OFF Stingray 1")
    prg.add(3048010, "Trig ON Stingray 1")
    prg.add(3050010, "Trig OFF Stingray 1")
    prg.add(4048510, "B comp y", 0.0000, enable=False)
    prg.add(4147510, "IGBT B comp y OFF")
    return prg
