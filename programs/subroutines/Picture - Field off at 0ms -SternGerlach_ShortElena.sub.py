...
def program(prg, cmd):
    ...
    prg.add(62510, "IGBT 1 pinch", -10.0000)
    prg.add(62520, "IGBT 2 pinch+comp", -10.0000)
    prg.add(62530, "IGBT 3 Open")
    prg.add(62540, "IGBT 4 Open")
    prg.add(62550, "IGBT 5 Open")
    prg.add(66010, "Na Repumper MOT Amp", 1000)
    prg.add(66510, "Na Repumper1 (+) Amp", 1000)
    prg.add(66910, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(67310, "Na Probe/Push (+) freq", 110.00)
    prg.add(67710, "Na Probe/Push (-) freq", 110.00)
    prg.add(68010, "Trig ON Stingray 1")
    prg.add(68110, "Na Probe/Push (+) Amp", 1000)
    prg.add(68510, "Na Probe/Push (-) Amp", 1000)
    prg.add(69510, "Na Probe/Push (-) Amp", 1)
    prg.add(70010, "Trig OFF Stingray 1")
    prg.add(318510, "Shutter Probe Na Close")
    prg.add(1068010, "Trig ON Stingray 1")
    prg.add(1068510, "Na Probe/Push (-) Amp", 1000)
    prg.add(1069510, "Na Probe/Push (-) Amp", 1)
    prg.add(1070010, "Trig OFF Stingray 1")
    prg.add(1078510, "Na Repumper MOT Amp", 1)
    prg.add(1088510, "Na Repumper1 (+) Amp", 1)
    prg.add(2068010, "Trig ON Stingray 1")
    prg.add(2070010, "Trig OFF Stingray 1")
    prg.add(3068010, "Trig ON Stingray 1")
    prg.add(3070010, "Trig OFF Stingray 1")
    prg.add(4068510, "B comp y", 0.0000, enable=False)
    prg.add(4167510, "IGBT B comp y OFF")
    return prg
