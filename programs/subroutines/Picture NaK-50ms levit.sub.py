...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-3899000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(-3889000, "K probe Repumper (+) Amp", 1.000000)
    prg.add(-3879000, "K Repumper 1p (+) Amp", 1.000000)
    prg.add(-3869000, "K probe Cooler (-) Amp", 1.000000)
    prg.add(-3859000, "Na Dark Spot Amp", 1.000000)
    prg.add(-3849000, "Na Repumper MOT Amp", 1.000000)
    prg.add(-2529000, "Shutter Probe K Open")
    prg.add(-2519000, "Shutter RepumperMOT K Open")
    prg.add(-2509000, "Shutter repump Na Open")
    prg.add(-2499000, "Shutter Probe Na Open")
    prg.add(-2009000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(-1999000, "Na Probe/Push (+) Amp", 1.000000)
    ...
    prg.add(495000, "IGBT 1 pinch", -10.000000)
    prg.add(495010, "IGBT 2 pinch+comp", -10.000000)
    prg.add(495020, "IGBT 3 Open")
    prg.add(495030, "IGBT 4 Open")
    prg.add(495040, "IGBT 5 Open")
    prg.add(495600, "K probe Cooler (-) freq", 99.500000)
    prg.add(496000, "K Cooler 2p (+) freq", 97.500000)
    prg.add(496400, "K Repumper 1p (+) Amp", 1000.000000)
    prg.add(496800, "K Repumper 1p (+) freq", 115.000000)
    prg.add(497200, "K Repumper 2p (+) freq", 96.000000)
    prg.add(498500, "Na Repumper MOT Amp", 1000.000000)
    prg.add(499000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(499400, "Na Repumper Tune (+) freq", 1713.000000)
    ...
    prg.add(501400, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(502000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(502400, "K probe Cooler (-) Amp", 1.000000)
    prg.add(503000, "Trig OFF Stingray 1")
    prg.add(751000, "Shutter Probe Na Close")
    prg.add(761000, "Shutter Probe K Close")
    ...
    prg.add(1531000, "K Repumper 1p (+) Amp", 1.000000)
