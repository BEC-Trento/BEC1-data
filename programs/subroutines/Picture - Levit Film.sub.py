...
def program(prg, cmd):
    ...
    prg.add(982000, "B comp y", 1.0000)
    prg.add(995000, "IGBT 1 pinch", -10.0000)
    prg.add(995010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(995020, "IGBT 3 Open")
    prg.add(995029, "IGBT 4 Open")
    prg.add(995040, "IGBT 5 Open")
    prg.add(995050, "IGBT 6 Open")
    prg.add(995070, "Na Probe/Push (-) Amp", 1)
    prg.add(995400, "Na Probe/Push (+) Amp", 1)
    prg.add(998500, "Na Repumper MOT Amp", 1000)
    prg.add(999000, "Na Repumper1 (+) Amp", 1000)
    prg.add(999400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(999800, "Na Probe/Push (+) freq", 110.00)
    prg.add(1000200, "Na Probe/Push (-) freq", 110.00)
    prg.add(1000500, "Trig Slow Stingray ON")
    prg.add(1000600, "Na Probe/Push (+) Amp", 1000)
    prg.add(1001000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1001399, "K probe Cooler (-) Amp", 1000)
    prg.add(1002050, "Na Probe/Push (-) Amp", 1)
    prg.add(1002400, "K probe Cooler (-) Amp", 1)
    prg.add(1003000, "Trig Slow Stingray OFF")
    prg.add(1251000, "Shutter Probe Na Close")
    prg.add(1500000, "Optical Levit ON")
    prg.add(2000500, "Trig Slow Stingray ON")
    prg.add(2001000, "Na Probe/Push (-) Amp", 1000)
    prg.add(2001400, "K probe Cooler (-) Amp", 1000)
    prg.add(2002000, "Na Probe/Push (-) Amp", 1)
    prg.add(2002400, "K probe Cooler (-) Amp", 1)
    prg.add(2003000, "Trig Slow Stingray OFF")
    prg.add(2011000, "Na Repumper MOT Amp", 1)
    prg.add(2021000, "Na Repumper1 (+) Amp", 1)
    prg.add(2031000, "K Repumper 1p (+) Amp", 1)
    prg.add(3000500, "Trig Slow Stingray ON")
    prg.add(3002500, "Trig Slow Stingray OFF")
    prg.add(4000500, "Trig Slow Stingray ON")
    prg.add(4002500, "Trig Slow Stingray OFF")
    prg.add(4511000, "Optical Levit OFF")
    prg.add(4750000, "Shutter Optical Levit Close")
    prg.add(5001000, "B comp y", 0.0000)
    prg.add(9500000, "Optical Levit ON")
    return prg
