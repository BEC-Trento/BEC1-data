...
def program(prg, cmd):
    ...
    prg.add(-1532000, "Shutter Probe K Open", enable=False)
    ...
    prg.add(495029, "IGBT 4 Open")
    prg.add(495040, "IGBT 5 Open")
    prg.add(495050, "IGBT 6 Open")
    prg.add(495070, "Na Probe/Push (-) Amp", 1)
    prg.add(495400, "Na Probe/Push (+) Amp", 1)
    ...
    prg.add(1501400, "K probe Cooler (-) Amp", 1000)
    ...
    prg.add(2502500, "Trig Slow Stingray OFF")
    prg.add(3500500, "Trig Slow Stingray ON")
    prg.add(3502500, "Trig Slow Stingray OFF")
    prg.add(4011000, "Optical Levit OFF")
    prg.add(4250000, "Shutter Optical Levit Close")
