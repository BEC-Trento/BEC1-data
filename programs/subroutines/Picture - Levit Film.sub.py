...
def program(prg, cmd):
    ...
    prg.add(-1522000, "Shutter RepumperMOT K Open", enable=False)
    ...
    prg.add(1795070, "Na Probe/Push (-) Amp", 1)
    prg.add(1795400, "Na Probe/Push (+) Amp", 1)
    ...
    prg.add(1800500, "Trig Slow Stingray ON")
    ...
    prg.add(1803000, "Trig Slow Stingray OFF")
    prg.add(2051000, "Shutter Probe Na Close")
    prg.add(2061000, "Shutter Probe K Close")
    prg.add(2300000, "Optical Levit ON")
    prg.add(2800500, "Trig Slow Stingray ON")
    prg.add(2801000, "Na Probe/Push (-) Amp", 1000)
    prg.add(2801400, "K probe Cooler (-) Amp", 1000)
    prg.add(2802000, "Na Probe/Push (-) Amp", 1)
    prg.add(2802400, "K probe Cooler (-) Amp", 1)
    prg.add(2803000, "Trig Slow Stingray OFF")
    prg.add(2811000, "Na Repumper MOT Amp", 1)
    prg.add(2821000, "Na Repumper1 (+) Amp", 1)
    prg.add(2831000, "K Repumper 1p (+) Amp", 1)
    prg.add(3800500, "Trig Slow Stingray ON")
    prg.add(3802500, "Trig Slow Stingray OFF")
    prg.add(4800500, "Trig Slow Stingray ON")
    prg.add(4802500, "Trig Slow Stingray OFF")
    prg.add(5311000, "Optical Levit OFF")
    prg.add(5550000, "Shutter Optical Levit Close")
    prg.add(5801000, "B comp y", 0.0000)
    prg.add(10300000, "Optical Levit ON")
    return prg
