...
def program(prg, cmd):
    ...
    prg.add(-2852000, "Na Repumper MOT Amp", 1, enable=False)
    ...
    prg.add(1195029, "IGBT 4 Open")
    prg.add(1195040, "IGBT 5 Open")
    prg.add(1195050, "IGBT 6 Open")
    prg.add(1195070, "Na Probe/Push (-) Amp", 1)
    prg.add(1195400, "Na Probe/Push (+) Amp", 1)
    ...
    prg.add(2203000, "Trig Slow Stingray OFF")
    prg.add(2211000, "Na Repumper MOT Amp", 1)
    prg.add(2221000, "Na Repumper1 (+) Amp", 1)
    prg.add(2231000, "K Repumper 1p (+) Amp", 1)
    prg.add(3200500, "Trig Slow Stingray ON")
    prg.add(3202500, "Trig Slow Stingray OFF")
    prg.add(4200500, "Trig Slow Stingray ON")
    prg.add(4202500, "Trig Slow Stingray OFF")
    prg.add(4711000, "Optical Levit OFF")
    prg.add(4950000, "Shutter Optical Levit Close")
    prg.add(5201000, "B comp y", 0.0000)
    prg.add(9700000, "Optical Levit ON")
    return prg
