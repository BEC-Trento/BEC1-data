...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-4299000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(-4289000, "K probe Repumper (+) Amp", 1.000000)
    prg.add(-4279000, "K Repumper 1p (+) Amp", 1.000000)
    prg.add(-4269000, "K probe Cooler (-) Amp", 1.000000)
    prg.add(-4259000, "Na Dark Spot Amp", 1.000000)
    prg.add(-4249000, "Na Repumper MOT Amp", 1.000000)
    prg.add(-2929000, "Shutter Probe K Open")
    prg.add(-2919000, "Shutter RepumperMOT K Open")
    prg.add(-2909000, "Shutter repump Na Open")
    prg.add(-2899000, "Shutter Probe Na Open")
    prg.add(-2409000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(-2399000, "Na Probe/Push (+) Amp", 1.000000)
    ...
    prg.add(82000, "B comp y", 1.000000)
    prg.add(95000, "IGBT 1 pinch", -10.000000)
    prg.add(95010, "IGBT 2 pinch+comp", -10.000000)
    prg.add(95020, "IGBT 3 Open")
    prg.add(95030, "IGBT 4 Open")
    prg.add(95040, "IGBT 5 Open")
    prg.add(95600, "K probe Cooler (-) freq", 99.500000)
    prg.add(96000, "K Cooler 2p (+) freq", 97.500000)
    prg.add(96400, "K Repumper 1p (+) Amp", 1000.000000)
    prg.add(96800, "K Repumper 1p (+) freq", 115.000000)
    prg.add(97200, "K Repumper 2p (+) freq", 96.000000)
    prg.add(98500, "Na Repumper MOT Amp", 1000.000000)
    prg.add(99000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(99400, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(99800, "Na Probe/Push (+) freq", 110.000000)
    prg.add(100200, "Na Probe/Push (-) freq", 110.000000)
    prg.add(100500, "Trig ON Stingray 1")
    prg.add(100600, "Na Probe/Push (+) Amp", 1000.000000)
    prg.add(101000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(101400, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(102000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(102400, "K probe Cooler (-) Amp", 1.000000)
    prg.add(103000, "Trig OFF Stingray 1")
    prg.add(351000, "Shutter Probe Na Close")
    prg.add(361000, "Shutter Probe K Close")
    prg.add(1100500, "Trig ON Stingray 1")
    prg.add(1101000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(1101400, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(1102000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(1102400, "K probe Cooler (-) Amp", 1.000000)
    prg.add(1103000, "Trig OFF Stingray 1")
    prg.add(1111000, "Na Repumper MOT Amp", 1.000000)
    prg.add(1121000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(1131000, "K Repumper 1p (+) Amp", 1.000000)
    prg.add(2100500, "Trig ON Stingray 1")
    prg.add(2102500, "Trig OFF Stingray 1")
    prg.add(3100500, "Trig ON Stingray 1")
    prg.add(3102500, "Trig OFF Stingray 1")
    prg.add(4101000, "B comp y", 0.000000)
    return prg
