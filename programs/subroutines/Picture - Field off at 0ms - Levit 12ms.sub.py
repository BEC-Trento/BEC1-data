...
def program(prg, cmd):
    ...
    prg.add(102000, "B comp y", 1.0000)
    prg.add(115000, "IGBT 1 pinch", -10.0000)
    prg.add(115010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(115020, "IGBT 3 Open")
    prg.add(115030, "IGBT 4 Open")
    prg.add(115040, "IGBT 5 Open")
    prg.add(118500, "Na Repumper MOT Amp", 1000)
    prg.add(119000, "Na Repumper1 (+) Amp", 1000)
    prg.add(119400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(119800, "Na Probe/Push (+) freq", 110.00)
    prg.add(120200, "Na Probe/Push (-) freq", 110.00)
    prg.add(120500, "Trig ON Stingray 1")
    prg.add(120600, "Na Probe/Push (+) Amp", 1000)
    prg.add(121000, "Na Probe/Push (-) Amp", 1000)
    prg.add(122000, "Na Probe/Push (-) Amp", 1)
    prg.add(122500, "Trig OFF Stingray 1")
    prg.add(371000, "Shutter Probe Na Close")
    prg.add(1120500, "Trig ON Stingray 1")
    prg.add(1121000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1122000, "Na Probe/Push (-) Amp", 1)
    prg.add(1122500, "Trig OFF Stingray 1")
    prg.add(1131000, "Na Repumper MOT Amp", 1)
    prg.add(1141000, "Na Repumper1 (+) Amp", 1)
    prg.add(2120500, "Trig ON Stingray 1")
    prg.add(2122500, "Trig OFF Stingray 1")
    prg.add(3120500, "Trig ON Stingray 1")
    prg.add(3122500, "Trig OFF Stingray 1")
    prg.add(4121000, "B comp y", 0.0000)
    prg.add(4220000, "IGBT B comp y OFF")
    return prg
