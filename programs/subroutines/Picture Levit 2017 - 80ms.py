...
def program(prg, cmd):
    ...
    prg.add(790000, "Config Field OFF.sub")
    prg.add(800000, "Picture NaK for Levit 2017.sub")
    prg.add(800000, "Picture NaK for Levit 2017 Trig2.sub", enable=False)
    prg.add(4802000, "B comp y", 0.0000)
    return prg
