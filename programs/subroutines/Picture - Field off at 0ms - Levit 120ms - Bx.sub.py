...
def program(prg, cmd):
    ...
    prg.add(1182000, "B comp x", 2000.000000)
    ...
    prg.add(1199000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(1199400, "Na Repumper MOT Amp", 1.000000)
    ...
    prg.add(5201000, "B comp x", 0.000000)
    return prg
