...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-59000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(-39000, "Na Repumper MOT Amp", 1.000000)
    prg.add(-29000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(-19000, "Na Probe/Push (+) Amp", 1.000000)
    prg.add(-9500, "B comp y", 0.000000)
    prg.add(-9000, "Shutter repump Na Open")
    ...
    prg.add(1000, "Shutter Probe Na Open")
    ...
    prg.add(1001000, "Na Dark Spot Amp", 1.000000)
