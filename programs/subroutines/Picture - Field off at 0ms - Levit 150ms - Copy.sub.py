...
def program(prg, cmd):
    ...
    prg.add(1478500, "Na Repumper MOT Amp", 1000.000000)
    prg.add(1479000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(1479400, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(1482000, "B comp y", 1.000000)
    prg.add(1491000, "Na Repumper MOT Amp", 1.000000)
    prg.add(1492000, "Na Repumper1 (+) Amp", 1.000000)
