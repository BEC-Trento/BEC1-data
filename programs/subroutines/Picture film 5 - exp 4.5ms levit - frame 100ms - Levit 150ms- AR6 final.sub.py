...
def program(prg, cmd):
    ...
    prg.add(-80, "Pulse uw ON")
    prg.add(0, "Pulse uw OFF")
    prg.add(1000, "Optical Levit OFF")
    prg.add(44500, "Trig ON Stingray 1")
    prg.add(45000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(46000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(46500, "Trig OFF Stingray 1")
    prg.add(132060, "Optical Levit ON")
    prg.add(999920, "Pulse uw ON")
    prg.add(1000000, "Pulse uw OFF")
    prg.add(1001000, "Optical Levit OFF")
    prg.add(1044500, "Trig ON Stingray 1")
    prg.add(1045000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(1046000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(1046500, "Trig OFF Stingray 1")
    prg.add(1132060, "Optical Levit ON")
    prg.add(1999920, "Pulse uw ON")
    prg.add(2000000, "Pulse uw OFF")
    prg.add(2001000, "Optical Levit OFF")
    prg.add(2044500, "Trig ON Stingray 1")
    prg.add(2045000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(2046000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(2046500, "Trig OFF Stingray 1")
    ...
    prg.add(2999920, "Pulse uw ON")
    prg.add(3000000, "Pulse uw OFF")
    prg.add(3001000, "Optical Levit OFF")
    prg.add(3044500, "Trig ON Stingray 1")
    prg.add(3045000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(3046000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(3046500, "Trig OFF Stingray 1")
    ...
    prg.add(3999920, "Pulse uw ON")
    prg.add(4000000, "Pulse uw OFF")
    prg.add(4001000, "Optical Levit OFF")
    prg.add(4008000, "K probe Cooler (-) Amp", 1.000000)
    prg.add(4044500, "Trig ON Stingray 1")
    prg.add(4045000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(4046000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(4046500, "Trig OFF Stingray 1")
