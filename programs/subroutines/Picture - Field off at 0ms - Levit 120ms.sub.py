...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-3202000, "Na Repumper1 (+) Amp", 1)
    prg.add(-3192000, "K probe Repumper (+) Amp", 1)
    prg.add(-3182000, "K Repumper 1p (+) Amp", 1)
    prg.add(-3162000, "Na Dark Spot Amp", 1)
    prg.add(-3152000, "Na Repumper MOT Amp", 1)
    prg.add(-2802000, "Shutter Probe Na Open")
    prg.add(-2312000, "Na Probe/Push (-) Amp", 1)
    prg.add(-2302000, "Na Probe/Push (+) Amp", 1)
    prg.add(-1832000, "Shutter Probe K Open")
    prg.add(-1822000, "Shutter RepumperMOT K Open")
    prg.add(-1812000, "Shutter repump Na Open")
    prg.add(-1292000, "K probe Cooler (-) Amp", 1)
    prg.add(-829000, "Na 3D MOT cool (-) Amp", 1)
    prg.add(-819000, "Na 3D MOT cool (+) Amp", 1)
    ...
    prg.add(10410, "Delta 1 Current", 15.700)
    ...
    prg.add(1182000, "B comp y", 1.0000)
    prg.add(1195000, "IGBT 1 pinch", -10.0000)
    prg.add(1195010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(1195020, "IGBT 3 Open")
    prg.add(1195030, "IGBT 4 Open")
    prg.add(1195040, "IGBT 5 Open")
    prg.add(1195050, "IGBT 6 Open")
    prg.add(1195600, "K probe Cooler (-) freq", 99.50)
    prg.add(1196000, "K Cooler 2p (+) freq", 97.50)
    prg.add(1196400, "K Repumper 1p (+) Amp", 1000)
    prg.add(1196800, "K Repumper 1p (+) freq", 115.00)
    prg.add(1197200, "K Repumper 2p (+) freq", 96.00)
    prg.add(1198500, "Na Repumper MOT Amp", 1000)
    prg.add(1199000, "Na Repumper1 (+) Amp", 1000)
    prg.add(1199400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(1199800, "Na Probe/Push (+) freq", 110.00)
    prg.add(1200200, "Na Probe/Push (-) freq", 110.00)
    prg.add(1200500, "Trig ON Stingray 1")
    prg.add(1200600, "Na Probe/Push (+) Amp", 1000)
    prg.add(1201000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1201400, "K probe Cooler (-) Amp", 1000)
    prg.add(1202050, "Na Probe/Push (-) Amp", 1)
    prg.add(1202400, "K probe Cooler (-) Amp", 1)
    ...
    prg.add(2201000, "Na Probe/Push (-) Amp", 1000)
    prg.add(2201400, "K probe Cooler (-) Amp", 1000)
    prg.add(2202000, "Na Probe/Push (-) Amp", 1)
    prg.add(2202400, "K probe Cooler (-) Amp", 1)
    prg.add(2203000, "Trig OFF Stingray 1")
    prg.add(2211000, "Na Repumper MOT Amp", 1)
    prg.add(2221000, "Na Repumper1 (+) Amp", 1)
    prg.add(2231000, "K Repumper 1p (+) Amp", 1)
    ...
    prg.add(5201000, "B comp y", 0.0000)
    return prg
