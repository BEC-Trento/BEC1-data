...
def program(prg, cmd):
    ...
    prg.add(37510, "IGBT 1 pinch", -10.0000)
    prg.add(37520, "IGBT 2 pinch+comp", -10.0000)
    prg.add(37530, "IGBT 3 Open")
    prg.add(37540, "IGBT 4 Open")
    prg.add(37550, "IGBT 5 Open")
    prg.add(41010, "Na Repumper1 (+) Amp", 1000)
    prg.add(41510, "Na Repumper MOT Amp", 400)
    prg.add(41610, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(41910, "Na Probe/Push (+) freq", 110.00)
    prg.add(42230, "Na Probe/Push (-) freq", 110.00)
    prg.add(42430, "Na Repumper MOT Amp", 1, enable=False)
    prg.add(42530, "Trig ON Stingray 1")
    prg.add(42630, "Na Probe/Push (+) Amp", 1000)
    prg.add(43030, "Na Probe/Push (-) Amp", 1000)
    prg.add(44030, "Na Probe/Push (-) Amp", 1)
    prg.add(44530, "Trig OFF Stingray 1")
    prg.add(293030, "Shutter Probe Na Close")
    prg.add(1042530, "Trig ON Stingray 1")
    prg.add(1043030, "Na Probe/Push (-) Amp", 1000)
    prg.add(1044030, "Na Probe/Push (-) Amp", 1)
    prg.add(1044530, "Trig OFF Stingray 1")
    prg.add(1053030, "Na Repumper MOT Amp", 1)
    prg.add(1063030, "Na Repumper1 (+) Amp", 1)
    prg.add(2042530, "Trig ON Stingray 1")
    prg.add(2044530, "Trig OFF Stingray 1")
    prg.add(3042530, "Trig ON Stingray 1")
    prg.add(3044530, "Trig OFF Stingray 1")
    prg.add(4043030, "B comp y", 0.0000, enable=False)
    prg.add(4142030, "IGBT B comp y OFF")
    return prg
