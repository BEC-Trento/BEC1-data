...
def program(prg, cmd):
    ...
    prg.add(795600, "K probe Cooler (-) freq", 99.50)
    prg.add(796000, "K Cooler 2p (+) freq", 97.50)
    prg.add(796400, "K Repumper 1p (+) Amp", 1000)
    prg.add(796800, "K Repumper 1p (+) freq", 115.00)
    prg.add(797200, "K Repumper 2p (+) freq", 96.00)
    ...
    prg.add(800500, "Trig ON Stingray 2")
    prg.add(800600, "Na Probe/Push (+) Amp", 1000)
    prg.add(801000, "Na Probe/Push (-) Amp", 1000)
    prg.add(801400, "K probe Cooler (-) Amp", 1000)
    prg.add(802050, "Na Probe/Push (-) Amp", 1)
    prg.add(802400, "K probe Cooler (-) Amp", 1)
    prg.add(803000, "Trig OFF Stingray 2")
    prg.add(1051000, "Shutter Probe Na Close")
    prg.add(1800500, "Trig ON Stingray 2")
    prg.add(1801000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1801399, "K probe Cooler (-) Amp", 1000)
    prg.add(1802000, "Na Probe/Push (-) Amp", 1)
    prg.add(1802400, "K probe Cooler (-) Amp", 1)
    prg.add(1803000, "Trig OFF Stingray 2")
    prg.add(1811000, "Na Repumper MOT Amp", 1)
    prg.add(1821000, "Na Repumper1 (+) Amp", 1)
    prg.add(1831000, "K Repumper 1p (+) Amp", 1)
    prg.add(2800500, "Trig ON Stingray 2")
    prg.add(2802500, "Trig OFF Stingray 2")
    prg.add(3800500, "Trig ON Stingray 2")
    prg.add(3802500, "Trig OFF Stingray 2")
