...
def program(prg, cmd):
    ...
    prg.add(10410, "Delta 1 Current", 12.000)
    ...
    prg.add(80000, "IGBT B comp z OFF")
    prg.add(112000, "B comp y", 3.0000)
    prg.add(125000, "IGBT 1 pinch", -10.0000)
    prg.add(125010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(125020, "IGBT 3 Open")
    prg.add(125030, "IGBT 4 Open")
    prg.add(125040, "IGBT 5 Open")
    prg.add(128500, "Na Repumper MOT Amp", 1000)
    prg.add(129000, "Na Repumper1 (+) Amp", 1000)
    prg.add(129400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(129800, "Na Probe/Push (+) freq", 110.00)
    prg.add(130200, "Na Probe/Push (-) freq", 110.00)
    prg.add(130500, "Trig ON Stingray 1")
    prg.add(130600, "Na Probe/Push (+) Amp", 1000)
    prg.add(131000, "Na Probe/Push (-) Amp", 1000)
    prg.add(132000, "Na Probe/Push (-) Amp", 1)
    prg.add(132500, "Trig OFF Stingray 1")
    prg.add(381000, "Shutter Probe Na Close")
    prg.add(1130500, "Trig ON Stingray 1")
    prg.add(1131000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1132000, "Na Probe/Push (-) Amp", 1)
    prg.add(1132500, "Trig OFF Stingray 1")
    prg.add(1141000, "Na Repumper MOT Amp", 1)
    prg.add(1151000, "Na Repumper1 (+) Amp", 1)
    prg.add(2130500, "Trig ON Stingray 1")
    prg.add(2132500, "Trig OFF Stingray 1")
    prg.add(3130500, "Trig ON Stingray 1")
    prg.add(3132500, "Trig OFF Stingray 1")
    prg.add(4131000, "B comp y", 0.0000, enable=False)
    prg.add(4230000, "IGBT B comp y OFF")
    return prg
