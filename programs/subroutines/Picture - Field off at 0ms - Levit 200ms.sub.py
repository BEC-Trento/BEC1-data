...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-2402000, "Na Repumper1 (+) Amp", 1)
    prg.add(-2362000, "Na Dark Spot Amp", 1)
    prg.add(-2352000, "Na Repumper MOT Amp", 1)
    prg.add(-2002000, "Shutter Probe Na Open")
    prg.add(-1512000, "Na Probe/Push (-) Amp", 1)
    prg.add(-1502000, "Na Probe/Push (+) Amp", 1)
    prg.add(-1012000, "Shutter repump Na Open")
    prg.add(-500000, "IGBT B comp y ON")
    prg.add(-29000, "Na 3D MOT cool (-) Amp", 0)
    prg.add(-19000, "Na 3D MOT cool (+) Amp", 0)
    ...
    prg.add(1000, "Shutter 3DMOT cool Na Open")
    ...
    prg.add(1982000, "B comp y", 1.0000)
    prg.add(1995000, "IGBT 1 pinch", -10.0000)
    prg.add(1995010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(1995020, "IGBT 3 Open")
    prg.add(1995029, "IGBT 4 Open")
    prg.add(1995040, "IGBT 5 Open")
    prg.add(1998500, "Na Repumper MOT Amp", 1000)
    prg.add(1999000, "Na Repumper1 (+) Amp", 1000)
    prg.add(1999400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(1999800, "Na Probe/Push (+) freq", 110.00)
    prg.add(2000200, "Na Probe/Push (-) freq", 110.00)
    prg.add(2000500, "Trig ON Stingray 1")
    prg.add(2000600, "Na Probe/Push (+) Amp", 1000)
    prg.add(2001000, "Na Probe/Push (-) Amp", 1000)
    prg.add(2002050, "Na Probe/Push (-) Amp", 1)
    prg.add(2003000, "Trig OFF Stingray 1")
    prg.add(2251000, "Shutter Probe Na Close")
    prg.add(3000500, "Trig ON Stingray 1")
    prg.add(3001000, "Na Probe/Push (-) Amp", 1000)
    prg.add(3002000, "Na Probe/Push (-) Amp", 1)
    prg.add(3003000, "Trig OFF Stingray 1")
    prg.add(3011000, "Na Repumper MOT Amp", 1)
    prg.add(3021000, "Na Repumper1 (+) Amp", 1)
    ...
    prg.add(6001000, "B comp y", 0.0000)
