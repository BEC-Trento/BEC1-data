...
def program(prg, cmd):
    ...
    prg.add(1600, "Na Zeeman slower (-) Amp", 1000, enable=False)
    prg.add(2000, "Na Probe/Push (-) Amp", 1000)
    prg.add(2400, "Na Probe/Push (+) Amp", 1000)
    prg.add(2800, "Na Probe/Push (+) ON")
    prg.add(3200, "Na 3D MOT cool (-) Amp", 1000)
    prg.add(3600, "Na 3D MOT cool (+) Amp", 1000)
    prg.add(4000, "Na 2D MOT (+) Amp", 1000, enable=False)
    prg.add(4400, "Na 2D MOT (-) Amp", 1000, enable=False)
    return prg
