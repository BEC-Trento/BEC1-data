...
def program(prg, cmd):
    ...
    prg.add(1130000, "IGBT B comp z OFF")
    prg.add(1145000, "IGBT 1 pinch", -10.0000)
    prg.add(1145010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(1145020, "IGBT 3 Open")
    prg.add(1145030, "IGBT 4 Open")
    prg.add(1145040, "IGBT 5 Open")
    prg.add(1150000, "IGBT B comp z OFF")
    prg.add(1182000, "B comp y", 1.0000)
    prg.add(1200000, "Picture NaK.sub", enable=False)
    prg.add(1200000, "Picture NaK Repump Off.sub", enable=False)
    prg.add(1200000, "Picture NaK Hamamatsu.sub", enable=False)
    prg.add(1200000, "Picture NaK TrigSlow.sub")
    prg.add(4701000, "Shutter Optical Levit Close", enable=False)
    prg.add(5202000, "B comp y", 0.0000, enable=False)
    prg.add(5301000, "IGBT B comp y OFF", enable=False)
    prg.add(9701000, "Optical Levit ON", enable=False)
    return prg
