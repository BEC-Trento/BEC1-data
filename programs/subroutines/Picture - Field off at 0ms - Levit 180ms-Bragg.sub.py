...
def program(prg, cmd):
    ...
    prg.add(1750000, "IGBT B comp z OFF")
    ...
    prg.add(1798000, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(1799000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(1799800, "Na Probe/Push (+) freq", 110.000000)
    prg.add(1800000, "Na Repumper MOT Amp", 1000.000000)
    ...
    prg.add(1802500, "Trig OFF Stingray 1")
    ...
    prg.add(5900000, "IGBT B comp y OFF")
    return prg
