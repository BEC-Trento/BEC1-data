...
def program(prg, cmd):
    ...
    prg.add(49500, "Trig ON Stingray 1")
    prg.add(50000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(51000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(51500, "Trig OFF Stingray 1")
    prg.add(131060, "Optical Levit ON")
    ...
    prg.add(1131060, "Optical Levit ON")
