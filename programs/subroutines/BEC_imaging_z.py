...
prg_version = "0.7"
def program(prg, cmd):
    prg.add(-703680, "Pulse Trig Stingray z", comment="F1", polarity=1, pulse_t=0.10000, enable=False)
    prg.add(-4339, "Probe z AOM TTL", enable=False)
    prg.add(-800, "Pulse Trig Stingray z", comment="atoms", polarity=1, pulse_t=0.15445)
