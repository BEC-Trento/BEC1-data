...
def program(prg, cmd):
    ...
    prg.add(10410, "Delta 1 Current", 30.000)
    ...
    prg.add(145510, "IGBT 1 pinch", -10.0000)
    prg.add(145520, "IGBT 2 pinch+comp", -10.0000)
    prg.add(145530, "IGBT 3 Open")
    prg.add(145540, "IGBT 4 Open")
    prg.add(145550, "IGBT 5 Open")
    prg.add(149010, "Na Repumper MOT Amp", 1000)
    prg.add(149510, "Na Repumper1 (+) Amp", 1000)
    prg.add(149910, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(150310, "Na Probe/Push (+) freq", 110.00)
    prg.add(150710, "Na Probe/Push (-) freq", 110.00)
    prg.add(151010, "Trig ON Stingray 1")
    prg.add(151110, "Na Probe/Push (+) Amp", 1000)
    prg.add(151510, "Na Probe/Push (-) Amp", 1000)
    prg.add(152510, "Na Probe/Push (-) Amp", 1)
    prg.add(153010, "Trig OFF Stingray 1")
    prg.add(401510, "Shutter Probe Na Close")
    prg.add(1151010, "Trig ON Stingray 1")
    prg.add(1151510, "Na Probe/Push (-) Amp", 1000)
    prg.add(1152510, "Na Probe/Push (-) Amp", 1)
    prg.add(1153010, "Trig OFF Stingray 1")
    prg.add(1161510, "Na Repumper MOT Amp", 1)
    prg.add(1171510, "Na Repumper1 (+) Amp", 1)
    prg.add(2151010, "Trig ON Stingray 1")
    prg.add(2153010, "Trig OFF Stingray 1")
    prg.add(3151010, "Trig ON Stingray 1")
    prg.add(3153010, "Trig OFF Stingray 1")
    prg.add(4151510, "B comp y", 0.0000, enable=False)
    prg.add(4250510, "IGBT B comp y OFF")
    return prg
