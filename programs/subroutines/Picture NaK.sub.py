...
def program(prg, cmd):
    ...
    prg.add(0, "Pulse Probe Na", polarity=1, pulse_t=0.00700)
    ...
    prg.add(1000000, "Pulse Probe Na", polarity=1, pulse_t=0.00700)
    prg.add(1002000, "Trig OFF Stingray 1")
    prg.add(1010000, "Shutter Probe Na Close", enable=False)
