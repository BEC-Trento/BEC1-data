...
def program(prg, cmd):
    ...
    prg.add(-201000, "B comp y", 1.0000)
    prg.add(-40000, "IGBT B comp y ON")
    prg.add(-9000, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(-8500, "Na Repumper MOT Amp", 1000)
    prg.add(-8000, "Na Repumper1 (+) Amp", 1000)
    prg.add(-1200, "Na Probe/Push (+) freq", 115.00)
    prg.add(-800, "Na Probe/Push (-) freq", 105.00)
