...
def program(prg, cmd):
    ...
    prg.add(2764500, "Trig ON Stingray 1")
    prg.add(2765000, "Na Probe/Push (-) Amp", 1000)
    prg.add(2766000, "Na Probe/Push (-) Amp", 1)
    prg.add(2767000, "Trig OFF Stingray 1")
    prg.add(2894500, "Trig ON Stingray 2")
    prg.add(2895000, "Na Probe/Push (-) Amp", 1000)
    prg.add(2896000, "Na Probe/Push (-) Amp", 1)
    prg.add(2897000, "Trig OFF Stingray 2")
    return prg
