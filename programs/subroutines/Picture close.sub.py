...
def program(prg, cmd):
    ...
    prg.add(-300, "Na Probe/Push (-) Amp", 1000)
    prg.add(0, "Pulse Probe Na", polarity=1, pulse_t=0.08000)
    prg.add(1000, "Na Probe/Push (-) Amp", 1, enable=False)
    prg.add(2000, "Trig OFF Stingray 1")
    prg.add(999500, "Trig ON Stingray 1")
    prg.add(1000000, "Na Probe/Push (-) Amp", 1000, enable=False)
    prg.add(1000000, "Pulse Probe Na", polarity=1, pulse_t=0.08000)
