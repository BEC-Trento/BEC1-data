...
def program(prg, cmd):
    ...
    prg.add(998100, "Na Repumper MOT Amp", 1000)
    prg.add(999500, "Trig ON Stingray 1")
    prg.add(1000000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1001000, "Na Probe/Push (-) Amp", 1)
    prg.add(1002050, "Na Repumper MOT Amp", 1)
    prg.add(1002600, "Na Repumper1 (+) Amp", 1)
    prg.add(1010500, "Trig OFF Stingray 1")
    prg.add(1999500, "Trig ON Stingray 1")
    prg.add(2010500, "Trig OFF Stingray 1")
    prg.add(2999500, "Trig ON Stingray 1")
    prg.add(3010500, "Trig OFF Stingray 1")
    prg.add(4000000, "B comp y", 0.0000)
    prg.add(4010000, "IGBT B comp y OFF")
    prg.add(4050000, "Na Repumper MOT Amp", 1000, enable=False)
    return prg
