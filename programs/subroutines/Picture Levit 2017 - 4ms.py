...
def program(prg, cmd):
    ...
    prg.add(30160, "Config Field OFF.sub")
    prg.add(31410, "B comp y", 1.0000, enable=False)
    prg.add(40160, "Picture NaK for Levit 2017.sub")
    prg.add(4042160, "B comp y", 0.0000)
    return prg
