...
def program(prg, cmd):
    ...
    prg.add(500000, "Shutter 3DMOT cool Na Open")
    prg.add(1100000, "Shutter repump Na Open")
    ...
    prg.add(2198000, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(2199000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(2199500, "Na Probe/Push (+) freq", 110.000000)
