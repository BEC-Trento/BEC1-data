...
def program(prg, cmd):
    ...
    prg.add(-3103000, "Na Repumper1 (+) Amp", 1)
    prg.add(-3063000, "Na Dark Spot Amp", 1)
    prg.add(-3053000, "Na Repumper MOT Amp", 1)
    prg.add(-2213000, "Na Probe/Push (-) Amp", 1)
    prg.add(-2203000, "Na Probe/Push (+) Amp", 1)
    prg.add(-1713000, "Shutter repump Na Open")
    ...
    prg.add(-2100, "Na Repumper MOT Amp", 1000, enable=False)
    prg.add(-1600, "Na Repumper1 (+) Amp", 1000, enable=False)
    prg.add(-1200, "Na Repumper Tune (+) freq", 1713.0, enable=False)
