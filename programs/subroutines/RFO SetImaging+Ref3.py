...
def program(prg, cmd):
    ...
    prg.add(-1200, "Na Probe/Push (+) freq", 113.00)
    prg.add(-800, "Na Probe/Push (-) freq", 107.00)
    ...
    prg.add(152000, "Trig Slow Stingray ON")
    prg.add(152500, "Na Probe/Push (-) Amp", 1000)
    prg.add(153500, "Na Probe/Push (-) Amp", 1)
    prg.add(154500, "Trig Slow Stingray OFF")
    prg.add(304500, "Trig ON Stingray 2")
    prg.add(305000, "Na Probe/Push (-) Amp", 1000)
    prg.add(306000, "Na Probe/Push (-) Amp", 1)
    prg.add(307000, "Trig OFF Stingray 2")
    return prg
