...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-2802000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(-2792000, "K probe Repumper (+) Amp", 1.000000)
    prg.add(-2782000, "K Repumper 1p (+) Amp", 1.000000)
    prg.add(-2762000, "Na Dark Spot Amp", 1.000000)
    prg.add(-2752000, "Na Repumper MOT Amp", 1.000000)
    prg.add(-2402000, "Shutter Probe Na Open")
    prg.add(-1912000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(-1902000, "Na Probe/Push (+) Amp", 1.000000)
    prg.add(-1432000, "Shutter Probe K Open")
    prg.add(-1422000, "Shutter RepumperMOT K Open")
    prg.add(-1412000, "Shutter repump Na Open")
    prg.add(-892000, "K probe Cooler (-) Amp", 1.000000)
    prg.add(-429000, "Na 3D MOT cool (-) Amp", 1.000000)
    prg.add(-419000, "Na 3D MOT cool (+) Amp", 1.000000)
    prg.add(-399000, "Shutter 3DMOT cool Na Open")
    ...
    prg.add(10410, "Delta 1 Current", 15.200000)
    ...
    prg.add(1582000, "B comp y", 1.000000)
    prg.add(1595000, "IGBT 1 pinch", -10.000000)
    prg.add(1595010, "IGBT 2 pinch+comp", -10.000000)
    prg.add(1595020, "IGBT 3 Open")
    prg.add(1595029, "IGBT 4 Open")
    prg.add(1595040, "IGBT 5 Open")
    prg.add(1595050, "IGBT 6 Open")
    prg.add(1595600, "K probe Cooler (-) freq", 99.500000)
    prg.add(1596000, "K Cooler 2p (+) freq", 97.500000)
    prg.add(1596399, "K Repumper 1p (+) Amp", 1000.000000)
    prg.add(1596800, "K Repumper 1p (+) freq", 115.000000)
    prg.add(1597200, "K Repumper 2p (+) freq", 96.000000)
    prg.add(1598500, "Na Repumper MOT Amp", 1000.000000)
    prg.add(1599000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(1599400, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(1599800, "Na Probe/Push (+) freq", 110.000000)
    prg.add(1600200, "Na Probe/Push (-) freq", 110.000000)
    prg.add(1600500, "Trig ON Stingray 1")
    prg.add(1600600, "Na Probe/Push (+) Amp", 1000.000000)
    prg.add(1601000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(1601399, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(1602050, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(1602400, "K probe Cooler (-) Amp", 1.000000)
    prg.add(1603000, "Trig OFF Stingray 1")
    prg.add(1851000, "Shutter Probe Na Close")
    prg.add(1861000, "Shutter Probe K Close")
    prg.add(2600500, "Trig ON Stingray 1")
    prg.add(2601000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(2601400, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(2602000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(2602400, "K probe Cooler (-) Amp", 1.000000)
    prg.add(2603000, "Trig OFF Stingray 1")
    prg.add(2611000, "Na Repumper MOT Amp", 1.000000)
    prg.add(2621000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(2631000, "K Repumper 1p (+) Amp", 1.000000)
    prg.add(3600500, "Trig ON Stingray 1")
    prg.add(3602500, "Trig OFF Stingray 1")
    prg.add(4600500, "Trig ON Stingray 1")
    prg.add(4602500, "Trig OFF Stingray 1")
    prg.add(5601000, "B comp y", 0.000000)
    return prg
