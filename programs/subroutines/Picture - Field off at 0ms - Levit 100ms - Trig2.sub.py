...
def program(prg, cmd):
    ...
    prg.add(2003000, "Trig OFF Stingray 2")
    prg.add(2011000, "Na Repumper MOT Amp", 1)
    prg.add(2021000, "Na Repumper1 (+) Amp", 1)
    prg.add(2031000, "K Repumper 1p (+) Amp", 1)
    prg.add(3000500, "Trig ON Stingray 2")
    prg.add(3002500, "Trig OFF Stingray 2")
    prg.add(4000500, "Trig ON Stingray 2")
    prg.add(4002500, "Trig OFF Stingray 2")
