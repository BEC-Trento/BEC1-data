...
def program(prg, cmd):
    ...
    prg.add(0, "TTL Push ON")
    prg.add(0, "TTL Push OFF", functions=dict(time=lambda x: x + cmd.get_var('probe_pulsetime')*1e-3))
    ...
    prg.add(1001410, "TTL Push ON")
    prg.add(1001410, "TTL Push OFF", functions=dict(time=lambda x: x + cmd.get_var('probe_pulsetime')*1e-3))
