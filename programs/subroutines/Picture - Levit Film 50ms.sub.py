...
def program(prg, cmd):
    ...
    prg.add(-3892000, "K probe Repumper (+) Amp", 1)
    prg.add(-3882000, "K Repumper 1p (+) Amp", 1)
    prg.add(-3862000, "Na Dark Spot Amp", 1)
    prg.add(-3852000, "Na Repumper MOT Amp", 1)
    prg.add(-3502000, "Shutter Probe Na Open")
    prg.add(-2532000, "Shutter Probe K Open")
    prg.add(-2522000, "Shutter RepumperMOT K Open")
    prg.add(-2512000, "Shutter repump Na Open")
    prg.add(-1992000, "K probe Cooler (-) Amp", 1)
    prg.add(-1529000, "Na 3D MOT cool (-) Amp", 1)
    prg.add(-1519000, "Na 3D MOT cool (+) Amp", 1)
    prg.add(-1500000, "Optical Levit OFF")
    prg.add(-1499000, "Shutter 3DMOT cool Na Open")
    prg.add(-1488000, "Shutter Optical Levit Close")
    ...
    prg.add(10410, "Delta 1 Current", 15.800)
