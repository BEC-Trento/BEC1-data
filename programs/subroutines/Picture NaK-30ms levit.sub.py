...
def program(prg, cmd):
    ...
    prg.add(-4089000, "K probe Repumper (+) Amp", 1.000000)
    prg.add(-4079000, "K Repumper 1p (+) Amp", 1.000000)
    prg.add(-4069000, "K probe Cooler (-) Amp", 1.000000)
    prg.add(-4059000, "Na Dark Spot Amp", 1.000000)
    prg.add(-4049000, "Na Repumper MOT Amp", 1.000000)
    prg.add(-2729000, "Shutter Probe K Open")
    prg.add(-2719000, "Shutter RepumperMOT K Open")
    ...
    prg.add(295600, "K probe Cooler (-) freq", 99.500000)
    prg.add(296000, "K Cooler 2p (+) freq", 97.500000)
    prg.add(296400, "K Repumper 1p (+) Amp", 1000.000000)
    prg.add(296800, "K Repumper 1p (+) freq", 115.000000)
    prg.add(297200, "K Repumper 2p (+) freq", 96.000000)
    prg.add(298500, "Na Repumper MOT Amp", 1000.000000)
    ...
    prg.add(301400, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(302000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(302400, "K probe Cooler (-) Amp", 1.000000)
    prg.add(303000, "Trig OFF Stingray 1")
    prg.add(551000, "Shutter Probe Na Close")
    prg.add(561000, "Shutter Probe K Close")
    prg.add(1300500, "Trig ON Stingray 1")
    prg.add(1301000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(1301399, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(1302000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(1302400, "K probe Cooler (-) Amp", 1.000000)
    prg.add(1303000, "Trig OFF Stingray 1")
    prg.add(1311000, "Na Repumper MOT Amp", 1.000000)
    prg.add(1321000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(1331000, "K Repumper 1p (+) Amp", 1.000000)
