...
def program(prg, cmd):
    ...
    prg.add(10410, "Delta 1 Current", 15.300)
    ...
    prg.add(1499800, "Na Probe/Push (+) freq", 110.00)
    prg.add(1500200, "Na Probe/Push (-) freq", 110.00)
    prg.add(1500500, "Trig ON Stingray 1")
    prg.add(1500600, "Na Probe/Push (+) Amp", 1000)
    prg.add(1501000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1501399, "K probe Cooler (-) Amp", 1000)
    prg.add(1502050, "Na Probe/Push (-) Amp", 1)
    ...
    prg.add(2501000, "Na Probe/Push (-) Amp", 1000)
    ...
    prg.add(2511000, "Na Repumper MOT Amp", 1)
    prg.add(2521000, "Na Repumper1 (+) Amp", 1)
