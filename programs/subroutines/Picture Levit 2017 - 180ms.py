...
def program(prg, cmd):
    ...
    prg.add(2100, "Delta 1 Current", 14.100)
    ...
    prg.add(1790000, "Config Field OFF.sub")
    prg.add(1791250, "B comp y", 1.0000, enable=False)
    prg.add(1800000, "Picture NaK.sub")
    prg.add(5802000, "B comp y", 0.0000)
    return prg
