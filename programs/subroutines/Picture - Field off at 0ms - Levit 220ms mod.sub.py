...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-2199000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(-2159000, "Na Dark Spot Amp", 1.000000)
    prg.add(-2149000, "Na Repumper MOT Amp", 1.000000)
    prg.add(-1630000, "Na 3D MOT cool (-) Amp", 1.000000)
    prg.add(-1620000, "Na 3D MOT cool (+) Amp", 1.000000)
    prg.add(-1610000, "Na Probe/Push (+) ON")
    prg.add(-1600000, "Shutter 3DMOT cool Na Open")
    prg.add(-809000, "Shutter repump Na Open")
    prg.add(-799000, "Shutter Probe Na Open")
    prg.add(-500000, "IGBT B comp y ON")
    prg.add(-309000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(-299000, "Na Probe/Push (+) Amp", 1.000000)
    ...
    prg.add(2150000, "IGBT B comp z OFF")
    prg.add(2182000, "B comp y", 1.000000)
    prg.add(2195000, "IGBT 1 pinch", -10.000000)
    prg.add(2195010, "IGBT 2 pinch+comp", -10.000000)
    prg.add(2195020, "IGBT 3 Open")
    prg.add(2195030, "IGBT 4 Open")
    prg.add(2195040, "IGBT 5 Open")
    prg.add(2199000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(2199400, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(2199800, "Na Probe/Push (+) freq", 110.000000)
    prg.add(2200000, "Na Repumper MOT Amp", 1000.000000)
    prg.add(2200200, "Na Probe/Push (-) freq", 110.000000)
    prg.add(2200500, "Trig ON Stingray 1")
    prg.add(2200600, "Na Probe/Push (+) Amp", 1000.000000)
    prg.add(2201000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(2202000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(2202500, "Trig OFF Stingray 1")
    prg.add(2451000, "Shutter Probe Na Close")
    prg.add(3200500, "Trig ON Stingray 1")
    prg.add(3201000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(3202000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(3202500, "Trig OFF Stingray 1")
    prg.add(3211000, "Na Repumper MOT Amp", 1.000000)
    prg.add(3221000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(4200500, "Trig ON Stingray 1")
    prg.add(4202500, "Trig OFF Stingray 1")
    prg.add(5200500, "Trig ON Stingray 1")
    prg.add(5202500, "Trig OFF Stingray 1")
    prg.add(5400000, "Shutter Optical Levit Close")
    prg.add(6201000, "B comp y", 0.000000)
    prg.add(6300000, "IGBT B comp y OFF")
