...
def program(prg, cmd):
    ...
    prg.add(230, "RF_freq", 110, functions=dict(frequency=lambda x: cmd.get_var('RF_freq_zero')*1e6, time=lambda x: x+1e-3*cmd.get_var('marconi1_pulsetime_zero')), enable=False)
