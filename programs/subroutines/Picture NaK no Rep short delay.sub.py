...
def program(prg, cmd):
    ...
    prg.add(149963, "Pulse Freq sweep Probe Na", polarity=1, pulse_t=0.05000)
    prg.add(150000, "Pulse Probe Na", polarity=1, pulse_t=0.01000)
    prg.add(152000, "Trig OFF Stingray 1")
    prg.add(160000, "Shutter Probe Na Close")
    prg.add(170000, "Na Repumper1 (+) Amp", 1)
    prg.add(299500, "Trig ON Stingray 1")
    prg.add(302000, "Trig OFF Stingray 1")
    prg.add(449500, "Trig ON Stingray 1")
    prg.add(452000, "Trig OFF Stingray 1")
    prg.add(600000, "B comp y", 0.0000)
    prg.add(610000, "IGBT B comp y OFF")
    return prg
