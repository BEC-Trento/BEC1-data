...
def program(prg, cmd):
    ...
    prg.add(10410, "Delta 1 Current", 15.600000)
    ...
    prg.add(600000, "Shutter repump Na Open")
    prg.add(1650000, "IGBT B comp z OFF")
    prg.add(1682000, "B comp y", 1.000000)
    prg.add(1695000, "IGBT 1 pinch", -10.000000)
    prg.add(1695010, "IGBT 2 pinch+comp", -10.000000)
    prg.add(1695020, "IGBT 3 Open")
    prg.add(1695029, "IGBT 4 Open")
    prg.add(1695040, "IGBT 5 Open")
    prg.add(1698000, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(1699000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(1699500, "Na Probe/Push (+) freq", 110.000000)
    prg.add(1700000, "Na Repumper MOT Amp", 1000.000000)
    prg.add(1700200, "Na Probe/Push (-) freq", 110.000000)
    prg.add(1700500, "Trig ON Stingray 1")
    prg.add(1700600, "Na Probe/Push (+) Amp", 1000.000000)
    prg.add(1701000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(1702000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(1702500, "Trig OFF Stingray 1")
    prg.add(1951000, "Shutter Probe Na Close")
    prg.add(2700500, "Trig ON Stingray 1")
    prg.add(2701000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(2702000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(2702500, "Trig OFF Stingray 1")
    prg.add(2711000, "Na Repumper MOT Amp", 1.000000)
    prg.add(2721000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(3700500, "Trig ON Stingray 1")
    prg.add(3702500, "Trig OFF Stingray 1")
    prg.add(4700500, "Trig ON Stingray 1")
    prg.add(4702500, "Trig OFF Stingray 1")
    prg.add(5701000, "B comp y", 0.000000)
    prg.add(5800000, "IGBT B comp y OFF")
    return prg
