...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-3199000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(-3189000, "K probe Repumper (+) Amp", 1.000000)
    prg.add(-3179000, "K Repumper 1p (+) Amp", 1.000000)
    prg.add(-3169000, "K probe Cooler (-) Amp", 1.000000)
    prg.add(-3159000, "Na Dark Spot Amp", 1.000000)
    prg.add(-3149000, "Na Repumper MOT Amp", 1.000000)
    prg.add(-1829000, "Shutter Probe K Open")
    prg.add(-1819000, "Shutter RepumperMOT K Open")
    prg.add(-1809000, "Shutter repump Na Open")
    prg.add(-1799000, "Shutter Probe Na Open")
    prg.add(-1309000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(-1299000, "Na Probe/Push (+) Amp", 1.000000)
