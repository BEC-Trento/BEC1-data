...
def program(prg, cmd):
    ...
    prg.add(1795600, "K probe Cooler (-) freq", 99.50)
    prg.add(1796000, "K Cooler 2p (+) freq", 97.50)
    prg.add(1796399, "K Repumper 1p (+) Amp", 1000)
    prg.add(1796800, "K Repumper 1p (+) freq", 115.00)
    prg.add(1797200, "K Repumper 2p (+) freq", 96.00)
    prg.add(1798500, "Na Repumper MOT Amp", 1000, enable=False)
    prg.add(1799000, "Na Repumper1 (+) Amp", 1000, enable=False)
    prg.add(1799400, "Na Repumper Tune (+) freq", 1713.0, enable=False)
