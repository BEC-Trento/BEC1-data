...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-3402000, "Na Repumper1 (+) Amp", 1, enable=False)
    prg.add(-3392000, "K probe Repumper (+) Amp", 1, enable=False)
    prg.add(-3382000, "K Repumper 1p (+) Amp", 1, enable=False)
    prg.add(-3362000, "Na Dark Spot Amp", 1, enable=False)
    prg.add(-3352000, "Na Repumper MOT Amp", 1, enable=False)
    prg.add(-3002000, "Shutter Probe Na Open", enable=False)
    prg.add(-2512000, "Na Probe/Push (-) Amp", 1, enable=False)
    ...
    prg.add(-1029000, "Na 3D MOT cool (-) Amp", 1, enable=False)
    prg.add(-1019000, "Na 3D MOT cool (+) Amp", 1, enable=False)
    prg.add(-999000, "Shutter 3DMOT cool Na Open")
    ...
    prg.add(495000, "IGBT 1 pinch", -10.0000)
    prg.add(495010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(495020, "IGBT 3 Open")
    prg.add(495030, "IGBT 4 Open")
    prg.add(495040, "IGBT 5 Open")
    prg.add(495050, "IGBT 6 Open")
    prg.add(495600, "K probe Cooler (-) freq", 99.50)
    prg.add(496000, "K Cooler 2p (+) freq", 97.50)
    prg.add(496400, "K Repumper 1p (+) Amp", 1000)
    prg.add(496800, "K Repumper 1p (+) freq", 115.00)
    prg.add(497200, "K Repumper 2p (+) freq", 96.00)
    prg.add(498500, "Na Repumper MOT Amp", 1000)
    prg.add(499000, "Na Repumper1 (+) Amp", 1000)
    prg.add(499400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(499800, "Na Probe/Push (+) freq", 110.00)
    prg.add(500200, "Na Probe/Push (-) freq", 110.00)
    prg.add(500500, "Trig ON Stingray 2")
    prg.add(500600, "Na Probe/Push (+) Amp", 1000)
    prg.add(501000, "Na Probe/Push (-) Amp", 1000)
    prg.add(501400, "K probe Cooler (-) Amp", 1000)
    prg.add(502050, "Na Probe/Push (-) Amp", 1)
    prg.add(502400, "K probe Cooler (-) Amp", 1)
    prg.add(503000, "Trig OFF Stingray 2")
    prg.add(751000, "Shutter Probe Na Close")
    prg.add(1500500, "Trig ON Stingray 2")
    ...
    prg.add(1503000, "Trig OFF Stingray 2")
    prg.add(1511000, "Na Repumper MOT Amp", 1)
    prg.add(1521000, "Na Repumper1 (+) Amp", 1)
    prg.add(1531000, "K Repumper 1p (+) Amp", 1)
    prg.add(2500500, "Trig ON Stingray 2")
    prg.add(2502500, "Trig OFF Stingray 2")
    prg.add(3500500, "Trig ON Stingray 2")
    prg.add(3502500, "Trig OFF Stingray 2")
