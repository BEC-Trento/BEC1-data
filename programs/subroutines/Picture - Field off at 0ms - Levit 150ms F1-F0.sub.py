...
def program(prg, cmd):
    ...
    prg.add(1499400, "Na Repumper Tune (+) freq", 1664.000000)
    ...
    prg.add(1500600, "Na Repumper MOT Amp", 1000.000000)
    prg.add(1501000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(1501399, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(1502050, "Na Repumper1 (+) Amp", 1.000000)
    ...
    prg.add(2501000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(2501400, "K probe Cooler (-) Amp", 1000.000000)
    prg.add(2502000, "Na Repumper1 (+) Amp", 1.000000)
