...
def program(prg, cmd):
    ...
    prg.add(1500, "Shutter Probe/Push Open")
    prg.add(1700, "Shutter repump Na Open")
    prg.add(2000, "Shutter EOM Na Close")
    prg.add(3000, "Shutter 2DMOT Close")
    prg.add(4000, "Shutter 3DMOT cool Na Close")
    prg.add(6000, "Shutter Dark Spot Close")
    prg.add(6500, "Shutter Probe/Push Close", enable=False)
    prg.add(7000, "Shutter repump Na Close", enable=False)
    return prg
