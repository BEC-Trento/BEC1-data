...
def program(prg, cmd):
    ...
    prg.add(29500, "Trig ON Stingray 1")
    prg.add(30000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(31000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(31500, "Trig OFF Stingray 1")
    prg.add(999930, "Pulse uw ON")
    prg.add(1000000, "Pulse uw OFF")
    prg.add(1029500, "Trig ON Stingray 1")
    prg.add(1030000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(1031000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(1031500, "Trig OFF Stingray 1")
    prg.add(1999930, "Pulse uw ON")
    prg.add(2000000, "Pulse uw OFF")
    prg.add(2029500, "Trig ON Stingray 1")
    prg.add(2030000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(2031000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(2031500, "Trig OFF Stingray 1")
    ...
    prg.add(3029500, "Trig ON Stingray 1")
    prg.add(3030000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(3031000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(3031500, "Trig OFF Stingray 1")
    ...
    prg.add(4029500, "Trig ON Stingray 1")
    prg.add(4030000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(4031000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(4031500, "Trig OFF Stingray 1")
