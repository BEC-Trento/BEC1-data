...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(1000, "Delta 1 Current", 30.000)
    ...
    prg.add(20000, "Na 3D MOT cool (+) freq", 98.50)
    prg.add(30000, "Na 3D MOT cool (-) freq", 121.50)
    prg.add(40000, "Na 3D MOT cool (+) Amp", 1000)
    prg.add(50000, "Na 3D MOT cool (-) Amp", 1000)
    ...
    prg.add(370000, "Na Probe/Push (-) Amp", 650)
