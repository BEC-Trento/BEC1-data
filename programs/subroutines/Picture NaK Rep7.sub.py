...
def program(prg, cmd):
    ...
    prg.add(-1200, "Na Probe/Push (+) freq", 116.00)
    prg.add(-800, "Na Probe/Push (-) freq", 104.00)
    ...
    prg.add(1472000, "Trig OFF Stingray 1")
    prg.add(1739500, "Trig ON Stingray 1")
