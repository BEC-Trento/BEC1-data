...
def program(prg, cmd):
    ...
    prg.add(82000, "B comp y", 3.0000)
    prg.add(85000, "IGBT 1 pinch", -10.0000)
    prg.add(85010, "IGBT 2 pinch+comp", -10.0000)
    prg.add(85020, "IGBT 3 Open")
    prg.add(85030, "IGBT 4 Open")
    prg.add(85040, "IGBT 5 Open")
    prg.add(88500, "Na Repumper MOT Amp", 1000)
    prg.add(89000, "Na Repumper1 (+) Amp", 1000)
    prg.add(89400, "Na Repumper Tune (+) freq", 1713.0)
    prg.add(89800, "Na Probe/Push (+) freq", 110.00)
    prg.add(90200, "Na Probe/Push (-) freq", 110.00)
    prg.add(90500, "Trig ON Stingray 1")
    prg.add(90600, "Na Probe/Push (+) Amp", 1000)
    prg.add(91000, "Na Probe/Push (-) Amp", 1000)
    prg.add(92000, "Na Probe/Push (-) Amp", 1)
    prg.add(92500, "Trig OFF Stingray 1")
    prg.add(341000, "Shutter Probe Na Close")
    prg.add(1090500, "Trig ON Stingray 1")
    prg.add(1091000, "Na Probe/Push (-) Amp", 1000)
    prg.add(1092000, "Na Probe/Push (-) Amp", 1)
    prg.add(1092500, "Trig OFF Stingray 1")
    prg.add(1101000, "Na Repumper MOT Amp", 1)
    prg.add(1111000, "Na Repumper1 (+) Amp", 1)
    prg.add(2090500, "Trig ON Stingray 1")
    prg.add(2092500, "Trig OFF Stingray 1")
    prg.add(3090500, "Trig ON Stingray 1")
    prg.add(3092500, "Trig OFF Stingray 1")
    prg.add(4091000, "B comp y", 0.0000, enable=False)
    prg.add(4190000, "IGBT B comp y OFF")
    return prg
