...
def program(prg, cmd):
    ...
    prg.add(500000, "Decompress Current 200-50", start_t=0.0000, stop_x=10.000, n_points=300, start_x=0.000, stop_t=50.0000)
    prg.add(1000000, "Decompress Current 200-50", start_t=0.0000, stop_x=0.000, n_points=300, start_x=10.000, stop_t=50.0000)
