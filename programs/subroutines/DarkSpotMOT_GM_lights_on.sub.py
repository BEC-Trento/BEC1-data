...
def program(prg, cmd):
    ...
    prg.add(40000, "Na Gray molasses (+) freq", 112.50, enable=False)
    prg.add(42000, "Na Gray molasses (-) freq", 87.50, enable=False)
    prg.add(44000, "AOM GM Amp ch1 (+)", 1000, enable=False)
    prg.add(46000, "AOM GM Amp ch2 (-)", 1000, enable=False)
