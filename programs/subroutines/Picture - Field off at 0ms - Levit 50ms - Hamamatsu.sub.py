...
def program(prg, cmd):
    ...
    prg.add(500000, "Picture NaK.sub", enable=False)
    prg.add(500000, "Picture NaK Repump Off.sub", enable=False)
    prg.add(500000, "Picture NaK Hamamatsu.sub")
    prg.add(4001000, "Shutter Optical Levit Close", enable=False)
    prg.add(4502000, "B comp y", 0.0000, enable=False)
    prg.add(4601000, "IGBT B comp y OFF", enable=False)
    prg.add(9001000, "Optical Levit ON", enable=False)
    return prg
