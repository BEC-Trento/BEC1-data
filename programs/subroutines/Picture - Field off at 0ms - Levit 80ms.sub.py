...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-3602000, "Na Repumper1 (+) Amp", 1)
    prg.add(-3592000, "K probe Repumper (+) Amp", 1, enable=False)
    prg.add(-3582000, "K Repumper 1p (+) Amp", 1, enable=False)
    prg.add(-3562000, "Na Dark Spot Amp", 1)
    prg.add(-3552000, "Na Repumper MOT Amp", 1)
    prg.add(-3202000, "Shutter Probe Na Open")
    prg.add(-2712000, "Na Probe/Push (-) Amp", 1)
    prg.add(-2702000, "Na Probe/Push (+) Amp", 1)
    prg.add(-2232000, "Shutter Probe K Open", enable=False)
    prg.add(-2222000, "Shutter RepumperMOT K Open", enable=False)
    prg.add(-2212000, "Shutter repump Na Open")
    prg.add(-1692000, "K probe Cooler (-) Amp", 1, enable=False)
    prg.add(-1229000, "Na 3D MOT cool (-) Amp", 1)
    prg.add(-1219000, "Na 3D MOT cool (+) Amp", 1)
    prg.add(-1199000, "Shutter 3DMOT cool Na Open")
    ...
    prg.add(10410, "Delta 1 Current", 15.900)
    ...
    prg.add(782000, "B comp y", 1.0000)
    ...
    prg.add(800600, "Na Probe/Push (+) Amp", 1000)
    prg.add(801000, "Na Probe/Push (-) Amp", 1000)
    ...
    prg.add(1061000, "Shutter Probe K Close", enable=False)
