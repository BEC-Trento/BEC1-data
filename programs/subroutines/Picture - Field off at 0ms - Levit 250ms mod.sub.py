...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(-1899000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(-1859000, "Na Dark Spot Amp", 1.000000)
    prg.add(-1849000, "Na Repumper MOT Amp", 1.000000)
    prg.add(-1330000, "Na 3D MOT cool (-) Amp", 1.000000)
    prg.add(-1320000, "Na 3D MOT cool (+) Amp", 1.000000)
    prg.add(-1310000, "Na Probe/Push (+) ON")
    prg.add(-1300000, "Shutter 3DMOT cool Na Open")
    prg.add(-509000, "Shutter repump Na Open")
    prg.add(-500000, "IGBT B comp y ON")
    prg.add(-499000, "Shutter Probe Na Open")
    prg.add(-9500, "B comp y", 0.000000)
    prg.add(-9000, "Na Probe/Push (-) Amp", 1.000000)
    ...
    prg.add(10410, "Delta 1 Current", 15.050000)
    ...
    prg.add(2450000, "IGBT B comp z OFF")
    prg.add(2482000, "B comp y", 1.000000)
    prg.add(2495000, "IGBT 1 pinch", -10.000000)
    prg.add(2495010, "IGBT 2 pinch+comp", -10.000000)
    prg.add(2495020, "IGBT 3 Open")
    prg.add(2495030, "IGBT 4 Open")
    prg.add(2495040, "IGBT 5 Open")
    prg.add(2499000, "Na Repumper1 (+) Amp", 1000.000000)
    prg.add(2499400, "Na Repumper Tune (+) freq", 1713.000000)
    prg.add(2499800, "Na Probe/Push (+) freq", 110.000000)
    prg.add(2500000, "Na Repumper MOT Amp", 1000.000000)
    prg.add(2500200, "Na Probe/Push (-) freq", 110.000000)
    prg.add(2500500, "Trig ON Stingray 1")
    prg.add(2500600, "Na Probe/Push (+) Amp", 1000.000000)
    ...
    prg.add(2751000, "Shutter Probe Na Close")
    prg.add(3500500, "Trig ON Stingray 1")
    prg.add(3501000, "Na Probe/Push (-) Amp", 1000.000000)
    prg.add(3502000, "Na Probe/Push (-) Amp", 1.000000)
    prg.add(3502500, "Trig OFF Stingray 1")
    prg.add(3511000, "Na Repumper MOT Amp", 1.000000)
    prg.add(3521000, "Na Repumper1 (+) Amp", 1.000000)
    prg.add(4500500, "Trig ON Stingray 1")
    prg.add(4502500, "Trig OFF Stingray 1")
    prg.add(5500500, "Trig ON Stingray 1")
    prg.add(5502500, "Trig OFF Stingray 1")
    prg.add(5700000, "Shutter Optical Levit Close")
    prg.add(6501000, "B comp y", 0.000000)
    prg.add(6600000, "IGBT B comp y OFF")
