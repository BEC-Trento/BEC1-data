...
def program(prg, cmd):
    ...
    prg.add(-1000500, "Pulse Trig Extra Hamamatsu", polarity=1, pulse_t=0.10000, enable=False)
    ...
    prg.add(2100, "Trig OFF Stingray 2")
    ...
    prg.add(1002099, "Trig OFF Stingray 2")
    prg.add(1010000, "Shutter Probe Na Close")
    prg.add(1020000, "Na Repumper1 (+) Amp", 1)
    prg.add(2019500, "Trig ON Stingray 2")
    prg.add(2022000, "Trig OFF Stingray 2")
    prg.add(3019500, "Trig ON Stingray 2")
    prg.add(3022000, "Trig OFF Stingray 2")
