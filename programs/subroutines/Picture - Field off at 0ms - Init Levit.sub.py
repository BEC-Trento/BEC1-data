...
def program(prg, cmd):
    ...
    prg.add(130000, "IGBT B comp z OFF", enable=False)
    prg.add(145000, "IGBT 1 pinch", -10.0000, enable=False)
    prg.add(145010, "IGBT 2 pinch+comp", -10.0000, enable=False)
    prg.add(145020, "IGBT 3 Open", enable=False)
    prg.add(145030, "IGBT 4 Open", enable=False)
    prg.add(145040, "IGBT 5 Open", enable=False)
    prg.add(150000, "IGBT B comp z OFF", enable=False)
    prg.add(182000, "B comp y", 1.0000, enable=False)
    prg.add(200000, "Picture NaK.sub", enable=False)
    prg.add(200000, "Picture NaK Repump Off.sub", enable=False)
    prg.add(200000, "Picture NaK Hamamatsu.sub", enable=False)
    prg.add(200000, "Picture NaK TrigSlow.sub", enable=False)
    prg.add(3701000, "Shutter Optical Levit Close", enable=False)
    prg.add(4202000, "B comp y", 0.0000, enable=False)
    prg.add(4301000, "IGBT B comp y OFF", enable=False)
    prg.add(8701000, "Optical Levit ON", enable=False)
    return prg
