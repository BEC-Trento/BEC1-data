...
def program(prg, cmd):
    ...
    prg.add(-20000, "Na Bragg relative freq 20 MHz", -10.0, enable=False)
    prg.add(-20000, "Na Bragg relative freq 2000 kHz", -900.00, functions=dict(frequency=lambda x: x+ cmd.get_var("t"), funct_enable=False), enable=False)
    prg.add(-20000, "Na Bragg", 0)
