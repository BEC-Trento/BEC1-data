...
def program(prg, cmd):
    ...
    prg.add(2100, "Delta 1 Current", 14.150)
    ...
    prg.add(1990000, "Config Field OFF.sub")
    prg.add(1991250, "B comp y", 1.0000, enable=False)
    prg.add(2000000, "Picture NaK.sub")
    prg.add(6002000, "B comp y", 0.0000)
    return prg
