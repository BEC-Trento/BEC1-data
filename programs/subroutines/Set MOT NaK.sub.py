...
def program(prg, cmd):
    ...
    prg.add(20000, "K Cooler 2p (+) freq", 97.50)
    prg.add(20500, "K Repumper 2p (+) freq", 96.00)
    prg.add(22000, "K Cooler 1p (-) freq", 115.00)
    prg.add(22500, "K Repumper 1p (+) freq", 115.00)
    prg.add(23000, "K Cooler 1p (-) Amp", 1000)
    prg.add(23500, "K Repumper 1p (+) Amp", 1000)
    prg.add(24000, "K probe Cooler (-) freq", 99.50)
    prg.add(24500, "K probe Repumper (+) freq", 126.00)
    prg.add(25000, "K probe Cooler (-) Amp", 1)
    prg.add(25500, "K probe Repumper (+) Amp", 750)
    ...
    prg.add(310000, "Na Zeeman slower (-) freq", 304.0)
