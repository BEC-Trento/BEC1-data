...
def program(prg, cmd):
    ...
    prg.add(390000, "B comp x", 850.0)
    prg.add(400000, "B comp y", 0.0000)
    prg.add(410000, "Analog71", 0.3500)
    prg.add(420000, "IGBT B comp x ON")
    prg.add(430000, "IGBT B comp y ON")
    prg.add(440000, "IGBT B comp z ON")
    return prg
