...
def program(prg, cmd):
    ...
    prg.add(-3033000, "Shutter Probe K Open", enable=False)
    prg.add(-3023000, "Shutter RepumperMOT K Open", enable=False)
    ...
    prg.add(260000, "Shutter Probe K Close", enable=False)
    ...
    prg.add(1030000, "K Repumper 1p (+) Amp", 1)
