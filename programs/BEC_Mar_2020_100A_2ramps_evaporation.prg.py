...
def program(prg, cmd):
    ...
    prg.add(230000000, "Config Field OFF.sub", functions=dict(time=lambda x: x+cmd.get_var('evap1_time')+cmd.get_var('evap2_time')+cmd.get_var('t_wait')+cmd.get_var('t_wait2')))
    ...
    prg.add(230000000, "Config Levitation", functions=dict(time=lambda x: x+cmd.get_var('evap1_time')+cmd.get_var('evap2_time')+cmd.get_var('t_wait')), enable=False)
    prg.add(230000000, "Config Field OFF.sub", functions=dict(time=lambda x: x+cmd.get_var('evap1_time')+cmd.get_var('evap2_time')+cmd.get_var('t_wait')+cmd.get_var('tof')-1+0.1), enable=False)
    prg.add(230000000, "BEC_imaging", functions=dict(time=lambda x: x+cmd.get_var('evap1_time')+cmd.get_var('evap2_time')+cmd.get_var('t_wait')+cmd.get_var('t_wait2')+cmd.get_var('tof')), enable=False)
    prg.add(230000000, "BEC_imaging_z", functions=dict(time=lambda x: x+cmd.get_var('evap1_time')+cmd.get_var('evap2_time')+cmd.get_var('tof')+cmd.get_var('t_wait')+cmd.get_var('t_wait2')))
    prg.add(240000000, "Config Field OFF.sub", functions=dict(time=lambda x: x+cmd.get_var('evap1_time')+cmd.get_var('evap2_time')+cmd.get_var('t_wait')+cmd.get_var('hold_time')+cmd.get_var('tof')), enable=False)
