...
def program(prg, cmd):
    ...
    prg.add(240000000, "Config Field OFF.sub", functions=dict(time=lambda x: x+cmd.get_var('evap1_time')+cmd.get_var('evap2_time')+cmd.get_var('t_wait')+cmd.get_var('t_wait2')+cmd.get_var('tof')))
