...
def program(prg, cmd):
    ...
    prg.add(9000000, "Synchronize.sub")
    ...
    prg.add(10200000, "BEC_imaging_xy", enable=False)
    ...
    prg.add(10662349, "Scope 1 Trigger Pulse", polarity=1, pulse_t=10.00000, functions=dict(time=lambda x: x-0.04154))
