...
def program(prg, cmd):
    ...
    prg.add(10000000, "Scope 1 Trigger Pulse", polarity=1, pulse_t=0.01448, functions=dict(time=lambda x: x-0.04154))
    ...
    prg.add(10000000, "BEC_imaging_xyz", enable=False)
    prg.add(10000000, "BEC_imaging_fast", enable=False)
