...
def program(prg, cmd):
    ...
    prg.add(4000000, "Rele 5 Close")
    prg.add(5000000, "Synchronize.sub")
    prg.add(72000000, "Na 3D MOT cool (-) Amp", 350.000000, enable=False)
    prg.add(79000000, "Rele 5 Open")
    prg.add(79500000, "Na 3D MOT cool (-) Amp", 1000.000000, enable=False)
    ...
    prg.add(94350000, "Config Field OFF ramp.sub")
    prg.add(94500000, "Picture NaK.sub")
    prg.add(170000000, "Set MOT NaK.sub")
    prg.add(171000000, "Config MOT.sub")
    prg.add(375000000, "Decompress Current MT.sub", enable=False)
    prg.add(375010000, "Decompress Voltage MT.sub", enable=False)
