...
def program(prg, cmd):
    ...
    prg.add(390009900, "General Trigger ON")
    prg.add(395000300, "Decompress Current MT.sub")
    prg.add(395010000, "Decompress Voltage MT.sub")
    prg.add(410010000, "IGBT 1 pinch", 10.000000)
    prg.add(410020000, "IGBT 1 pinch", -10.000000)
    prg.add(410470000, "Config Field OFF.sub")
    prg.add(410670029, "Picture.sub")
    prg.add(451500000, "Set MOT.sub")
    prg.add(452000000, "Dark Spot MOT load.sub")
    prg.add(452100000, "Config MOT.sub")
    return prg
