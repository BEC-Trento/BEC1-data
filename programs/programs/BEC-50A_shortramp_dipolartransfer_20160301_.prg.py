...
def program(prg, cmd):
    ...
    prg.add(382830000, "LZ -1 to 0", enable=False)
    ...
    prg.add(394800000, "excite pinch")
    prg.add(397005000, "Dipole Trap y DAC V", -8.5000)
    prg.add(397006000, "Dipole Trap x DAC V", 0.0000)
    prg.add(397011000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(397182000, "Picture NaK.sub")
    prg.add(407182000, "Bias field initialization")
    prg.add(413679000, "Pulse uw OFF")
    prg.add(416167200, "Set MOT NaK.sub")
    prg.add(416667200, "Dark Spot MOT load.sub")
    prg.add(416767200, "Config MOT.sub")
    return prg
def commands(cmd):
