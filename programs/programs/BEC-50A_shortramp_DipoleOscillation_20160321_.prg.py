...
def program(prg, cmd):
    ...
    prg.add(387750000, "spin cleaning pinch")
    prg.add(389760000, "Rele 2 Open")
    prg.add(390170000, "Rabi preparation")
    prg.add(394230000, "ReleConfigBackForGravityComp")
    prg.add(394590000, "Rabi pulse New Antena")
    prg.add(401994849, "Dipole Trap y DAC V", -0.1000)
    prg.add(401995249, "Dipole Trap x DAC V", 0.0000)
    prg.add(402000249, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(402000249, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(402000249, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(402000249, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(402000249, "Picture - DipoleLoad - Levit 50ms.sub", enable=False)
    prg.add(402000249, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(402320249, "LZ 1+1 to 2+2", enable=False)
    prg.add(402480249, "Picture NaK.sub", enable=False)
    prg.add(412780249, "excite pinch", enable=False)
    prg.add(424653649, "Bias field initialization")
    prg.add(425404349, "Pulse uw OFF")
    prg.add(433638849, "Set MOT NaK.sub")
    prg.add(434138849, "Dark Spot MOT load.sub")
    prg.add(434238849, "Config MOT.sub")
    return prg
def commands(cmd):
