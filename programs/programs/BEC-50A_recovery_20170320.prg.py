...
def program(prg, cmd):
    ...
    prg.add(200057959, "B comp x", 985.0)
    ...
    prg.add(731200000, "Config Field OFF.sub")
    prg.add(731400000, "Picture NaK.sub")
    prg.add(736400000, "Set MOT NaK.sub")
    prg.add(736900000, "Dark Spot MOT load.sub")
    prg.add(737000000, "Config MOT.sub")
    return prg
def commands(cmd):
    import numpy as np
