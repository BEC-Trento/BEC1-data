...
def program(prg, cmd):
    ...
    prg.add(397650100, "excite pinch", enable=False)
    prg.add(399670000, "Phase Imprint Pulse.sub")
    prg.add(409715500, "Dipole Trap y DAC V", -0.1000)
    prg.add(409715900, "Dipole Trap x DAC V", 0.0000)
    prg.add(409720900, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(409720900, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(409720900, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(409720900, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(409720900, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(409720900, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(409890900, "Picture NaK.sub")
    prg.add(421764300, "Bias field initialization")
    prg.add(422515000, "Pulse uw OFF", enable=False)
    prg.add(430749500, "Set MOT NaK.sub")
    prg.add(431249500, "Dark Spot MOT load.sub")
    prg.add(431349500, "Config MOT.sub")
    return prg
def commands(cmd):
