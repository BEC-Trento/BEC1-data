...
def program(prg, cmd):
    ...
    prg.add(380750050, "Dipole Trap y ramp", start_t=0.0000, stop_x=6.000, n_points=200, start_x=2.000, stop_t=100.0000, enable=False)
    prg.add(380760050, "Dipole Trap x ramp", start_t=0.0000, stop_x=4.000, n_points=100, start_x=2.000, stop_t=100.0000, enable=False)
    ...
    prg.add(382780050, "LZ -1 to 0", enable=False)
    prg.add(387280050, "MW repump preparation")
    prg.add(387280050, "Rabi preparation 2", enable=False)
    prg.add(390330050, "spin cleaning pinch", enable=False)
    ...
    prg.add(394680100, "Rabi pulse New Antena")
    prg.add(395180100, "Pulse uw ON")
    prg.add(395180600, "Pulse uw OFF")
    prg.add(395184895, "Dipole Trap y DAC V", -0.1000)
    prg.add(395185295, "Dipole Trap x DAC V", 0.0000)
    prg.add(395190295, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(395190295, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(395190295, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(395190295, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(395190295, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(395190295, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(395190295, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(395190295, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(395190295, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(395190295, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(395360295, "Picture NaK.sub", enable=False)
    prg.add(395360295, "Picture NaK no Rep.sub")
    prg.add(407233695, "Bias field initialization")
    prg.add(407984395, "Pulse uw OFF")
    prg.add(416218895, "Set MOT NaK.sub")
    prg.add(416718895, "Dark Spot MOT load.sub")
    prg.add(416818895, "Config MOT.sub")
    return prg
def commands(cmd):
