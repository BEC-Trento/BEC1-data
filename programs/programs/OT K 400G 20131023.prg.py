...
def program(prg, cmd):
    ...
    prg.add(474480000, "Config Feshbach.sub")
    prg.add(474680000, "Feshbach ramp 20ms 0-50A.sub")
    prg.add(474780000, "Delta 1 Current", 50.000000, enable=False)
    prg.add(474780009, "Delta 2 Voltage", 15.000000, enable=False)
    prg.add(475900000, "Feshbach ramp 10ms 50-0A.sub")
    prg.add(476569000, "Dipole Trap x (+) Amp", 1.000000)
    prg.add(476569400, "Dipole Trap y (-) Amp", 1.000000)
    prg.add(476570000, "Config Levitation F1+1.sub", enable=False)
