...
def program(prg, cmd):
    ...
    prg.add(394684395, "Dipole Trap y DAC V", -0.1000)
    prg.add(394684795, "Dipole Trap x DAC V", 0.0000)
    prg.add(394689795, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(394689795, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(394689795, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(394689795, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(394689795, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(394689795, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(394689795, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(394689795, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(394689795, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(394849795, "Picture NaK.sub", enable=False)
    prg.add(406723195, "Bias field initialization")
    prg.add(407473895, "Pulse uw OFF")
    prg.add(415708395, "Set MOT NaK.sub")
    prg.add(416208395, "Dark Spot MOT load.sub")
    prg.add(416308395, "Config MOT.sub")
    return prg
def commands(cmd):
