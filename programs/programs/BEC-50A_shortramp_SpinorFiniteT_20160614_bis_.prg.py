...
def program(prg, cmd):
    ...
    prg.add(395984395, "Dipole Trap y DAC V", -0.1000)
    prg.add(395984795, "Dipole Trap x DAC V", 0.0000)
    prg.add(395989795, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(395989795, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(395989795, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(395989795, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(395989795, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(395989795, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(395989795, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(395989795, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(395989795, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(396149795, "Picture NaK.sub", enable=False)
    prg.add(408023195, "Bias field initialization")
    prg.add(408773895, "Pulse uw OFF")
    prg.add(417008395, "Set MOT NaK.sub")
    prg.add(417508395, "Dark Spot MOT load.sub")
    prg.add(417608395, "Config MOT.sub")
    return prg
def commands(cmd):
