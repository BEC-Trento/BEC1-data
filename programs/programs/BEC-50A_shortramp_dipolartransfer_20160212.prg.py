...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(0, "RF mag sweep 0 level")
    ...
    prg.add(392800000, "Rabi oscillation 0 to 1-1")
    prg.add(393318000, "Dipole Trap y DAC V", 0.0000)
    prg.add(393319000, "Dipole Trap x DAC V", 0.0000)
    prg.add(393324000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(393495000, "Picture NaK.sub", enable=False)
    prg.add(403513200, "Set MOT NaK.sub")
    prg.add(403830500, "Config Field OFF.sub", enable=False)
    prg.add(404013200, "Dark Spot MOT load.sub")
    prg.add(404113200, "Config MOT.sub")
    return prg
def commands(cmd):
