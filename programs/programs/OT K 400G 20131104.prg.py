...
def program(prg, cmd):
    ...
    prg.add(473865000, "B comp y", 1.810000)
    prg.add(474366000, "Trigger LZ ON")
    prg.add(474466000, "Trigger LZ OFF")
    prg.add(474470000, "Config Field OFF.sub")
    ...
    prg.add(476559000, "Dipole Trap x (+) Amp", 1.000000)
    prg.add(476559400, "Dipole Trap y (-) Amp", 1.000000)
    prg.add(476560000, "Config Levitation from Feshbach.sub", enable=False)
    prg.add(476560000, "Config Levitation F1+1.sub")
    prg.add(476670000, "Config Field OFF.sub")
    prg.add(476676000, "Picture NaK.sub")
