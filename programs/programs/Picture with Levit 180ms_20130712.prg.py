...
def program(prg, cmd):
    ...
    prg.add(89000000, "B comp x", 317.000000)
    ...
    prg.add(479590000, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(479590000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(479600000, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(479600000, "Picture - Field off at 0ms - Levit 5ms.sub", enable=False)
