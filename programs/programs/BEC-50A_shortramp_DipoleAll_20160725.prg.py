...
def program(prg, cmd):
    ...
    prg.add(444743900, "Dipole Trap y DAC V", -0.1000)
    prg.add(444744300, "Dipole Trap x DAC V", 0.0000)
    prg.add(444745300, "Picture NaK.sub", enable=False)
    prg.add(444745300, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(444745300, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(444745300, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(444745300, "Picture - Field off at 0ms - Levit 30ms.sub")
    prg.add(444745300, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(444745300, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(444745300, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(444745300, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(444745300, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(444915300, "Picture NaK.sub", enable=False)
    prg.add(444915300, "Picture NaK no Rep.sub", enable=False)
    prg.add(449915300, "Bx Grad OFF")
    prg.add(461688699, "Bias field initialization")
    prg.add(462539399, "Pulse uw OFF")
    prg.add(470773899, "Set MOT NaK.sub")
    prg.add(471273899, "Dark Spot MOT load.sub")
    prg.add(471373899, "Config MOT.sub")
    return prg
def commands(cmd):
