...
def program(prg, cmd):
    ...
    prg.add(295000300, "Decompress Current MT.sub")
    prg.add(295010000, "Decompress Voltage MT.sub")
    prg.add(380099000, "General Trigger ON")
    prg.add(381000000, "Config Field OFF.sub")
    prg.add(381320029, "Picture.sub")
    prg.add(391500000, "Set MOT.sub")
    prg.add(392000000, "Dark Spot MOT load.sub")
    prg.add(392100000, "Config MOT.sub")
    return prg
