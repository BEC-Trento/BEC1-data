...
def program(prg, cmd):
    ...
    prg.add(179058460, "B comp x", 1045.0)
    ...
    prg.add(685770000, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(693431580, "Config Field OFF.sub", enable=False)
    prg.add(693433580, "Picture NaK Hamamatsu.sub", enable=False)
    prg.add(693433580, "Picture NaK.sub", enable=False)
    prg.add(722267000, "Picture - Field off at 0ms - Levit 5ms.sub", enable=False)
    prg.add(724300000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(724300000, "Bottom Evaporation ON")
    prg.add(724305000, "RFO FM amp", 0.5000)
    prg.add(724805000, "RFO FM amp", 0.0000)
    prg.add(724806000, "Config Field OFF.sub", enable=False)
    prg.add(724809000, "Picture NaK.sub", enable=False)
    prg.add(724809000, "Picture NaK Hamamatsu.sub", enable=False)
    prg.add(724809000, "Picture NaK Repump Off.sub", enable=False)
    prg.add(724811000, "Bottom Evaporation OFF")
    prg.add(724812420, "Picture - Field off at 0ms - Levit 180ms.sub")
    prg.add(724812420, "Picture - Field off at 0ms - Levit 180ms - Hamamatsu.sub", enable=False)
    prg.add(724812420, "Picture - Field off at 0ms - Levit 50ms - Hamamatsu.sub", enable=False)
    prg.add(724812420, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(728800840, "Picture - Field off at 0ms - Levit 80ms.sub", enable=False)
    prg.add(732580840, "Set MOT NaK.sub")
    prg.add(733080840, "Dark Spot MOT load.sub")
    prg.add(733180840, "Config MOT.sub")
    return prg
def commands(cmd):
