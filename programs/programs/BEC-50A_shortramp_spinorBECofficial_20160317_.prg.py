...
def program(prg, cmd):
    ...
    prg.add(392803000, "Pulse uw OFF")
    prg.add(392809000, "Dipole Trap y DAC V", -0.1000)
    prg.add(392809400, "Dipole Trap x DAC V", 0.0000)
    prg.add(392814400, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(392814400, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(392814400, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(392814400, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(392814400, "Picture - DipoleLoad - Levit 50ms.sub", enable=False)
    prg.add(392814400, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub")
    prg.add(393134400, "LZ 1+1 to 2+2")
    prg.add(393294400, "Picture NaK.sub", enable=False)
    prg.add(403594400, "excite pinch", enable=False)
    prg.add(415467800, "Bias field initialization")
    prg.add(424453000, "Set MOT NaK.sub")
    prg.add(424953000, "Dark Spot MOT load.sub")
    prg.add(425053000, "Config MOT.sub")
    return prg
def commands(cmd):
