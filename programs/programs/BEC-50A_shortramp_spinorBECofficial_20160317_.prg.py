...
def program(prg, cmd):
    ...
    prg.add(542603000, "Pulse uw OFF")
    prg.add(542609000, "Dipole Trap y DAC V", -0.1000)
    prg.add(542609400, "Dipole Trap x DAC V", 0.0000)
    prg.add(542614400, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(542614400, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(542614400, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(542614400, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(542614400, "Picture - DipoleLoad - Levit 50ms.sub", enable=False)
    prg.add(543094400, "Picture NaK.sub", enable=False)
    prg.add(553394400, "excite pinch", enable=False)
    prg.add(565267800, "Bias field initialization")
    prg.add(574253000, "Set MOT NaK.sub")
    prg.add(574753000, "Dark Spot MOT load.sub")
    prg.add(574853000, "Config MOT.sub")
    return prg
def commands(cmd):
