...
def program(prg, cmd):
    ...
    prg.add(129009540, "B comp x", 395.0)
    ...
    prg.add(665589000, "B comp x ramp", start_t=0, stop_x=304, n_points=25, start_x=395, stop_t=500)
    prg.add(665590000, "Delta 1 Current ramp", start_t=0.0000, stop_x=50.000, n_points=300, start_x=100.000, stop_t=500.0000)
    prg.add(670430000, "Picture NaK RFO doubleCam.sub")
    prg.add(671110000, "RFO FM amp", 0.5000)
    prg.add(671130100, "RFO SingleSweepTrig Ramp", start_t=0.0000, stop_x=0.000, n_points=61, start_x=1.000, stop_t=600.0000)
    prg.add(671140000, "Pulse uw ON")
    prg.add(672730000, "RFO FM amp", 0.7000)
    prg.add(673630000, "RFO FM amp", 1.0000)
    prg.add(674870000, "RFO FM amp", 1.6000)
    prg.add(674914000, "RFO FM ampQuantum Ramp", start_t=0.0000, stop_x=0.000, n_points=24, start_x=1.000, stop_t=230.0000, enable=False)
    prg.add(675715000, "RFO FM amp", 5.0000)
    prg.add(679565000, "Pulse uw OFF")
    prg.add(679605000, "Picture - Levit Film.sub")
    prg.add(683075000, "RFO FM amp", 0.0000)
    prg.add(693075500, "Set MOT NaK.sub")
    prg.add(693575500, "Dark Spot MOT load.sub")
    prg.add(693675500, "Config MOT.sub")
    return prg
