...
def program(prg, cmd):
    ...
    prg.add(200057960, "B comp x", 935.0)
    ...
    prg.add(745281099, "Pulse uw ON", enable=False)
    prg.add(745281599, "Pulse uw OFF", enable=False)
    prg.add(745301599, "Config Field OFF.sub", enable=False)
    prg.add(745302599, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(745302599, "Picture - Field off at 0ms - Levit 180ms.sub")
    prg.add(745302599, "Picture NaK Hamamatsu.sub", enable=False)
    prg.add(745303599, "Picture NaK no Rep.sub", enable=False)
    prg.add(745303599, "Picture NaK.sub", enable=False)
    prg.add(760303599, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(766303599, "Set MOT NaK.sub")
    prg.add(766803599, "Dark Spot MOT load.sub")
    prg.add(766903599, "Config MOT.sub")
    return prg
def commands(cmd):
