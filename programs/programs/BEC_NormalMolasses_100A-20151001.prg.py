...
def program(prg, cmd):
    ...
    prg.add(681360000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(681360000, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(681360000, "Picture - Field off at 0ms - Levit 150msBraggAllign.sub", enable=False)
    prg.add(685010000, "Config Field OFF.sub")
    prg.add(685020000, "Picture NaK.sub")
