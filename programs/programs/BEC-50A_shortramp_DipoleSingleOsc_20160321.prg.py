...
def program(prg, cmd):
    ...
    prg.add(381370000, "excite pinch")
    prg.add(381870000, "ReleConfigBackForGravityComp")
    prg.add(382470000, "Dipole Trap y DAC V", -0.1000)
    prg.add(382470400, "Dipole Trap x DAC V", 0.0000)
    prg.add(382475400, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(382475400, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(382475400, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub")
    prg.add(382475400, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(382475400, "Picture - DipoleLoad - Levit 50ms.sub", enable=False)
    prg.add(382475400, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(382795400, "LZ 1+1 to 2+2", enable=False)
    prg.add(382955400, "Picture NaK.sub", enable=False)
    prg.add(393255400, "excite pinch", enable=False)
    prg.add(405128800, "Bias field initialization")
    prg.add(405879500, "Pulse uw OFF")
    prg.add(414114000, "Set MOT NaK.sub")
    prg.add(414614000, "Dark Spot MOT load.sub")
    prg.add(414714000, "Config MOT.sub")
    return prg
def commands(cmd):
