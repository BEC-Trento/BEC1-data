...
def program(prg, cmd):
    ...
    prg.add(674553980, "Config Field OFF.sub")
    prg.add(674553980, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(674563980, "Picture NaK Bragg Tom.sub")
