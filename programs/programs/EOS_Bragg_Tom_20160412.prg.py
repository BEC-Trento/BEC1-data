...
def program(prg, cmd):
    ...
    prg.add(674501780, "Bragg Pulse Single2015.sub", enable=False)
    prg.add(674502000, "Pulse uw ON", enable=False)
    prg.add(674552000, "Pulse uw OFF", enable=False)
    prg.add(674553980, "Config Field OFF.sub", enable=False)
    prg.add(674553980, "Picture - Field off at 0ms - Levit 180ms.sub")
    prg.add(674563980, "Picture NaK Bragg Tom.sub", enable=False)
    prg.add(674563980, "Picture NaK.sub", enable=False)
    prg.add(674563980, "Na Repumper1 (+) Amp", 600, enable=False)
    prg.add(680193980, "Set MOT NaK.sub")
    prg.add(680693980, "Dark Spot MOT load.sub")
    prg.add(680793980, "Config MOT.sub")
    return prg
def commands(cmd):
