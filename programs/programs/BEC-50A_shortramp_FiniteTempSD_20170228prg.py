...
def program(prg, cmd):
    ...
    prg.add(281371900, "B comp y ramp", start_t=0, stop_x=3, n_points=200, start_x=0, stop_t=130)
    ...
    prg.add(307422050, "ReleConfigBackForGravityComp", enable=False)
    prg.add(307922050, "Rabi pulse New Antena", enable=False)
    prg.add(307972050, "Dipole Trap x DAC V", 0.0000)
    prg.add(307972150, "Dipole Trap y DAC V", -0.1000)
    prg.add(307972250, "Picture NaK.sub", enable=False)
    prg.add(307972250, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(307972250, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(307972250, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(307972250, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(307972250, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(307972250, "Picture - Field off at 0ms -SternGerlach_Ele.sub", enable=False)
    prg.add(307972250, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(307972250, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(307972250, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(307972250, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(308142250, "Picture NaK.sub", enable=False)
    prg.add(308142250, "Picture NaK no Rep.sub", enable=False)
    prg.add(312598750, "Bx Grad OFF")
    prg.add(324372149, "Bias field initialization")
    prg.add(325222849, "Pulse uw OFF")
    prg.add(333457349, "Set MOT NaK.sub")
    prg.add(333957349, "Dark Spot MOT load.sub")
    prg.add(334057349, "Config MOT.sub")
    return prg
def commands(cmd):
