...
def program(prg, cmd):
    ...
    prg.add(679019000, "Bottom Evaporation ON")
    prg.add(679019400, "Pulse uw ON", enable=False)
    prg.add(679314400, "Pulse uw ON")
    prg.add(679474400, "Pulse uw OFF")
    prg.add(679484400, "Picture NaK.sub", enable=False)
    prg.add(679484400, "Picture NaK no Rep.sub")
    prg.add(679524400, "Bottom Evaporation OFF")
    prg.add(680494400, "Config Field OFF.sub", enable=False)
    prg.add(680494400, "Picture - Levit Film.sub", enable=False)
    prg.add(680494400, "Picture - Levit Film 50ms.sub")
    prg.add(680594400, "Picture NaK Trig2.sub", enable=False)
    prg.add(696134400, "Set MOT NaK.sub")
    prg.add(696634400, "Dark Spot MOT load.sub")
    prg.add(696734400, "Config MOT.sub")
    return prg
