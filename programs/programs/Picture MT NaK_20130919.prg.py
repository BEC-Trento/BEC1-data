...
def program(prg, cmd):
    ...
    prg.add(72010000, "Delta 1 Current", 12.000000)
    ...
    prg.add(80100000, "Rele 5 Open")
    prg.add(91100000, "Config Field OFF ramp.sub")
    prg.add(91125000, "Picture close NaK.sub")
    prg.add(100000000, "Set MOT NaK.sub")
    prg.add(105000000, "Config MOT.sub")
    return prg
