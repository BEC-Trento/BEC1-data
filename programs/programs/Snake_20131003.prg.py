...
def program(prg, cmd):
    ...
    prg.add(470000000, "Shutter OT x Open")
    prg.add(470500000, "Dipole Trap x (+) Amp", 1.000000)
    prg.add(470501000, "Dipole Trap y (-) Amp", 1.000000)
    prg.add(473802000, "OT x ramp.sub")
    prg.add(473802500, "OT y ramp.sub")
    prg.add(474850000, "Config Field OFF ramp.sub")
    prg.add(474850000, "Picture NaK-50ms levit.sub", enable=False)
    prg.add(476235000, "Dipole Trap x (+) Amp", 1.000000)
    prg.add(476235500, "Dipole Trap y (-) Amp", 1.000000)
    prg.add(476335000, "Picture NaK.sub")
