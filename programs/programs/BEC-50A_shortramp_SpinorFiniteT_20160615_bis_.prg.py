...
def program(prg, cmd):
    ...
    prg.add(380750050, "Dipole Trap y ramp", start_t=0.0000, stop_x=6.000, n_points=200, start_x=2.000, stop_t=10.0000)
    prg.add(380760050, "Dipole Trap x ramp", start_t=0.0000, stop_x=4.000, n_points=100, start_x=2.000, stop_t=10.0000)
    ...
    prg.add(395780100, "Dipole Trap y DAC V", -0.1000)
    prg.add(395780500, "Dipole Trap x DAC V", 0.0000)
    prg.add(395785500, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(395785500, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(395785500, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(395785500, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(395785500, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(395785500, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(395785500, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(395785500, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(395785500, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(395945500, "Picture NaK.sub", enable=False)
    prg.add(407818900, "Bias field initialization")
    prg.add(408569600, "Pulse uw OFF")
    prg.add(416804100, "Set MOT NaK.sub")
    prg.add(417304100, "Dark Spot MOT load.sub")
    prg.add(417404100, "Config MOT.sub")
    return prg
def commands(cmd):
