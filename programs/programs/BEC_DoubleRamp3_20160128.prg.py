...
def program(prg, cmd):
    ...
    prg.add(671500000, "RFO FM amp", 0.4000)
    prg.add(672730000, "RFO FM amp", 0.5000)
    prg.add(673630000, "RFO FM amp", 0.6500)
    prg.add(674730000, "RFO FM amp", 0.8000)
    prg.add(675629000, "RFO FM amp", 1.0000)
    prg.add(676229000, "RFO FM amp", 2.6000)
    prg.add(676829000, "RFO FM amp", 3.7000)
