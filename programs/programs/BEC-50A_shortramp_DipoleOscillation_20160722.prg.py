...
def program(prg, cmd):
    ...
    prg.add(445739600, "Bx Grad ON")
    prg.add(448039600, "Dipole Trap y DAC V", -0.1000)
    prg.add(448040000, "Dipole Trap x DAC V", 0.0000)
    prg.add(448041000, "Picture NaK.sub", enable=False)
    prg.add(448043000, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(448043000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(448043000, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(448043000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(448043000, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(448043000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(448043000, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(448043000, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub")
    prg.add(448213000, "Picture NaK.sub", enable=False)
    prg.add(448213000, "Picture NaK no Rep.sub", enable=False)
    prg.add(453213000, "Bx Grad OFF")
    prg.add(464986399, "Bias field initialization")
    prg.add(465837099, "Pulse uw OFF")
    prg.add(474071599, "Set MOT NaK.sub")
    prg.add(474571599, "Dark Spot MOT load.sub")
    prg.add(474671599, "Config MOT.sub")
    return prg
def commands(cmd):
