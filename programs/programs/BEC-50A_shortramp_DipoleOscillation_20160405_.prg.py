...
def program(prg, cmd):
    ...
    prg.add(387750050, "Rabi preparation 2")
    prg.add(390800050, "spin cleaning pinch")
    prg.add(392000000, "Bcomp y Sign Minus", enable=False)
    prg.add(392850050, "ReleConfigBackForGravityComp")
    prg.add(392850050, "ReleConfigBackForAntiGravityComp", enable=False)
    prg.add(393350050, "Rabi pulse New Antena", enable=False)
    prg.add(393574550, "Dipole Trap y DAC V", -0.1000)
    prg.add(393574950, "Dipole Trap x DAC V", 0.0000)
    prg.add(393579950, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(393579950, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(393579950, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(393579950, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(393579950, "Picture - DipoleLoad - Levit 50ms.sub", enable=False)
    prg.add(393579950, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(393579950, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(393739950, "Picture NaK.sub")
    prg.add(404039950, "excite pinch", enable=False)
    prg.add(415913350, "Bias field initialization")
    prg.add(416664050, "Pulse uw OFF")
    prg.add(424898550, "Set MOT NaK.sub")
    prg.add(425398550, "Dark Spot MOT load.sub")
    prg.add(425498550, "Config MOT.sub")
    return prg
def commands(cmd):
