...
def program(prg, cmd):
    ...
    prg.add(385250050, "Rabi preparation 2", enable=False)
    prg.add(388300050, "spin cleaning pinch", enable=False)
    ...
    prg.add(392650100, "Rabi pulse New Antena", enable=False)
    prg.add(397650100, "excite pinch")
    prg.add(399674600, "Dipole Trap y DAC V", -0.1000)
    prg.add(399675000, "Dipole Trap x DAC V", 0.0000)
    prg.add(399680000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(399680000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(399680000, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(399680000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(399680000, "Picture - DipoleLoad - Levit 50ms.sub", enable=False)
    prg.add(399680000, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(399680000, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(399850000, "Picture NaK.sub")
    prg.add(411723400, "Bias field initialization")
    prg.add(412474100, "Pulse uw OFF", enable=False)
    prg.add(420708600, "Set MOT NaK.sub")
    prg.add(421208600, "Dark Spot MOT load.sub")
    prg.add(421308600, "Config MOT.sub")
    return prg
def commands(cmd):
