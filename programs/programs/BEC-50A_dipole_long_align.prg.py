...
def program(prg, cmd):
    ...
    prg.add(179058460, "B comp x", 1025.0)
    ...
    prg.add(684295500, "Dipole Trap x DAC V", 3.0000)
    prg.add(684305000, "Dipole Trap y DAC V", 6.0000)
    ...
    prg.add(724300000, "Config Field OFF.sub", enable=False)
    ...
    prg.add(724305500, "Picture - Field off at 0ms - Levit 50ms.sub")
    prg.add(724310500, "Picture - Field off at 0ms - End Levit and Picture.sub", enable=False)
    prg.add(724310500, "Picture NaK.sub", enable=False)
    prg.add(724310500, "Picture NaK Repump Off.sub", enable=False)
    prg.add(724313920, "Picture - Field off at 0ms - Levit 180ms - Hamamatsu.sub", enable=False)
    prg.add(724313920, "Picture - Field off at 0ms - Levit 50ms - Hamamatsu.sub", enable=False)
    prg.add(724313920, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(724323080, "Dipole Trap y DAC V", 0.0000)
    prg.add(724323580, "Dipole Trap x DAC V", 0.0000)
    prg.add(725812340, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(727812340, "Picture - Field off at 0ms - Levit 80ms.sub", enable=False)
    prg.add(731592340, "Set MOT NaK.sub")
    prg.add(732092340, "Dark Spot MOT load.sub")
    prg.add(732192340, "Config MOT.sub")
    return prg
def commands(cmd):
