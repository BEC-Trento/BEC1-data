...
def program(prg, cmd):
    ...
    prg.add(179058460, "B comp x", 1035.0)
    ...
    prg.add(693440000, "Config Field OFF.sub", enable=False)
    prg.add(693442000, "Picture NaK Hamamatsu.sub", enable=False)
    prg.add(693442000, "Picture NaK.sub", enable=False)
    prg.add(722275420, "Picture - Field off at 0ms - Levit 5ms.sub", enable=False)
    prg.add(724300000, "Picture - Field off at 0ms - Init Levit.sub", enable=False)
    prg.add(724300000, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(724305000, "Dipole Trap y DAC V", 6.0000)
    prg.add(724305500, "Dipole Trap x DAC V", 4.0000)
    prg.add(724305500, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(724310500, "Picture - Field off at 0ms - End Levit and Picture.sub", enable=False)
    prg.add(724315500, "Picture NaK.sub")
    prg.add(724315500, "Picture NaK Repump Off.sub", enable=False)
    prg.add(724318920, "Picture - Field off at 0ms - Levit 180ms - Hamamatsu.sub", enable=False)
    prg.add(724318920, "Picture - Field off at 0ms - Levit 50ms - Hamamatsu.sub", enable=False)
    prg.add(724318920, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(724328080, "Dipole Trap y DAC V", 0.0000)
    prg.add(724328580, "Dipole Trap x DAC V", 0.0000)
    prg.add(725817340, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(727817340, "Picture - Field off at 0ms - Levit 80ms.sub", enable=False)
    prg.add(731597340, "Set MOT NaK.sub")
    prg.add(732097340, "Dark Spot MOT load.sub")
    prg.add(732197340, "Config MOT.sub")
    return prg
def commands(cmd):
