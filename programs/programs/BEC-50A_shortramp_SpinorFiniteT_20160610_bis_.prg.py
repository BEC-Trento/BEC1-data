...
def program(prg, cmd):
    ...
    prg.add(270000500, "Dipole Trap y ramp", start_t=0.0000, stop_x=1.000, n_points=300, start_x=-0.100, stop_t=2000.0000)
    ...
    prg.add(380750050, "Dipole Trap y ramp", start_t=0.0000, stop_x=6.000, n_points=200, start_x=1.000, stop_t=10.0000, enable=False)
    prg.add(380760050, "Dipole Trap x ramp", start_t=0.0000, stop_x=4.000, n_points=100, start_x=2.000, stop_t=20.0000, enable=False)
    ...
    prg.add(387280050, "Rabi preparation 2")
    ...
    prg.add(404680100, "excite pinch", enable=False)
    prg.add(407324398, "Dipole Trap y DAC V", -0.1000)
    prg.add(407324798, "Dipole Trap x DAC V", 0.0000)
    prg.add(407329798, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(407329798, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(407329798, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(407329798, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(407329798, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(407329798, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(407329798, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(407329798, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(407329798, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(407429798, "Picture NaK.sub", enable=False)
    prg.add(419303198, "Bias field initialization")
    prg.add(420053898, "Pulse uw OFF")
    prg.add(428288398, "Set MOT NaK.sub")
    prg.add(428788398, "Dark Spot MOT load.sub")
    prg.add(428888398, "Config MOT.sub")
    return prg
def commands(cmd):
