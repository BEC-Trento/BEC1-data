...
def program(prg, cmd):
    ...
    prg.add(89000000, "B comp x", 278.000000)
    prg.add(90003000, "Evaporation Ramp.sub")
    prg.add(375000300, "Decompress Current MT.sub")
    prg.add(375010000, "Decompress Voltage MT.sub")
    prg.add(483690500, "B comp y ramp 0-5 1ms.sub")
    prg.add(483700000, "Config Field OFF ramp.sub")
    prg.add(483710300, "Config Levitation F1+1.sub")
    prg.add(483710450, "B comp x", 0.000000)
    prg.add(483710500, "B comp y ramp 5-0 1ms.sub")
    prg.add(485495000, "Config Field OFF.sub")
    prg.add(485501000, "Picture.sub")
    ...
    prg.add(520000000, "Na Repumper MOT Amp", 1000.000000, enable=False)
    return prg
