...
def program(prg, cmd):
    ...
    prg.add(381430000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(405612700, "Set MOT NaK.sub")
    prg.add(406112700, "Dark Spot MOT load.sub")
    prg.add(406212700, "Config MOT.sub")
    prg.add(417977862, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    return prg
def commands(cmd):
