...
def program(prg, cmd):
    ...
    prg.add(446239600, "Bx Grad Pulse")
    prg.add(446329600, "Dipole Trap y DAC V", -0.1000)
    prg.add(446330000, "Dipole Trap x DAC V", 0.0000)
    prg.add(446335000, "Bx Grad OFF")
    prg.add(446336000, "Picture NaK.sub", enable=False)
    prg.add(446338000, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(446338000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(446338000, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(446338000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(446338000, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(446338000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(446338000, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(446338000, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub")
    prg.add(446340000, "Picture NaK.sub", enable=False)
    prg.add(446340000, "Picture NaK no Rep.sub", enable=False)
    prg.add(451340000, "Bx Grad OFF")
    prg.add(463113399, "Bias field initialization")
    prg.add(463964099, "Pulse uw OFF")
    prg.add(472198599, "Set MOT NaK.sub")
    prg.add(472698599, "Dark Spot MOT load.sub")
    prg.add(472798599, "Config MOT.sub")
    return prg
def commands(cmd):
