...
def program(prg, cmd):
    ...
    prg.add(453243898, "Dipole Trap y DAC V", -0.1000)
    prg.add(453244298, "Dipole Trap x DAC V", 0.0000)
    prg.add(453245298, "Picture NaK.sub", enable=False)
    prg.add(453247298, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(453247298, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(453247298, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(453247298, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(453247298, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(453247298, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(453247298, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(453247298, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub")
    prg.add(453249298, "Picture NaK.sub", enable=False)
    prg.add(453249298, "Picture NaK no Rep.sub", enable=False)
    prg.add(458249298, "Bx Grad OFF")
    prg.add(470022697, "Bias field initialization")
    prg.add(470873397, "Pulse uw OFF")
    prg.add(479107897, "Set MOT NaK.sub")
    prg.add(479607897, "Dark Spot MOT load.sub")
    prg.add(479707897, "Config MOT.sub")
    return prg
def commands(cmd):
