...
def program(prg, cmd):
    ...
    prg.add(202191645, "B comp x", 733.0)
    ...
    prg.add(791230000, "B comp x ramp", start_t=0, stop_x=860, n_points=200, start_x=733, stop_t=1200)
    ...
    prg.add(811241575, "Picture NaK Hamamatsu.sub")
