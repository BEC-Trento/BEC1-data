...
def program(prg, cmd):
    ...
    prg.add(380330000, "LZ -1 to 0", enable=False)
    prg.add(386830000, "ReleConfigBackForGravityComp")
    prg.add(387180000, "Dipole Trap y DAC V", -0.1000)
    prg.add(387180400, "Dipole Trap x DAC V", 0.0000)
    prg.add(387181400, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(387181400, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(387181400, "Picture -DipoleLoad-SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(387181400, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(387181400, "Picture - DipoleLoad - Levit 50ms.sub", enable=False)
    prg.add(387181400, "Picture - Field off at 0ms - Levit 30ms.sub")
    prg.add(387661400, "Picture NaK.sub", enable=False)
    prg.add(390924800, "Bias field initialization")
    prg.add(399910000, "Set MOT NaK.sub")
    prg.add(400410000, "Dark Spot MOT load.sub")
    prg.add(400510000, "Config MOT.sub")
    return prg
def commands(cmd):
