...
def program(prg, cmd):
    ...
    prg.add(495000300, "Decompress Current MT.sub")
    prg.add(495010000, "Decompress Voltage MT.sub")
    prg.add(580099000, "General Trigger ON")
    prg.add(581000000, "Config Field OFF.sub")
    prg.add(581320030, "Picture.sub")
    prg.add(591500000, "Set MOT.sub")
    prg.add(592000000, "Dark Spot MOT load.sub")
    prg.add(592100000, "Config MOT.sub")
    return prg
