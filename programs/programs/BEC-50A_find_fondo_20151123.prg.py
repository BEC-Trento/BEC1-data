...
def program(prg, cmd):
    ...
    prg.add(179058460, "B comp x", 1042.0)
    ...
    prg.add(693450000, "Picture NaK.sub", enable=False)
    prg.add(693450000, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(722283420, "Picture - Field off at 0ms - Levit 5ms.sub", enable=False)
    prg.add(724308000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(724308000, "Picture - Field off at 0ms - Levit 180ms.sub")
    prg.add(724308000, "Config Field OFF.sub", enable=False)
    prg.add(724318000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(724318000, "Picture NaK.sub", enable=False)
    prg.add(724318000, "Picture NaK Hamamatsu.sub", enable=False)
    prg.add(724318000, "Picture NaK Repump Off.sub", enable=False)
    prg.add(724318000, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(724318000, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(724318000, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(724318000, "Picture - Field off at 0ms - Levit 80ms.sub", enable=False)
    prg.add(728098000, "Set MOT NaK.sub")
    prg.add(728598000, "Dark Spot MOT load.sub")
    prg.add(728698000, "Config MOT.sub")
    return prg
def commands(cmd):
