...
def program(prg, cmd):
    ...
    prg.add(200069900, "B comp x", 970.0)
    ...
    prg.add(474391100, "Picture NaK.sub", enable=False)
    ...
    prg.add(488781300, "Rabi pulse New Antena", enable=False)
    prg.add(488785600, "Bx Grad Pulse", enable=False)
    prg.add(488785600, "TTL2-11 ON")
    prg.add(488785700, "Bx Grad OFF", enable=False)
    prg.add(488790700, "Bx Grad ON", enable=False)
    prg.add(488790700, "excite pinch", enable=False)
    prg.add(489891200, "Dipole Trap x DAC V", 0.0000, functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    prg.add(489891700, "Dipole Trap y DAC V", 0.0000, functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    prg.add(489892099, "TTL2-10 OFF", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    prg.add(489892199, "TTL2-11 OFF", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    prg.add(489897199, "Picture NaK.sub", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False), enable=False)
    prg.add(489898199, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(489898699, "Picture - Field off at 0ms -SternGerlach_Ele.sub", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    prg.add(489898699, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(489898699, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(489898699, "Picture - Field off at 0ms -SternGerlach_ShortElena2017.sub", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False), enable=False)
    prg.add(489958699, "Picture NaK.sub", enable=False)
    prg.add(489958699, "Picture NaK no Rep.sub", enable=False)
    prg.add(495968699, "Bx Grad OFF", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    prg.add(495968799, "TTL2 5 OFF", enable=False)
    prg.add(507742198, "Bias field initialization", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    prg.add(508592896, "Pulse uw OFF", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    prg.add(516827397, "Set MOT NaK.sub", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    prg.add(517327397, "Dark Spot MOT load.sub", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    prg.add(517427397, "Config MOT.sub", functions=dict(time=lambda x: x+cmd.get_var('dt'), funct_enable=False))
    return prg
def commands(cmd):
    import numpy as np
    iters = np.arange(0, 1000, 40)
    j = 0
    while(cmd.running):
        dt1 = iters[j]
        cmd.set_var('dt', dt1)
