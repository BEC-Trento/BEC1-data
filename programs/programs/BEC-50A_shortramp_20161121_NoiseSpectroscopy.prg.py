...
def program(prg, cmd):
    ...
    prg.add(428372000, "MT ramp plus opening")
    ...
    prg.add(430752000, "Bcomp z Sign Minus", enable=False)
    ...
    prg.add(436802050, "Majorana_spactroscopy")
    prg.add(442106200, "Dipole Trap x DAC V", 0.0000)
    prg.add(442106700, "Dipole Trap y DAC V", -0.1000)
    prg.add(442106710, "Picture NaK.sub", enable=False)
    prg.add(442106710, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(442106710, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(442106710, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(442106710, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(442106710, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(442106710, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(442106710, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(442106710, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(442106710, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(442238209, "Picture NaK.sub", enable=False)
    prg.add(442238209, "Picture NaK no Rep.sub", enable=False)
    prg.add(447238209, "Bx Grad OFF", enable=False)
    prg.add(459011608, "Bias field initialization")
    prg.add(459862308, "Pulse uw OFF")
    prg.add(468096808, "Set MOT NaK.sub")
    prg.add(468596808, "Dark Spot MOT load.sub")
    prg.add(468696808, "Config MOT.sub")
    return prg
def commands(cmd):
