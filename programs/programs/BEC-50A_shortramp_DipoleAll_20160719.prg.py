...
def program(prg, cmd):
    ...
    prg.add(444739600, "Excite_Gradx", enable=False)
    prg.add(504739600, "excite pinch", enable=False)
    prg.add(504739600, "Excite Levit coil")
    prg.add(506419600, "Dipole Trap y DAC V", -0.1000)
    prg.add(506420000, "Dipole Trap x DAC V", 0.0000)
    prg.add(506421000, "Picture NaK.sub", enable=False)
    prg.add(506423000, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(506423000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(506423000, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(506423000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(506423000, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(506423000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(506423000, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(506423000, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(506593000, "Picture NaK.sub")
    prg.add(506593000, "Picture NaK no Rep.sub", enable=False)
    prg.add(511593000, "Bx Grad OFF")
    prg.add(523366399, "Bias field initialization")
    prg.add(524217099, "Pulse uw OFF")
    prg.add(532451599, "Set MOT NaK.sub")
    prg.add(532951599, "Dark Spot MOT load.sub")
    prg.add(533051599, "Config MOT.sub")
    return prg
def commands(cmd):
