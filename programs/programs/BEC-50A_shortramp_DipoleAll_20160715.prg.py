...
def program(prg, cmd):
    ...
    prg.add(444746000, "Picture NaK.sub")
    prg.add(444751000, "Bx Grad OFF", enable=False)
    prg.add(444754000, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(444754000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(444754000, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(444754000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(444754000, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(444754000, "Picture - Field off at 0ms - Levit 50ms.sub")
    prg.add(444754000, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(444754000, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(444756000, "Picture NaK.sub", enable=False)
    prg.add(444756000, "Picture NaK no Rep.sub", enable=False)
    prg.add(449756000, "Bx Grad OFF")
    prg.add(461529399, "Bias field initialization")
    prg.add(462380099, "Pulse uw OFF")
    prg.add(470614599, "Set MOT NaK.sub")
    prg.add(471114599, "Dark Spot MOT load.sub")
    prg.add(471214599, "Config MOT.sub")
    return prg
def commands(cmd):
