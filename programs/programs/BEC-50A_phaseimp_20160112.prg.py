...
def program(prg, cmd):
    ...
    prg.add(674280000, "Test imaging phase imprint 180ms", enable=False)
    prg.add(674280000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(674280000, "Phase Imprint Pulse.sub", enable=False)
    prg.add(674300000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(674300000, "Picture - Field off at 0ms - Levit 180ms.sub")
    prg.add(674310000, "Config Field OFF.sub", enable=False)
    prg.add(674310000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(674310000, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(674320000, "Picture NaK.sub", enable=False)
    prg.add(685963962, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(696663962, "Set MOT NaK.sub")
    prg.add(697163962, "Dark Spot MOT load.sub")
    prg.add(697263962, "Config MOT.sub")
    return prg
def commands(cmd):
    a=[4,5,6]
    cmd.set_var("hhh", 4)
