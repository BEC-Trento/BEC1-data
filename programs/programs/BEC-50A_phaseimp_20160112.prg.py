...
def program(prg, cmd):
    ...
    prg.add(674280000, "Config Field OFF.sub", enable=False)
    prg.add(674280000, "Test imaging phase imprint 180ms", enable=False)
    prg.add(674280000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(674280000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(674280000, "Phase Imprint Pulse.sub")
    prg.add(674410000, "Picture - Field off at 0ms - Levit 180ms.sub")
    prg.add(674864962, "Picture NaK.sub", enable=False)
    prg.add(674864962, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(685953962, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(696653962, "Set MOT NaK.sub")
    prg.add(697153962, "Dark Spot MOT load.sub")
    prg.add(697253962, "Config MOT.sub")
    return prg
def commands(cmd):
    a=[4,5,6]
    cmd.set_var("hhh", 4)
