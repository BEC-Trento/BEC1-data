...
def program(prg, cmd):
    ...
    prg.add(270000500, "Dipole Trap y ramp", start_t=0.0000, stop_x=1.800, n_points=300, start_x=-8.500, stop_t=2000.0000)
    ...
    prg.add(388310500, "Dipole Trap y DAC V", -8.5000)
    prg.add(388315000, "Picture NaK.sub", enable=False)
    prg.add(388320000, "Picture - Field off at 0ms - Levit 50ms.sub", functions=dict(time=lambda x: x + cmd.get_var("t"), funct_enable=False), enable=False)
    ...
    prg.add(388320000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
