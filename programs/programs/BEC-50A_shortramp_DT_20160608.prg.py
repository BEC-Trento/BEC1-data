...
def program(prg, cmd):
    ...
    prg.add(119010040, "B comp x", 1000.0)
    prg.add(120000000, "Evaporation Ramp.sub")
    prg.add(150000000, "Dipole Trap x DAC V", 7.0000)
    prg.add(150010000, "Dipole Trap y DAC V", 1.5000)
    ...
    prg.add(378320000, "Picture - Field off at 0ms - Levit 80ms.sub", enable=False)
    prg.add(378330000, "Picture NaK.sub")
    prg.add(381000000, "Dipole Trap x DAC V", 0.0000)
    prg.add(381010000, "Dipole Trap y DAC V", 0.0000)
