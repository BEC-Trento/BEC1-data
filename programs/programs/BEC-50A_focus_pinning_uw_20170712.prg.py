...
def program(prg, cmd):
    ...
    prg.add(199060000, "B comp x", 1030.0)
    ...
    prg.add(746300100, "Pulse uw ON", enable=False)
    prg.add(746300200, "Pulse uw OFF", enable=False)
    prg.add(746300250, "Config Field OFF.sub")
    prg.add(746301250, "Picture NaK.sub")
    prg.add(746301250, "Picture NaK no Rep.sub", enable=False)
    prg.add(746301250, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(746301250, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(746301250, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(746301250, "Picture - Field off at 0ms - Levit 120ms.sub", enable=False)
    prg.add(746301250, "Picture - Field off at 0ms - Levit 80ms.sub", enable=False)
    prg.add(747478811, "Bx Grad OFF")
    prg.add(752478811, "Set MOT NaK.sub")
    prg.add(752978811, "Dark Spot MOT load.sub")
    prg.add(753078811, "Config MOT.sub")
    prg.add(755078811, "TTL Pinning ON")
    prg.add(755178811, "Pinning Lock", 3.0000)
    prg.add(757178811, "Optical Levit (+) Amp", 1000)
    return prg
def commands(cmd):
    import numpy as np
