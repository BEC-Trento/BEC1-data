...
def program(prg, cmd):
    ...
    prg.add(470000000, "Shutter OT x Open", enable=False)
    prg.add(470500000, "Dipole Trap x (+) Amp", 1.000000, enable=False)
    prg.add(470501000, "Dipole Trap y (-) Amp", 1.000000, enable=False)
    prg.add(473302000, "OT x ramp.sub", enable=False)
    prg.add(473302500, "OT y ramp.sub", enable=False)
    ...
    prg.add(477005000, "Dipole Trap x (+) Amp", 1.000000, enable=False)
    prg.add(477005500, "Dipole Trap y (-) Amp", 1.000000, enable=False)
