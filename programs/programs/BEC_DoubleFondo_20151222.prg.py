...
def program(prg, cmd):
    ...
    prg.add(668440000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(668440000, "Picture - Field off at 0ms - Levit 180ms.sub")
    prg.add(669150500, "Config Field OFF.sub", enable=False)
    prg.add(669160500, "Picture NaK.sub", enable=False)
    prg.add(672440000, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(686390500, "Set MOT NaK.sub")
    prg.add(686890500, "Dark Spot MOT load.sub")
    prg.add(686990500, "Config MOT.sub")
    return prg
