...
def program(prg, cmd):
    ...
    prg.add(240000000, "Dipole Trap x DAC V", 4.0000)
    ...
    prg.add(380821000, "Dipole Trap x DAC V", 0.0000)
    prg.add(394853200, "Set MOT NaK.sub")
    prg.add(395353200, "Dark Spot MOT load.sub")
    prg.add(395453200, "Config MOT.sub")
    return prg
def commands(cmd):
