...
def program(prg, cmd):
    ...
    prg.add(89000000, "B comp x", 255.000000)
    ...
    prg.add(467960000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    ...
    prg.add(482850000, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
