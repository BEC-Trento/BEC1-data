...
def program(prg, cmd):
    ...
    prg.add(471000000, "Shutter OT x Open")
    prg.add(472290000, "Trigger OT ramp_x ON")
    prg.add(472290100, "Trigger OT ramp_x OFF")
    ...
    prg.add(474450000, "Picture NaK.sub")
    prg.add(477005000, "Dipole Trap x (+) Amp", 1.000000)
    prg.add(477005500, "Dipole Trap y (-) Amp", 1.000000)
