...
def program(prg, cmd):
    ...
    prg.add(452552100, "Rabi pulse recombine", enable=False)
    prg.add(452555300, "Dipole Trap x DAC V", 0.0000)
    prg.add(452555800, "Dipole Trap y DAC V", -0.1000)
    prg.add(452557200, "Picture NaK.sub", enable=False)
    prg.add(452557200, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(452557200, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(452557200, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(452557200, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(452557200, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(452557200, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(452557200, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(452557200, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(452688699, "Picture NaK.sub", enable=False)
    prg.add(452688699, "Picture NaK no Rep.sub", enable=False)
    prg.add(457688699, "Bx Grad OFF", enable=False)
    prg.add(469462098, "Bias field initialization")
    prg.add(470312798, "Pulse uw OFF")
    prg.add(478547298, "Set MOT NaK.sub")
    prg.add(479047298, "Dark Spot MOT load.sub")
    prg.add(479147298, "Config MOT.sub")
    return prg
def commands(cmd):
