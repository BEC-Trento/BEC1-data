...
def program(prg, cmd):
    ...
    prg.add(300912050, "spin cleaning pinch")
    ...
    prg.add(307922050, "Bx Grad ON", enable=False)
    prg.add(307922050, "heating dipole", enable=False)
    prg.add(308422050, "Dipole Trap x DAC V", 0.0000)
    prg.add(308422150, "Dipole Trap y DAC V", -0.1000)
    prg.add(308422150, "Picture NaK.sub", enable=False)
    prg.add(308422150, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(308422150, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(308422150, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(308422150, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(308422150, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(308422150, "Picture - Field off at 0ms -SternGerlach_Ele.sub", enable=False)
    prg.add(308422150, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(308422150, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(308422150, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(308422150, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(308592150, "Picture NaK.sub", enable=False)
    prg.add(308592150, "Picture NaK no Rep.sub", enable=False)
    prg.add(313048650, "Bx Grad OFF")
    prg.add(324822049, "Bias field initialization")
    prg.add(325672749, "Pulse uw OFF")
    prg.add(333907249, "Set MOT NaK.sub")
    prg.add(334407249, "Dark Spot MOT load.sub")
    prg.add(334507249, "Config MOT.sub")
    return prg
def commands(cmd):
