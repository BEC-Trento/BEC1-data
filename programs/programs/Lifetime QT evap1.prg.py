...
def program(prg, cmd):
    ...
    prg.add(270150000, "Config Field OFF.sub")
    prg.add(270200030, "Picture.sub")
    prg.add(301500000, "Set MOT.sub")
    prg.add(302000000, "Dark Spot MOT load.sub")
    prg.add(302100000, "Config MOT.sub")
    return prg
