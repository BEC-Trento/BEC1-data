...
def program(prg, cmd):
    ...
    prg.add(68010000, "Delta 1 Current", 7.800000, enable=False)
    ...
    prg.add(474400000, "Config Field OFF.sub")
    prg.add(474470000, "B comp x", 0.000000)
    prg.add(474600000, "Config Levitation zero current.sub", enable=False)
    prg.add(474600000, "Config Pinch from MT.sub")
    prg.add(476950000, "Delta 1 Current", 5.000000)
    prg.add(477000000, "Config Field OFF.sub")
    prg.add(477200000, "Dipole Trap x (+) Amp", 1.000000)
    prg.add(477200400, "Dipole Trap y (-) Amp", 1.000000)
    prg.add(477450000, "Picture NaK.sub")
    ...
    prg.add(520000000, "K probe Cooler (-) Amp", 1000.000000, enable=False)
    prg.add(520000000, "Na Probe/Push (-) Amp", 1000.000000, enable=False)
    prg.add(521000000, "Na Probe/Push (+) Amp", 1000.000000, enable=False)
    return prg
