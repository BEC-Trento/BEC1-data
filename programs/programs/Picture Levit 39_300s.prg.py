...
def program(prg, cmd):
    ...
    prg.add(23000000, "Synchronize.sub")
    ...
    prg.add(89000000, "B comp x", 273.000000)
    ...
    prg.add(482990500, "B comp y ramp 0-5 1ms.sub")
    prg.add(483000000, "Config Field OFF ramp.sub")
    prg.add(483010300, "Config Levitation F1+1.sub")
    prg.add(483010450, "B comp x", 0.000000)
    prg.add(483010500, "B comp y ramp 5-0 1ms.sub")
    prg.add(484795000, "Config Field OFF.sub")
    prg.add(484801000, "Picture.sub")
