...
def program(prg, cmd):
    ...
    prg.add(129010040, "B comp x", 415.0)
    ...
    prg.add(589800000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(589800000, "Config Field OFF.sub", enable=False)
    prg.add(589950000, "Picture NaK.sub", enable=False)
    prg.add(592900000, "Bragg Pulse Single2015.sub")
    prg.add(596210000, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(596210000, "Picture - Field off at 0ms - Levit 20ms.sub")
    prg.add(683210000, "MOT light Pulse.sub", enable=False)
    prg.add(685520050, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(685520050, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(692900000, "Set MOT NaK.sub")
    prg.add(693400000, "Dark Spot MOT load.sub")
    prg.add(693500000, "Config MOT.sub")
    return prg
