...
def program(prg, cmd):
    ...
    prg.add(444746300, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(444746300, "Picture - Field off at 0ms - Levit 20ms.sub")
    prg.add(444746300, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(444746300, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(444746300, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(444746300, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(444746300, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(444746300, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(444748300, "Picture NaK.sub", enable=False)
    prg.add(444748300, "Picture NaK no Rep.sub", enable=False)
    prg.add(456621700, "Bias field initialization")
    prg.add(456631700, "Bx Grad OFF")
    prg.add(457382400, "Pulse uw OFF")
    prg.add(465616900, "Set MOT NaK.sub")
    prg.add(466116900, "Dark Spot MOT load.sub")
    prg.add(466216900, "Config MOT.sub")
    return prg
def commands(cmd):
