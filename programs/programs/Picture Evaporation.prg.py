...
def program(prg, cmd):
    ...
    prg.add(80003990, "General Trigger ON")
    ...
    prg.add(580000000, "Config Field OFF.sub")
    prg.add(580010030, "Picture.sub")
    prg.add(590000000, "Set MOT.sub")
    prg.add(593000000, "Dark Spot MOT load.sub")
    return prg
