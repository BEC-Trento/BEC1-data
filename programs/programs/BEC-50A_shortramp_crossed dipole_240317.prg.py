...
def program(prg, cmd):
    ...
    prg.add(487911250, "Rabi preparation 2")
    prg.add(492281300, "ReleConfigBackForGravityComp")
    prg.add(492781300, "Rabi pulse New Antena")
    prg.add(492781300, "excite pinch", enable=False)
    prg.add(492805600, "Dipole Trap x DAC V", 0.0000)
    prg.add(492805700, "Dipole Trap y DAC V", 0.0000)
    prg.add(492805900, "TTL2-10 OFF")
    prg.add(492805900, "Picture NaK.sub", enable=False)
    prg.add(492805900, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(492805900, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(492805900, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(492806000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(492806000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(492806000, "Picture - Field off at 0ms -SternGerlach_Ele.sub")
    prg.add(492806000, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(492806000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(492806000, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(492806000, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(492976000, "Picture NaK.sub", enable=False)
    prg.add(492976000, "Picture NaK no Rep.sub", enable=False)
    prg.add(497976000, "Bx Grad OFF", enable=False)
    prg.add(509749399, "Bias field initialization")
    prg.add(510600099, "Pulse uw OFF")
    prg.add(518834599, "Set MOT NaK.sub")
    prg.add(519334599, "Dark Spot MOT load.sub")
    prg.add(519434599, "Config MOT.sub")
    return prg
def commands(cmd):
