...
def program(prg, cmd):
    ...
    prg.add(439405600, "Dipole Trap x DAC V", 0.0000)
    prg.add(439406100, "Dipole Trap y DAC V", -0.1000)
    prg.add(439407500, "Picture NaK.sub", enable=False)
    prg.add(439407500, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(439407500, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(439407500, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(439407500, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(439407500, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(439407500, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(439407500, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(439407500, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(439538999, "Picture NaK.sub", enable=False)
    prg.add(439538999, "Picture NaK no Rep.sub", enable=False)
    prg.add(444538999, "Bx Grad OFF", enable=False)
    prg.add(456312398, "Bias field initialization")
    prg.add(457163098, "Pulse uw OFF")
    prg.add(465397598, "Set MOT NaK.sub")
    prg.add(465897598, "Dark Spot MOT load.sub")
    prg.add(465997598, "Config MOT.sub")
    return prg
def commands(cmd):
