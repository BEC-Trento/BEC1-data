...
def program(prg, cmd):
    ...
    prg.add(663450000, "Picture - Field off at 0ms - Levit 150ms.sub")
    prg.add(683040000, "Config Field OFF.sub", enable=False)
    prg.add(683050000, "Picture NaK.sub", enable=False)
    prg.add(696700000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(708050000, "Set MOT NaK.sub")
    prg.add(708550000, "Dark Spot MOT load.sub")
    prg.add(708650000, "Config MOT.sub")
    return prg
