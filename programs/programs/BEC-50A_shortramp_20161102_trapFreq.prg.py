...
def program(prg, cmd):
    ...
    prg.add(429372000, "B comp y ramp", start_t=0, stop_x=2, n_points=200, start_x=0, stop_t=130)
    ...
    prg.add(440502050, "Rabi preparation 2")
    prg.add(443552050, "spin cleaning pinch")
    prg.add(446552050, "Bcomp y Sign Minus", enable=False)
    prg.add(447402100, "ReleConfigBackForGravityComp")
    prg.add(447902100, "Rabi pulse New Antena")
    prg.add(447902100, "excite pinch", enable=False)
    prg.add(447902100, "Excite Levit coil", enable=False)
    prg.add(447906200, "Dipole Trap x DAC V", 0.0000)
    prg.add(447906700, "Dipole Trap y DAC V", -0.1000)
    prg.add(447906710, "Picture NaK.sub", enable=False)
    prg.add(447906710, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(447906710, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(447906710, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(447906710, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(447906710, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(447906710, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(447906710, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(447906710, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(447906710, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(448038209, "Picture NaK.sub", enable=False)
    prg.add(448038209, "Picture NaK no Rep.sub", enable=False)
    prg.add(453038209, "Bx Grad OFF", enable=False)
    prg.add(464811608, "Bias field initialization")
    prg.add(465662308, "Pulse uw OFF")
    prg.add(473896808, "Set MOT NaK.sub")
    prg.add(474396808, "Dark Spot MOT load.sub")
    prg.add(474496808, "Config MOT.sub")
    return prg
def commands(cmd):
