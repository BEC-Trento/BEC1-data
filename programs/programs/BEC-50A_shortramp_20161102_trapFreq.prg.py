...
def program(prg, cmd):
    ...
    prg.add(440502050, "Rabi preparation 2", enable=False)
    ...
    prg.add(447903000, "excite pinch", enable=False)
    prg.add(447903000, "Excite Levit coil", enable=False)
    prg.add(447907500, "Dipole Trap x DAC V", 0.0000)
    prg.add(447908000, "Dipole Trap y DAC V", -0.1000)
    prg.add(447909400, "Picture NaK.sub", enable=False)
    prg.add(447909400, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(447909400, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(447909400, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(447909400, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(447909400, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(447909400, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(447909400, "Picture - Field off at 0ms - Levit 50ms.sub")
    prg.add(447909400, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(447909400, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(448040899, "Picture NaK.sub", enable=False)
    prg.add(448040899, "Picture NaK no Rep.sub", enable=False)
    prg.add(453040899, "Bx Grad OFF", enable=False)
    prg.add(464814298, "Bias field initialization")
    prg.add(465664998, "Pulse uw OFF")
    prg.add(473899498, "Set MOT NaK.sub")
    prg.add(474399498, "Dark Spot MOT load.sub")
    prg.add(474499498, "Config MOT.sub")
    return prg
def commands(cmd):
