...
def program(prg, cmd):
    ...
    prg.add(625030000, "Config Field OFF.sub")
    prg.add(625150000, "Picture NaK.sub")
    prg.add(625150000, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(625150000, "Picture - Field off at 0ms - Levit 5ms.sub", enable=False)
    prg.add(625150000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(625150000, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(625150000, "Config Field OFF.sub", enable=False)
    prg.add(625350000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(625350000, "Picture NaK.sub", enable=False)
    prg.add(625350000, "Picture NaK Hamamatsu.sub", enable=False)
    prg.add(625350000, "Picture NaK Repump Off.sub", enable=False)
    prg.add(625350000, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(625350000, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(625350000, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(625350000, "Picture - Field off at 0ms - Levit 80ms.sub", enable=False)
    prg.add(629130000, "Set MOT NaK.sub")
    prg.add(629630000, "Dark Spot MOT load.sub")
    prg.add(629730000, "Config MOT.sub")
    return prg
def commands(cmd):
