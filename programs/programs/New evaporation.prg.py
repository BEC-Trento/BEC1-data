...
def program(prg, cmd):
    ...
    prg.add(500000, "Synchronize.sub")
    ...
    prg.add(400000000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(400000000, "Picture - Field off at 0ms - Levit 250ms.sub")
    prg.add(400000000, "Picture - Field off at 0ms - Levit 200ms.sub", enable=False)
    prg.add(400000000, "Picture - Field off at 0ms - Levit 120ms.sub", enable=False)
    prg.add(400000000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
