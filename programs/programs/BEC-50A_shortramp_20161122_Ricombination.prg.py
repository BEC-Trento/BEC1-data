...
def program(prg, cmd):
    ...
    prg.add(443002050, "spin cleaning pinch")
    prg.add(446002050, "Rabi preparation_Z")
    prg.add(449052100, "ReleConfigBackForGravityComp")
    prg.add(449552100, "Rabi pulse New Antena")
    prg.add(449582100, "phase imprint pulse_2016", enable=False)
    prg.add(449592100, "Rabi pulse recombine")
    prg.add(449595300, "Dipole Trap x DAC V", 0.0000)
    prg.add(449595800, "Dipole Trap y DAC V", -0.1000)
    prg.add(449597200, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(449597200, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(449597200, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(449597200, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(449597200, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(449597200, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(449597200, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(449597200, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub")
    prg.add(449597200, "Picture NaK_rep phase imprint.sub", enable=False)
    prg.add(449597200, "Picture NaK.sub", enable=False)
    prg.add(454728699, "Bx Grad OFF", enable=False)
    prg.add(466502098, "Bias field initialization")
    prg.add(467352798, "Pulse uw OFF")
    prg.add(475587298, "Set MOT NaK.sub")
    prg.add(476087298, "Dark Spot MOT load.sub")
    prg.add(476187298, "Config MOT.sub")
    return prg
def commands(cmd):
