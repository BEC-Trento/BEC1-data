...
def program(prg, cmd):
    ...
    prg.add(394689795, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    ...
    prg.add(394859795, "Picture NaK.sub", enable=False)
    prg.add(406733195, "Bias field initialization")
    prg.add(407483895, "Pulse uw OFF")
    prg.add(415718395, "Set MOT NaK.sub")
    prg.add(416218395, "Dark Spot MOT load.sub")
    prg.add(416318395, "Config MOT.sub")
    return prg
def commands(cmd):
