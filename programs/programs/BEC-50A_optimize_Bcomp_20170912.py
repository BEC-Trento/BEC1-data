...
def program(prg, cmd):
    ...
    prg.add(199059539, "B comp x", 1010.0)
    ...
    prg.add(764300000, "Picture Levit 2017 - 50ms", enable=False)
    prg.add(764300000, "Picture Levit 2017 - 100ms", enable=False)
    prg.add(764300000, "Picture Levit 2017 - 120ms")
    prg.add(764300000, "Picture Levit 2017 - 150ms", enable=False)
    prg.add(764300000, "Picture Levit 20170908.sub", enable=False)
    prg.add(764300000, "Config Field OFF.sub", enable=False)
    prg.add(764300135, "TTL2-12 ON")
