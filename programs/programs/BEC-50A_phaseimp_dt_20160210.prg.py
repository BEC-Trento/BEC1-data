...
def program(prg, cmd):
    ...
    prg.add(120010000, "Dipole Trap x DAC V", 7.0000, enable=False)
    prg.add(120010100, "Dipole Trap y DAC V", 1.8000, enable=False)
    ...
    prg.add(270010000, "Dipole Trap y ramp", start_t=0.0000, stop_x=1.800, n_points=300, start_x=0.000, stop_t=2000.0000, enable=False)
    ...
    prg.add(378320000, "Phase Imprint Pulse.sub", enable=False)
    ...
    prg.add(378320000, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    ...
    prg.add(378330000, "Picture NaK.sub", enable=False)
    prg.add(385350000, "Dipole Trap x DAC V", 0.0000, enable=False)
    prg.add(385351000, "Dipole Trap y DAC V", 0.0000, enable=False)
    prg.add(392362200, "Set MOT NaK.sub")
    prg.add(392862200, "Dark Spot MOT load.sub")
    prg.add(392962200, "Config MOT.sub")
    prg.add(404242400, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(404727362, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    return prg
def commands(cmd):
