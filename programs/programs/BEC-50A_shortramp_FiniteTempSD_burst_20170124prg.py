...
def program(prg, cmd):
    ...
    prg.add(280367000, "B comp x ramp", start_t=0, stop_x=1369, n_points=300, start_x=1000, stop_t=250)
    ...
    prg.add(284412050, "heating dipole")
    prg.add(304412050, "Rabi preparation 2")
    prg.add(307912050, "ReleConfigBackForGravityComp")
    prg.add(307912050, "excite pinch", enable=False)
    prg.add(307916050, "Dipole Trap x DAC V", 0.0000)
    prg.add(307916150, "Dipole Trap y DAC V", -0.1000)
    prg.add(308046150, "Picture NaK.sub")
    prg.add(308046150, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(308046150, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(308046150, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(308046150, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(308046150, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(308046150, "Picture - Field off at 0ms -SternGerlach_Ele.sub", enable=False)
    prg.add(308046150, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(308046150, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(308046150, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(308046150, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(308216150, "Picture NaK.sub", enable=False)
    prg.add(308216150, "Picture NaK no Rep.sub", enable=False)
    prg.add(313216150, "Bx Grad OFF")
    prg.add(324989549, "Bias field initialization")
    prg.add(325840249, "Pulse uw OFF")
    prg.add(334074749, "Set MOT NaK.sub")
    prg.add(334574749, "Dark Spot MOT load.sub")
    prg.add(334674749, "Config MOT.sub")
    return prg
def commands(cmd):
