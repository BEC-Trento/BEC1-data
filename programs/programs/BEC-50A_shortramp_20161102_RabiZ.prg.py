...
def program(prg, cmd):
    ...
    prg.add(447906800, "Dipole Trap x DAC V", 0.0000)
    prg.add(447907300, "Dipole Trap y DAC V", -0.1000)
    prg.add(447907310, "Picture NaK.sub", enable=False)
    prg.add(447907310, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(447907310, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(447907310, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(447907310, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(447907310, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(447907310, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(447907310, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(447907310, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(447907310, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(448038809, "Picture NaK.sub", enable=False)
    prg.add(448038809, "Picture NaK no Rep.sub", enable=False)
    prg.add(453038809, "Bx Grad OFF", enable=False)
    prg.add(464812208, "Bias field initialization")
    prg.add(465662908, "Pulse uw OFF")
    prg.add(473897408, "Set MOT NaK.sub")
    prg.add(474397408, "Dark Spot MOT load.sub")
    prg.add(474497408, "Config MOT.sub")
    return prg
def commands(cmd):
