...
def program(prg, cmd):
    ...
    prg.add(447902100, "Rabi pulse New Antena", enable=False)
    prg.add(447902100, "excite pinch", enable=False)
    prg.add(447902100, "Excite Levit coil", enable=False)
    prg.add(447905600, "Dipole Trap x DAC V", 0.0000)
    prg.add(447906100, "Dipole Trap y DAC V", -0.1000)
    prg.add(447906110, "Picture NaK.sub", enable=False)
    prg.add(447906110, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(447906110, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(447906110, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(447906110, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(447906110, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(447906110, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(447906110, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(447906110, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(447906110, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(448037609, "Picture NaK.sub", enable=False)
    prg.add(448037609, "Picture NaK no Rep.sub", enable=False)
    prg.add(453037609, "Bx Grad OFF", enable=False)
    prg.add(464811008, "Bias field initialization")
    prg.add(465661708, "Pulse uw OFF")
    prg.add(473896208, "Set MOT NaK.sub")
    prg.add(474396208, "Dark Spot MOT load.sub")
    prg.add(474496208, "Config MOT.sub")
    return prg
def commands(cmd):
