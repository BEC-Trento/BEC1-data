...
def program(prg, cmd):
    ...
    prg.add(475950000, "Config Field OFF.sub")
    prg.add(475960000, "Config Feshbach.sub")
    prg.add(476160000, "Feshbach ramp 20ms 0-50A.sub", enable=False)
    prg.add(476160000, "Delta 1 Current", 1.140000)
    prg.add(476160000, "Feshbach ramp 20ms 0-1140mA.sub", enable=False)
    prg.add(476265500, "B comp x", 0.000000)
    prg.add(476267500, "B comp y", 0.000000)
    prg.add(477200000, "Trigger uw sweep ON")
    prg.add(477201000, "Trigger uw amp ON")
    prg.add(477300000, "Trigger uw sweep OFF")
    prg.add(477301000, "Trigger uw amp OFF")
    prg.add(477360000, "Feshbach ramp 10ms 50-0A.sub", enable=False)
    prg.add(477360000, "Delta 1 Current", 0.000000)
    prg.add(477360000, "Feshbach ramp 10ms 1140-0mA.sub", enable=False)
