...
def program(prg, cmd):
    ...
    prg.add(89000000, "B comp x", 263.000000)
    ...
    prg.add(570210000, "Ext Ver Init - 50ms.sub", enable=False)
    prg.add(570210000, "Ext Ver Init - 150ms.sub", enable=False)
    prg.add(570660000, "Ext Ver Half - 50ms.sub", enable=False)
    prg.add(570660000, "Ext Ver Half - 150ms.sub", enable=False)
    ...
    prg.add(630000000, "Mirrors Imaging")
    prg.add(638000000, "Shutter Probe Na Open")
