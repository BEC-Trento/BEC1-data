...
def program(prg, cmd):
    ...
    prg.add(39950500, "Melassa Na.sub", enable=False)
    prg.add(39951500, "Melassa Na amp.sub", enable=False)
    prg.add(39992000, "Config Field OFF.sub", enable=False)
    prg.add(40000000, "MOT lights Off Na F2.sub")
    prg.add(40005000, "Config MOT.sub", enable=False)
    prg.add(40010000, "Set MOT K.sub")
    prg.add(60000000, "Rele 5 Close")
