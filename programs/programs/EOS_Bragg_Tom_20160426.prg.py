...
def program(prg, cmd):
    ...
    prg.add(674500000, "Bragg Pulse Single2015.sub", enable=False)
    prg.add(674500000, "Bragg Pulse Single2015.sub", enable=False)
    prg.add(674500000, "Bragg Pulse Single2015.sub", enable=False)
    prg.add(674580000, "Config Field OFF.sub", enable=False)
    prg.add(674580000, "Picture - Field off at 0ms - Levit 180ms.sub")
    prg.add(674580000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(674590000, "Picture NaK Bragg Tom.sub", enable=False)
    prg.add(674590000, "Picture NaK Bragg Tom no repump.sub", enable=False)
    prg.add(674590000, "Picture NaK.sub", enable=False)
    prg.add(676590000, "Na Repumper1 (+) Amp", 600, enable=False)
    prg.add(682220000, "Set MOT NaK.sub")
    prg.add(682720000, "Dark Spot MOT load.sub")
    prg.add(682820000, "Config MOT.sub")
    return prg
def commands(cmd):
