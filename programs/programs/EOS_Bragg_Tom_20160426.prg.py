...
def program(prg, cmd):
    ...
    prg.add(674500000, "Bragg Pulse Single New_20160509.sub")
    prg.add(674530000, "Config Field OFF.sub")
    prg.add(674530000, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    ...
    prg.add(674531000, "Picture NaK Bragg New_20160509.sub")
