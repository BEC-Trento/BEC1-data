...
def program(prg, cmd):
    ...
    prg.add(567010000, "empty.sub", enable=False)
    prg.add(668310000, "Bragg Pulse Single2015.sub")
    prg.add(668310000, "Bragg Pulse Single2015.sub", enable=False)
    prg.add(668310000, "Bragg Pulse Single2015.sub", enable=False)
    prg.add(668340000, "Config Field OFF.sub")
    prg.add(668340000, "Picture - Field off at 0ms - Levit 180ms.sub", enable=False)
    prg.add(668340000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(668340000, "Picture - Field off at 0ms - Levit 80ms.sub", enable=False)
    prg.add(668341000, "Picture NaK Bragg Tom.sub")
    prg.add(668341000, "Picture NaK Bragg Tom no repump.sub", enable=False)
    prg.add(668341000, "Picture NaK.sub", enable=False)
    prg.add(670341000, "Na Repumper1 (+) Amp", 600, enable=False)
    prg.add(675971000, "Set MOT NaK.sub")
    prg.add(676471000, "Dark Spot MOT load.sub")
    prg.add(676571000, "Config MOT.sub")
    return prg
def commands(cmd):
