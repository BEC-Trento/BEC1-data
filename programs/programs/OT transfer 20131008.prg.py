...
def program(prg, cmd):
    ...
    prg.add(450000000, "Shutter OT x Open")
    prg.add(450500000, "Dipole Trap x (+) Amp", 1.000000)
    prg.add(450501000, "Dipole Trap y (-) Amp", 1.000000)
    prg.add(453002000, "OT x ramp.sub")
    prg.add(453002500, "OT y ramp.sub")
    prg.add(473340000, "MT Off ramp_100ms.sub")
    prg.add(474350000, "Config Field OFF ramp.sub", enable=False)
    prg.add(474450000, "OT x evap ramp_100ms.sub")
    prg.add(474550000, "Picture NaK-30ms levit.sub", enable=False)
    prg.add(476550000, "Dipole Trap x (+) Amp", 1.000000)
    prg.add(476550500, "Dipole Trap y (-) Amp", 1.000000)
    prg.add(476751000, "Picture NaK.sub")
