...
def program(prg, cmd):
    ...
    prg.add(444739600, "excite pinch", enable=False)
    prg.add(444744600, "Dipole Trap y DAC V", -0.1000)
    prg.add(444745000, "Dipole Trap x DAC V", 0.0000)
    prg.add(444745000, "Picture NaK.sub", enable=False)
    prg.add(444747000, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(444747000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(444747000, "Picture - Field off at 0ms - Levit 10ms.sub", enable=False)
    prg.add(444747000, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(444747000, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(444747000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(444747000, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(444747000, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(444749000, "Picture NaK.sub", enable=False)
    prg.add(444749000, "Picture NaK no Rep.sub", enable=False)
    prg.add(449749000, "Bx Grad OFF")
    prg.add(461522399, "Bias field initialization")
    prg.add(462373099, "Pulse uw OFF")
    prg.add(470607599, "Set MOT NaK.sub")
    prg.add(471107599, "Dark Spot MOT load.sub")
    prg.add(471207599, "Config MOT.sub")
    return prg
def commands(cmd):
