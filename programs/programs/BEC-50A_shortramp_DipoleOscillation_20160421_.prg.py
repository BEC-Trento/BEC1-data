...
def program(prg, cmd):
    ...
    prg.add(422650100, "excite pinch")
    prg.add(422774398, "Dipole Trap y DAC V", -0.1000)
    prg.add(422774798, "Dipole Trap x DAC V", 0.0000)
    prg.add(422774798, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub", enable=False)
    prg.add(422774798, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(422774798, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(422774798, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(422774798, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(422774798, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(422774798, "Picture NaK.sub", enable=False)
    prg.add(422944798, "Picture NaK low repump Tom.sub")
    prg.add(434818198, "Bias field initialization")
    prg.add(435568898, "Pulse uw OFF", enable=False)
    prg.add(443803398, "Set MOT NaK.sub")
    prg.add(444303398, "Dark Spot MOT load.sub")
    prg.add(444403398, "Config MOT.sub")
    return prg
def commands(cmd):
