...
def program(prg, cmd):
    ...
    prg.add(394735100, "Pulse uw ON", enable=False)
    prg.add(394739400, "Dipole Trap y DAC V", -0.1000)
    prg.add(394739800, "Dipole Trap x DAC V", 0.0000)
    prg.add(394740000, "Pulse uw OFF")
    prg.add(394744800, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(394744800, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    prg.add(394744800, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(394744800, "Picture - Field off at 0ms -SternGerlach_ShortTom.sub", enable=False)
    prg.add(394744800, "Picture - Field off at 0ms -SternGerlach_ShortTom15ms.sub", enable=False)
    prg.add(394744800, "Picture - Field off at 0ms -SternGerlach_ShortElena.sub", enable=False)
    prg.add(394754800, "Picture NaK no Rep.sub", enable=False)
    prg.add(394754800, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
    prg.add(394754800, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(394754800, "Picture - Field off at 0ms - Levit 30ms-SternGerlach.sub", enable=False)
    prg.add(394754800, "Picture - Field off at 0ms - AntiLevit 50ms.sub", enable=False)
    prg.add(394924800, "Picture NaK.sub", enable=False)
    prg.add(406798200, "Bias field initialization")
    prg.add(407548900, "Pulse uw OFF")
    prg.add(415783400, "Set MOT NaK.sub")
    prg.add(416283400, "Dark Spot MOT load.sub")
    prg.add(416383400, "Config MOT.sub")
    return prg
def commands(cmd):
