...
def program(prg, cmd):
    ...
    prg.add(120003040, "Config MT compr.sub", enable=False)
    ...
    prg.add(130006050, "MTnC to MTC.sub", enable=False)
    prg.add(130008020, "Grav Comp", 0.0000)
    prg.add(140008020, "B comp x", 250.0)
    prg.add(145008020, "Evaporation Ramp.sub")
    prg.add(657518020, "Decompress Current MT.sub")
    prg.add(657525021, "Decompress Voltage MT.sub")
    prg.add(667524000, "Picture - Field off at 0ms - Levit 20ms.sub", enable=False)
    prg.add(667524041, "Config Field OFF.sub")
    prg.add(667624041, "Picture NaK.sub")
    prg.add(673640021, "Set MOT NaK.sub")
    prg.add(673740021, "Config MOT.sub")
    prg.add(674240021, "Dark Spot MOT load.sub")
    return prg
