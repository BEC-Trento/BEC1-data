...
def program(prg, cmd):
    ...
    prg.add(468200000, "Na Probe/Push (+) freq", 110.000000)
    prg.add(468600000, "Na Probe/Push (-) freq", 110.000000)
    prg.add(469000000, "Shutter Push Na Open")
    prg.add(469100000, "Shutter OT x Open")
    prg.add(473802000, "OT x ramp.sub")
    prg.add(474850000, "Config Field OFF ramp.sub", enable=False)
    prg.add(474850000, "Picture NaK-50ms levit.sub")
    prg.add(474880000, "Picture NaK.sub", enable=False)
    prg.add(480000000, "Dipole Trap x (+) Amp", 1.000000)
    prg.add(501000000, "Shutter OT x Close")
