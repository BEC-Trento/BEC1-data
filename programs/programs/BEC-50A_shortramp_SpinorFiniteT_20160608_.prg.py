...
def program(prg, cmd):
    ...
    prg.add(270000500, "Dipole Trap y ramp", start_t=0.0000, stop_x=1.500, n_points=300, start_x=-0.100, stop_t=2000.0000)
    ...
    prg.add(392659799, "Picture - Field off at 0ms - Levit 100ms.sub", enable=False)
    prg.add(392659799, "Picture - Field off at 0ms -SternGerlach_Levit 10ms.sub")
    ...
    prg.add(392659799, "Picture - Field off at 0ms - Levit 30ms.sub", enable=False)
