...
def program(prg, cmd):
    ...
    prg.add(129010040, "B comp x", 277.0)
    ...
    prg.add(637060000, "Picture - Field off at 0ms - Levit 50ms.sub", enable=False)
    prg.add(641670000, "Picture - Field off at 0ms - Levit 150ms.sub", enable=False)
    prg.add(643440000, "Config Field OFF.sub", enable=False)
    prg.add(643440000, "Picture - Field off at 0ms - Levit 180ms.sub")
    prg.add(643450000, "Picture NaK.sub", enable=False)
    prg.add(658050000, "Set MOT NaK.sub")
    prg.add(658550000, "Dark Spot MOT load.sub")
    prg.add(658650000, "Config MOT.sub")
    return prg
