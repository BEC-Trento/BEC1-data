...
def program(prg, cmd):
    ...
    prg.add(320000, "Na Gray molasses (+) freq", 117.50, enable=False)
    prg.add(330000, "Na Gray molasses (-) freq", 82.50, enable=False)
    prg.add(340000, "AOM GM Amp ch1 (+)", 1000, enable=False)
    prg.add(350000, "AOM GM Amp ch2 (-)", 1000, enable=False)
