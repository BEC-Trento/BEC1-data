...
def program(prg, cmd):
    ...
    prg.add(110167000, "Evaporation ramp", start_t=0.0000, func_args="fstart=45e6, fend=25e6, tau=1", n_points=500, func="(fstart - fend)*exp(-t/tau) + fend", stop_t=5000.0000, functions=dict(func_args=lambda x: x), enable=False)
