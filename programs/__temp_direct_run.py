...
prg_version = "0.5.1"
def program(prg, cmd):
    prg.add(0, "Delta 1 Current", 12.000)
    ...
    prg.add(30000, "Na Gray molasses (+) freq", 112.50)
    prg.add(30500, "Na Gray molasses (-) freq", 87.50)
    prg.add(31000, "Na Gray molasses (+) Amp", 1000)
    prg.add(31500, "Na Gray molasses (-) Amp", 1000)
